...
public class Applet extends java.applet.Applet implements MouseListener, MouseMotionListener, KeyListener, MouseWheelListener, ComponentListener,
	...
	public final void paint(Graphics var1) {
		try {
			if (mudclient != null) {
				...
				if (mudclient.gameState == 2 && this.loadingLogo != null)
		...
		try {
			if (null != this.imageProducer) {
				this.imageProducer.setPixels(0, 0, mudclient.getSurface().width2, mudclient.getSurface().height2,
					this.imageModel, GraphicsController.pixels, 0, mudclient.getSurface().width2);
