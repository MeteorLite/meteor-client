...
public class ModelPusher {
    ...
    private Logger log = new Logger("ModelPusher");
    ...
    public ModelPusher(HdPlugin plugin, HdPluginConfig config, ProceduralGenerator proceduralGenerator, ModelHasher modelHasher) {
        this.plugin = plugin;
        this.config = config;
