...
@Retention(AnnotationRetention.RUNTIME)
    ...
    val name: String, val description: String, val position: Int = 100000, val closedByDefault: Boolean = false,
    val keyName: String = "", val hidden: Boolean = false, val unhide: String = ""
    )