package net.runelite.client.plugins.gpuhd.model;
...
import net.runelite.client.plugins.gpuhd.data.materials.Overlay;
import net.runelite.client.plugins.gpuhd.data.materials.Underlay;
import net.runelite.client.plugins.gpuhd.scene.model_overrides.InheritTileColorType;
...
import net.runelite.client.plugins.gpuhd.scene.model_overrides.TzHaarRecolorType;
import net.runelite.client.plugins.gpuhd.scene.ProceduralGenerator;
import net.runelite.client.plugins.gpuhd.utils.HDUtils;
...
import static net.runelite.client.plugins.gpuhd.utils.HDUtils.dotNormal3Lights;
...
public class ModelPusher {
    ...
    public ModelPusher(HdPlugin plugin, HdPluginConfig config, ProceduralGenerator proceduralGenerator,
        ModelHasher modelHasher) {
        this.hdPlugin = plugin;
        this.config = config;
