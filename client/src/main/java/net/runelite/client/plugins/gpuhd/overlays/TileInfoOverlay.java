package net.runelite.client.plugins.gpuhd.overlays;
...
public class TileInfoOverlay extends meteor.ui.overlay.Overlay
{
	...
	public TileInfoOverlay(HdPluginConfig config)
	{
	...
	public Dimension render(Graphics2D g)
	{
		...
		g.setFont(FontManager.INSTANCE.getRunescapeFont());
	...
	private Rectangle drawTileInfo(Graphics2D g, Tile tile, Polygon poly, Rectangle dodgeRect)
	{
		...
		for (String line : lines)
		{
			...
			OverlayUtil.INSTANCE.renderTextLocation(g, p, line, Color.WHITE);
		}
