...
/**
 * @author Kris | 23/08/2022
 */
public class SliderUI extends BasicSliderUI
{
    private static final Color BRAND_BLUE = new Color(25, 194, 255);
    private final Color rangeColor = BRAND_BLUE;
    ...
    public void paintTrack(Graphics g)
    {
        ...
        g2d.setPaint(ColorScheme.INSTANCE.getLIGHT_GRAY_COLOR());
        Color oldColor = ColorScheme.INSTANCE.getLIGHT_GRAY_COLOR();
    ...
    public void paintThumb(Graphics g)
    {
        ...
        g2d.setColor(BRAND_BLUE);
        g2d.fill(thumbShape);

        g2d.setColor(ColorScheme.INSTANCE.getDARK_GRAY_COLOR());
        g2d.draw(thumbShape);
        g2d.dispose();
    }
