...
public class VorbisFloor {
   ...
   VorbisFloor() {
      ...
      if (var1 != 1) {
         ...
         this.field177 = new int[var5];
         this.field177[0] = 0;
         this.field177[1] = 1 << var4;
         var5 = 2;
         ...
         for(var9 = 0; var9 < var2; ++var9) {
            ...
            for(int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
               this.field177[var5++] = VorbisSample.readBits(var4);
            }
         }

         if (field186 == null || field186.length < var5) {
            field186 = new int[var5];
            field185 = new int[var5];
            field179 = new boolean[var5];
         }
   ...
   @ObfuscatedName("ac")
   int method202(int var1, int var2, int var3, int var4, int var5) {
      int var6 = var4 - var2;
      int var7 = var3 - var1;
   ...
   @ObfuscatedName("ab")
   void method199(int var1, int var2, int var3, int var4, float[] var5, int var6) {
      int var7 = var4 - var2;
      int var8 = var3 - var1;
   ...
   void VarbisFloor_sort(int var1, int var2) {
      if (var1 < var2) {
         int var3 = var1;
         int var4 = field186[var1];
         int var5 = field185[var1];
         boolean var6 = field179[var1];

         for(int var7 = var1 + 1; var7 <= var2; ++var7) {
            int var8 = field186[var7];
            if (var8 < var4) {
               field186[var3] = var8;
               field185[var3] = field185[var7];
               field179[var3] = field179[var7];
               ++var3;
               field186[var7] = field186[var3];
               field185[var7] = field185[var3];
               field179[var7] = field179[var3];
            }
         }
   ...
   boolean readSubmapFloor() {
      ...
      if (!var1) {
         ...
         int var2 = this.field177.length;

         int var3;
         for(var3 = 0; var3 < var2; ++var3) {
            field186[var3] = this.field177[var3];
         }

         var3 = field184[this.multiplier - 1];
         int var4 = Client.iLog(var3 - 1);
         field185[0] = VorbisSample.readBits(var4);
         field185[1] = VorbisSample.readBits(var4);
         int var5 = 2;
         ...
         for(int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
            ...
            int var11 = 0;
            if (var9 > 0) {
               var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method290();
            }

            for(int var12 = 0; var12 < var8; ++var12) {
               int var13 = this.subclassBooks[var7][var11 & var10];
               var11 >>>= var9;
               field185[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method290() : 0;
            }
         }
   ...
   @ObfuscatedName("av")
   void method201(float[] var1, int var2) {
      int var3 = this.field177.length;
      int var4 = field184[this.multiplier - 1];
      boolean[] var5 = field179;
      field179[1] = true;
      var5[0] = true;
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = method203(field186, var6);
         var8 = method198(field186, var6);
         var9 = this.method202(field186[var7], field185[var7], field186[var8], field185[var8], field186[var6]);
         var10 = field185[var6];
         int var11 = var4 - var9;
         int var13 = (var11 < var9 ? var11 : var9) << 1;
         if (var10 != 0) {
            boolean[] var14 = field179;
            field179[var8] = true;
            var14[var7] = true;
            field179[var6] = true;
            if (var10 >= var13) {
               field185[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
            } else {
               field185[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
            }
         } else {
            field179[var6] = false;
            field185[var6] = var9;
      ...
      var6 = 0;
      var7 = field185[0] * this.multiplier;

      for(var8 = 1; var8 < var3; ++var8) {
         if (field179[var8]) {
            var9 = field186[var8];
            var10 = field185[var8] * this.multiplier;
            this.method199(var6, var7, var9, var10, var1, var2);
            if (var9 >= var2) {
               return;
            }
