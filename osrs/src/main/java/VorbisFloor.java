...
public class VorbisFloor {
	...
	static {
		field289 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field295 = new int[var5];
			this.field295[0] = 0;
			this.field295[1] = 1 << var4;
			var5 = 2;
			...
			for (var6 = 0; var6 < var2; ++var6) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field295[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field294 == null || field294.length < var5) {
				field294 = new int[var5];
				field291 = new int[var5];
				field285 = new boolean[var5];
			}
	...
	@ObfuscatedName("c")
	int method766(int var1, int var2, int var3, int var4, int var5) {
		int var6 = var4 - var2;
		int var7 = var3 - var1;
	...
	@ObfuscatedName("x")
	void method767(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field294[var1];
			int var5 = field291[var1];
			boolean var6 = field285[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field294[var7];
				if (var8 < var4) {
					field294[var3] = var8;
					field291[var3] = field291[var7];
					field285[var3] = field285[var7];
					++var3;
					field294[var7] = field294[var3];
					field291[var7] = field291[var3];
					field285[var7] = field285[var3];
				}
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field295.length;

			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				field294[var3] = this.field295[var3];
			}

			var3 = field289[this.multiplier - 1];
			int var4 = class4.iLog(var3 - 1);
			field291[0] = VorbisSample.readBits(var4);
			field291[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method1046();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field291[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method1046() : 0;
				}
			}
	...
	@ObfuscatedName("y")
	void method784(float[] var1, int var2) {
		int var3 = this.field295.length;
		int var4 = field289[this.multiplier - 1];
		boolean[] var5 = field285;
		field285[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method782(field294, var6);
			var8 = method780(field294, var6);
			var9 = this.method766(field294[var7], field291[var7], field294[var8], field291[var8], field294[var6]);
			var10 = field291[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field285;
				field285[var8] = true;
				var14[var7] = true;
				field285[var6] = true;
				if (var10 >= var13) {
					field291[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field291[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field285[var6] = false;
				field291[var6] = var9;
		...
		var6 = 0;
		var7 = field291[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field285[var8]) {
				var9 = field294[var8];
				var10 = field291[var8] * this.multiplier;
				this.method767(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
	...
	@ObfuscatedName("a")
	static int method782(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
	...
	@ObfuscatedName("f")
	static int method780(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
