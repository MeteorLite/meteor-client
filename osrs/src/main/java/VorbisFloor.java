...
public class VorbisFloor {
   @ObfuscatedName("af")
   static final int[] field184 = new int[]{256, 128, 86, 64};
    @ObfuscatedName("an")
   ...
   VorbisFloor() {
      ...
      if (var1 != 1) {
         ...
         this.field182 = new int[var5];
         this.field182[0] = 0;
         this.field182[1] = 1 << var4;
         var5 = 2;
         ...
         for(var9 = 0; var9 < var2; ++var9) {
            ...
            for(int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
               this.field182[var5++] = VorbisSample.readBits(var4);
            }
         }

         if (field180 == null || field180.length < var5) {
            field180 = new int[var5];
            field190 = new int[var5];
            field191 = new boolean[var5];
         }
   ...
   @ObfuscatedName("aw")
   int method221(int var1, int var2, int var3, int var4, int var5) {
      int var6 = var4 - var2;
      int var7 = var3 - var1;
   ...
   @ObfuscatedName("ac")
   void method222(int var1, int var2, int var3, int var4, float[] var5, int var6) {
      int var7 = var4 - var2;
      int var8 = var3 - var1;
    ...
    void VarbisFloor_sort(int var1, int var2) {
      if (var1 < var2) {
         int var3 = var1;
         int var4 = field180[var1];
         int var5 = field190[var1];
         boolean var6 = field191[var1];

         for(int var7 = var1 + 1; var7 <= var2; ++var7) {
            int var8 = field180[var7];
            if (var8 < var4) {
               field180[var3] = var8;
               field190[var3] = field190[var7];
               field191[var3] = field191[var7];
               ++var3;
               field180[var7] = field180[var3];
               field190[var7] = field190[var3];
               field191[var7] = field191[var3];
            }
         }
    ...
    boolean readSubmapFloor() {
      ...
      if (!var1) {
         ...
         int var2 = this.field182.length;

         int var3;
         for(var3 = 0; var3 < var2; ++var3) {
            field180[var3] = this.field182[var3];
         }

         var3 = field184[this.multiplier - 1];
         int var4 = LoginPacket.iLog(var3 - 1);
         field190[0] = VorbisSample.readBits(var4);
         field190[1] = VorbisSample.readBits(var4);
         int var5 = 2;
         ...
         for(int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
            ...
            int var11 = 0;
            if (var9 > 0) {
               var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method309();
            }

            for(int var12 = 0; var12 < var8; ++var12) {
               int var13 = this.subclassBooks[var7][var11 & var10];
               var11 >>>= var9;
               field190[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method309() : 0;
            }
         }
   ...
   @ObfuscatedName("aq")
   void method225(float[] var1, int var2) {
      int var3 = this.field182.length;
      int var4 = field184[this.multiplier - 1];
      boolean[] var5 = field191;
      field191[1] = true;
      var5[0] = true;
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = method220(field180, var6);
         var8 = method226(field180, var6);
         var9 = this.method221(field180[var7], field190[var7], field180[var8], field190[var8], field180[var6]);
         var10 = field190[var6];
         int var11 = var4 - var9;
         int var13 = (var11 < var9 ? var11 : var9) << 1;
         if (var10 != 0) {
            boolean[] var14 = field191;
            field191[var8] = true;
            var14[var7] = true;
            field191[var6] = true;
            if (var10 >= var13) {
               field190[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
            } else {
               field190[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
            }
         } else {
            field191[var6] = false;
            field190[var6] = var9;
      ...
      var6 = 0;
      var7 = field190[0] * this.multiplier;

      for(var8 = 1; var8 < var3; ++var8) {
         if (field191[var8]) {
            var9 = field180[var8];
            var10 = field190[var8] * this.multiplier;
            this.method222(var6, var7, var9, var10, var1, var2);
            if (var9 >= var2) {
               return;
            }
   ...
   @ObfuscatedName("af")
   static int method220(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
