...
public class VorbisFloor {
   @ObfuscatedName("f")
   static final int[] field192 = new int[]{256, 128, 86, 64};
    @ObfuscatedName("w")
   ...
   VorbisFloor() {
      ...
      if (var1 != 1) {
         ...
         this.field193 = new int[var5];
         this.field193[0] = 0;
         this.field193[1] = 1 << var4;
         var5 = 2;
         ...
         for(var9 = 0; var9 < var2; ++var9) {
            ...
            for(int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
               this.field193[var5++] = VorbisSample.readBits(var4);
            }
         }

         if (field194 == null || field194.length < var5) {
            field194 = new int[var5];
            field195 = new int[var5];
            field196 = new boolean[var5];
         }
   ...
   @ObfuscatedName("v")
   int method191(int var1, int var2, int var3, int var4, int var5) {
      int var6 = var4 - var2;
      int var7 = var3 - var1;
   ...
   @ObfuscatedName("s")
   void method196(int var1, int var2, int var3, int var4, float[] var5, int var6) {
      int var7 = var4 - var2;
      int var8 = var3 - var1;
    ...
    void VarbisFloor_sort(int var1, int var2) {
      if (var1 < var2) {
         int var3 = var1;
         int var4 = field194[var1];
         int var5 = field195[var1];
         boolean var6 = field196[var1];

         for(int var7 = var1 + 1; var7 <= var2; ++var7) {
            int var8 = field194[var7];
            if (var8 < var4) {
               field194[var3] = var8;
               field195[var3] = field195[var7];
               field196[var3] = field196[var7];
               ++var3;
               field194[var7] = field194[var3];
               field195[var7] = field195[var3];
               field196[var7] = field196[var3];
            }
         }
    ...
    boolean readSubmapFloor() {
      ...
      if (!var1) {
         ...
         int var2 = this.field193.length;

         int var3;
         for(var3 = 0; var3 < var2; ++var3) {
            field194[var3] = this.field193[var3];
         }

         var3 = field192[this.multiplier - 1];
         int var4 = FaceNormal.iLog(var3 - 1);
         field195[0] = VorbisSample.readBits(var4);
         field195[1] = VorbisSample.readBits(var4);
         int var5 = 2;
         ...
         for(int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
            ...
            int var11 = 0;
            if (var9 > 0) {
               var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method287();
            }

            for(int var12 = 0; var12 < var8; ++var12) {
               int var13 = this.subclassBooks[var7][var11 & var10];
               var11 >>>= var9;
               field195[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method287() : 0;
            }
         }
   ...
   @ObfuscatedName("i")
   void method194(float[] var1, int var2) {
      int var3 = this.field193.length;
      int var4 = field192[this.multiplier - 1];
      boolean[] var5 = field196;
      field196[1] = true;
      var5[0] = true;
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = method195(field194, var6);
         var8 = method197(field194, var6);
         var9 = this.method191(field194[var7], field195[var7], field194[var8], field195[var8], field194[var6]);
         var10 = field195[var6];
         int var11 = var4 - var9;
         int var13 = (var11 < var9 ? var11 : var9) << 1;
         if (var10 != 0) {
            boolean[] var14 = field196;
            field196[var8] = true;
            var14[var7] = true;
            field196[var6] = true;
            if (var10 >= var13) {
               field195[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
            } else {
               field195[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
            }
         } else {
            field196[var6] = false;
            field195[var6] = var9;
      ...
      var6 = 0;
      var7 = field195[0] * this.multiplier;

      for(var8 = 1; var8 < var3; ++var8) {
         if (field196[var8]) {
            var9 = field194[var8];
            var10 = field195[var8] * this.multiplier;
            this.method196(var6, var7, var9, var10, var1, var2);
            if (var9 >= var2) {
               return;
            }
   ...
   @ObfuscatedName("f")
   static int method195(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
   ...
   @ObfuscatedName("w")
   static int method197(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
