...
public class VorbisFloor {
   @ObfuscatedName("h")
   static final int[] field185 = new int[]{256, 128, 86, 64};
   @ObfuscatedName("e")
   ...
   VorbisFloor() {
      ...
      if (var1 != 1) {
         ...
         this.field176 = new int[var5];
         this.field176[0] = 0;
         this.field176[1] = 1 << var4;
         var5 = 2;
         ...
         for(var9 = 0; var9 < var2; ++var9) {
            ...
            for(int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
               this.field176[var5++] = VorbisSample.readBits(var4);
            }
         }

         if (field183 == null || field183.length < var5) {
            field183 = new int[var5];
            field184 = new int[var5];
            field177 = new boolean[var5];
         }
   ...
   @ObfuscatedName("v")
   int method213(int var1, int var2, int var3, int var4, int var5) {
      int var6 = var4 - var2;
      int var7 = var3 - var1;
   ...
   @ObfuscatedName("x")
   void method209(int var1, int var2, int var3, int var4, float[] var5, int var6) {
      int var7 = var4 - var2;
      int var8 = var3 - var1;
   ...
   void VarbisFloor_sort(int var1, int var2) {
      if (var1 < var2) {
         int var3 = var1;
         int var4 = field183[var1];
         int var5 = field184[var1];
         boolean var6 = field177[var1];

         for(int var7 = var1 + 1; var7 <= var2; ++var7) {
            int var8 = field183[var7];
            if (var8 < var4) {
               field183[var3] = var8;
               field184[var3] = field184[var7];
               field177[var3] = field177[var7];
               ++var3;
               field183[var7] = field183[var3];
               field184[var7] = field184[var3];
               field177[var7] = field177[var3];
            }
         }
   ...
   boolean readSubmapFloor() {
      ...
      if (!var1) {
         ...
         int var2 = this.field176.length;

         int var3;
         for(var3 = 0; var3 < var2; ++var3) {
            field183[var3] = this.field176[var3];
         }

         var3 = field185[this.multiplier - 1];
         int var4 = Player.iLog(var3 - 1);
         field184[0] = VorbisSample.readBits(var4);
         field184[1] = VorbisSample.readBits(var4);
         int var5 = 2;
         ...
         for(int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
            ...
            int var11 = 0;
            if (var9 > 0) {
               var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method302();
            }

            for(int var12 = 0; var12 < var8; ++var12) {
               int var13 = this.subclassBooks[var7][var11 & var10];
               var11 >>>= var9;
               field184[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method302() : 0;
            }
         }
   ...
   @ObfuscatedName("f")
   void method212(float[] var1, int var2) {
      int var3 = this.field176.length;
      int var4 = field185[this.multiplier - 1];
      boolean[] var5 = field177;
      field177[1] = true;
      var5[0] = true;
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = method211(field183, var6);
         var8 = method208(field183, var6);
         var9 = this.method213(field183[var7], field184[var7], field183[var8], field184[var8], field183[var6]);
         var10 = field184[var6];
         int var11 = var4 - var9;
         int var13 = (var11 < var9 ? var11 : var9) << 1;
         if (var10 != 0) {
            boolean[] var14 = field177;
            field177[var8] = true;
            var14[var7] = true;
            field177[var6] = true;
            if (var10 >= var13) {
               field184[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
            } else {
               field184[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
            }
         } else {
            field177[var6] = false;
            field184[var6] = var9;
      ...
      var6 = 0;
      var7 = field184[0] * this.multiplier;

      for(var8 = 1; var8 < var3; ++var8) {
         if (field177[var8]) {
            var9 = field183[var8];
            var10 = field184[var8] * this.multiplier;
            this.method209(var6, var7, var9, var10, var1, var2);
            if (var9 >= var2) {
               return;
            }
   ...
   @ObfuscatedName("h")
   static int method211(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
   ...
   @ObfuscatedName("e")
   static int method208(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
