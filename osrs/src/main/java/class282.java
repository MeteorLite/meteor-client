...
public final class class282 {
   ...
   static IndexedSprite[] method1535() {
   ...
   static int method1534(int var0, Script var1, boolean var2) {
      if (var0 == 5306) {
         ...
         if (var0 == 5307) {
            ...
            Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = StructComposition.clientPreferences.method551();
            return 1;
         } else if (var0 != 5309) {
            if (var0 == 5310) {
            ...
            var3 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize];
            if (var3 == 1 || var3 == 2) {
               StructComposition.clientPreferences.method557(var3);
            }
   ...
   static final void drawSpriteOnMinimap(int var0, int var1, int var2, int var3, SpritePixels var4, SpriteMask var5) {
      if (var4 != null) {
         ...
         if (var7 <= 6400) {
            ...
            if (var7 > 2500) {
               var4.method2478(var10 + var5.width / 2 - var4.width / 2, var5.height / 2 - var11 - var4.height / 2, var0, var1, var5.width, var5.height, var5.xStarts, var5.xWidths);
            } else {
   ...
   static String method1533(String var0) {
