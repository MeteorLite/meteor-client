...
public class TriBool {
	...
	static int method2273(int var0, int var1) {
		FloorOverlayDefinition var2 = Canvas.method85(var0);
		if (var2 == null) {
			return var1;
		} else {
			int var4;
			...
			if (var2.secondaryRgb >= 0) {
				...
				var8 = UserComparator3.method680(var7, 96);
				return Rasterizer3D.Rasterizer3D_colorPalette[var8] | -16777216;
			} else if (var2.texture >= 0) {
				int var3 = UserComparator3.method680(Rasterizer3D.clips.Rasterizer3D_textureLoader.getAverageTextureRGB(var2.texture), 96);
