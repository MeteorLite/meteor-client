         ...
         if (var0 == 3910) {
            ...
            if (var0 == 3914) {
               ...
               if (EnumComposition.grandExchangeEvents != null) {
                  EnumComposition.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_nameComparator, var13);
               }
               ...
               var13 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
               if (EnumComposition.grandExchangeEvents != null) {
                  EnumComposition.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_priceComparator, var13);
               }
               ...
               var13 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
               if (EnumComposition.grandExchangeEvents != null) {
                  EnumComposition.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_ageComparator, var13);
               }
               ...
               var13 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
               if (EnumComposition.grandExchangeEvents != null) {
                  EnumComposition.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_quantityComparator, var13);
               }
               ...
               if (var0 == 3920) {
                  ...
                  var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                  var11 = (GrandExchangeEvent)EnumComposition.grandExchangeEvents.events.get(var3);
                  Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = var11.getOfferName();
                  return 1;
               } else if (var0 == 3922) {
                  var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                  var11 = (GrandExchangeEvent)EnumComposition.grandExchangeEvents.events.get(var3);
                  Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = var11.getPreviousOfferName();
                  return 1;
               } else if (var0 == 3923) {
                  var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                  var11 = (GrandExchangeEvent)EnumComposition.grandExchangeEvents.events.get(var3);
                  ...
                  var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                  var11 = (GrandExchangeEvent)EnumComposition.grandExchangeEvents.events.get(var3);
                  Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var11.grandExchangeOffer.totalQuantity;
                  return 1;
               } else if (var0 == 3925) {
                  var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                  var11 = (GrandExchangeEvent)EnumComposition.grandExchangeEvents.events.get(var3);
                  Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var11.grandExchangeOffer.unitPrice;
                  return 1;
               } else if (var0 == 3926) {
                  var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                  var11 = (GrandExchangeEvent)EnumComposition.grandExchangeEvents.events.get(var3);
                  Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var11.grandExchangeOffer.id;
                  return 1;
               } else {
                  return 2;
               }
