      ...
      if (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var1][var2] & 2) != 0 || (Tiles.Tiles_renderFlags[var0][var1][var2] & 16) == 0) {
         ...
         if (var8.hasSound()) {
            ...
            if (var22.soundEffectIds != null) {
               var22.field697 = var22.field699 + (int)(Math.random() * (double)(var22.field695 - var22.field699));
            }
         }
         ...
         if (var5 == 22) {
            ...
            if (var5 >= 12) {
               ...
               var6.newBoundaryObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field838[var4], 0, var19, var21);
               if (var4 == 0) {
                  if (var8.clipped) {
               ...
               var6.newBoundaryObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field839[var4], 0, var19, var21);
               if (var8.clipped) {
                  if (var4 == 0) {
                     Tiles.field836[var0][var1][var2 + 1] = 50;
                  } else if (var4 == 1) {
               ...
               if (var5 == 2) {
                  ...
                  var6.newBoundaryObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)var30, Tiles.field838[var4], Tiles.field838[var28], var19, var21);
                  if (var8.modelClipped) {
                     if (var4 == 0) {
                        class312.field3014[var0][var1][var2] |= 585;
                        class312.field3014[var0][var1][var2 + 1] |= 1170;
                  ...
                  var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field838[var4], 0, 0, 0, var19, var21);
               } else {
                  Object var25;
                  long var31;
                  if (var5 == 5) {
                     ...
                     var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, Tiles.field838[var4], 0, var28 * Tiles.field840[var4], var28 * Tiles.field830[var4], var19, var21);
                  } else if (var5 == 6) {
                     var28 = 8;
                     var31 = var6.getBoundaryObjectTag(var0, var1, var2);
                     if (0L != var31) {
                     ...
                     var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, 256, var4, var28 * Tiles.field841[var4], var28 * Tiles.field842[var4], var19, var21);
                  } else if (var5 == 7) {
                     var23 = var4 + 2 & 3;
                     if (var8.animationId == -1 && var8.transforms == null) {
                     ...
                     var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var25, (Renderable)var26, 256, var4, var28 * Tiles.field841[var4], var28 * Tiles.field842[var4], var19, var21);
                  }
               }
            }
         } else {
            ...
            if (var34 != null && var6.method1193(var0, var1, var2, var16, var9, var10, (Renderable)var34, var5 == 11 ? 256 : 0, var19, var21) && var8.clipped) {
               var23 = 15;
