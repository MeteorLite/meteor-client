...
public abstract class UserList {
	...
	static int method2243(int var0, Script var1, boolean var2) {
		int var3;
		int var4;
		int var6;
		if (var0 == 3400) {
			...
			EnumComposition var5 = class271.getEnum(var3);
			if (var5.outputType != 's') {
			}

			for (var6 = 0; var6 < var5.outputCount; ++var6) {
				if (var4 == var5.keys[var6]) {
					Interpreter.Interpreter_stringStack[++class137.Interpreter_stringStackSize - 1] = var5.strVals[var6];
					var5 = null;
					break;
				}
			}
			...
			if (var5 != null) {
				Interpreter.Interpreter_stringStack[++class137.Interpreter_stringStackSize - 1] = var5.defaultStr;
			}
			...
			if (var0 == 3411) {
				var3 = Interpreter.Interpreter_intStack[--SoundCache.Interpreter_intStackSize];
				EnumComposition var10 = class271.getEnum(var3);
				Interpreter.Interpreter_intStack[++SoundCache.Interpreter_intStackSize - 1] = var10.size();
				return 1;
			} else {
				return 2;
			}
			...
			EnumComposition var7 = class271.getEnum(var9);
	...
	static final boolean method2244() {
