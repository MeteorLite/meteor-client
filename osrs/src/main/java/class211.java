      ...
      if (var5 == null) {
         ...
         if (!var4) {
            ...
            if (class374.field3598 == null) {
               ...
               class374.field3598 = new ThreadPoolExecutor(0, class133.field1283, 0L, TimeUnit.MILLISECONDS, new ArrayBlockingQueue(class133.field1283 * 100 + 100), new class130());
            }
