...
public class ArchiveDiskActionHandler implements Runnable {
	...
	@ObfuscatedName("ax")
	static boolean field3543;
	@ObfuscatedName("ao")
	static Object field3545;
		...
		try {
			while (true) {
				...
				if (var1 != null) {
					...
					synchronized(field3545) {
						if ((field3543 || field3544 <= 1) && ArchiveDiskActionHandler_requestQueue.method2028()) {
							field3544 = 0;
							field3545.notifyAll();
							return;
						}
	...
	static void method1914(Font var0, Font var1) {
		if (SecureRandomCallable.worldSelectBackSprites == null) {
			SecureRandomCallable.worldSelectBackSprites = PacketWriter.method646(class199.archive8, "sl_back", "");
		}

		if (PendingSpawn.worldSelectFlagSprites == null) {
			PendingSpawn.worldSelectFlagSprites = InvDefinition.method953(class199.archive8, "sl_flags", "");
		}

		if (ModelData0.worldSelectArrows == null) {
			ModelData0.worldSelectArrows = InvDefinition.method953(class199.archive8, "sl_arrows", "");
		}

		if (TaskHandler.worldSelectStars == null) {
			TaskHandler.worldSelectStars = InvDefinition.method953(class199.archive8, "sl_stars", "");
		}
		...
		if (SecureRandomCallable.worldSelectBackSprites != null) {
			...
			for (var16 = var5 * var15; var16 < World.World_count && var15 - Login.worldSelectPage < var4; ++var16) {
				...
				int var21 = 0;
				if (var17.isBeta()) {
					var20 = var17.isMembersOnly() ? class110.field1122 : class110.field1132;
				} else if (var17.isDeadman()) {
					var20 = var17.isMembersOnly() ? class110.field1126 : class110.field1133;
				} else if (var17.method393()) {
					var21 = 16711680;
					var20 = var17.isMembersOnly() ? class110.field1125 : class110.field1130;
				} else if (var17.method395()) {
					var20 = var17.isMembersOnly() ? class110.field1134 : class110.field1129;
				} else if (var17.isPvp()) {
					var20 = var17.isMembersOnly() ? class110.field1135 : class110.field1127;
				} else if (var17.method396()) {
					var20 = var17.isMembersOnly() ? class110.field1121 : class110.field1124;
				} else if (var17.method397()) {
					var20 = var17.isMembersOnly() ? class110.field1136 : class110.field1131;
				}

				if (var20 == null || var20.field1137 >= SecureRandomCallable.worldSelectBackSprites.length) {
					var20 = var17.isMembersOnly() ? class110.field1128 : class110.field1123;
				}
				...
				if (MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var11 && MouseHandler.MouseHandler_x < var12 + var23 && MouseHandler.MouseHandler_y < var11 + var24 && var18) {
					...
					SecureRandomCallable.worldSelectBackSprites[var20.field1137].drawTransOverlayAt(var12, var11, 128, 16777215);
					var14 = true;
				} else {
					SecureRandomCallable.worldSelectBackSprites[var20.field1137].drawAt(var12, var11);
				}
