...
public class class32 {
   ...
   static int method130(int var0, Script var1, boolean var2) {
      ...
      int var11;
      if (var0 == 1300) {
         var11 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize] - 1;
         if (var11 >= 0 && var11 <= 9) {
         ...
         if (var0 == 1301) {
            ...
            var4.parent = AttackOption.getWidgetChild(var11, var6);
            return 1;
         } else if (var0 == 1302) {
            ...
            if (var0 != 1350) {
               ...
               if (var0 == 1351) {
                  ...
                  var11 = Interpreter.Interpreter_intStack[class87.Interpreter_intStackSize] - 1;
                  if (var11 >= 0 && var11 <= 9) {
                     GrandExchangeOfferTotalQuantityComparator.Widget_setKeyIgnoreHeld(var4, var11);
                     return 1;
                  } else {
                     throw new RuntimeException();
                  }
