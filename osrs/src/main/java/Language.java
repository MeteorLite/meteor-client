...
public class Language implements class342 {
	...
	static final Language field4237;
	@ObfuscatedName("c")
	@ObfuscatedSignature(
		descriptor = "Lmo;"
	)
	...
	static final Language field4239;
	@ObfuscatedName("h")
	@ObfuscatedSignature(
		descriptor = "Lmo;"
	)
	static final Language field4240;
	@ObfuscatedName("j")
	@ObfuscatedSignature(
		descriptor = "Lmo;"
	)
	...
	static final Language field4242;
	@ObfuscatedName("l")
	@ObfuscatedSignature(
		descriptor = "[Lmo;"
	)
	static final Language[] field4246;
	@ObfuscatedName("hw")
	@ObfuscatedSignature(
		descriptor = "Lnl;"
	)
	...
	static {
		...
		field4237 = new Language("DE", "de", "German", ModeWhere.field4262, 1, "DE");
		Language_FR = new Language("FR", "fr", "French", ModeWhere.field4262, 2, "FR");
		field4239 = new Language("PT", "pt", "Portuguese", ModeWhere.field4262, 3, "BR");
		field4240 = new Language("NL", "nl", "Dutch", ModeWhere.field4256, 4, "NL");
		Language_ES = new Language("ES", "es", "Spanish", ModeWhere.field4256, 5, "ES");
		field4242 = new Language("ES_MX", "es-mx", "Spanish (Latin American)", ModeWhere.field4262, 6, "MX");
		Language[] var0 = method6568();
		field4246 = new Language[var0.length];
		Language[] var1 = var0;

		for (int var2 = 0; var2 < var1.length; ++var2) {
			Language var3 = var1[var2];
			if (field4246[var3.id] != null) {
				throw new IllegalStateException();
			}

			field4246[var3.id] = var3;
		}
	...
	static Language[] method6568() {
		return new Language[]{Language_FR, Language_EN, field4239, field4240, field4242, Language_ES, field4237};
	}
	...
	public static Language method6580(int var0) {
		return var0 >= 0 && var0 < field4246.length ? field4246[var0] : null;
	}
