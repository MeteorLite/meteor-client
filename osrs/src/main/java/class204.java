            ...
            if (var4.isInteractable) {
               if (!var4.isFollower || Client.followerIndex == var1) {
                  ...
                  if (var4.combatLevel != 0 && var0.combatLevelChange != 0) {
                     var6 = var0.combatLevelChange != -1 ? var0.combatLevelChange * -1605021683 * 1962901189 : var4.combatLevel * 1652634765 * 176795205;
                  ...
                  if (var4.isFollower && Client.followerOpsLowPriority) {
                     WorldMapManager.insertMenuItemNoShift("Examine", class149.colorStartTag(16776960) + var5, 1003, var1, var2, var3);
                  }

                  if (Client.isItemSelected == 1) {
                     WorldMapManager.insertMenuItemNoShift("Use", Client.selectedItemName + " " + "->" + " " + class149.colorStartTag(16776960) + var5, 7, var1, var2, var3);
                  } else if (Client.isSpellSelected) {
                     if ((class149.selectedSpellFlags & 2) == 2) {
                        WorldMapManager.insertMenuItemNoShift(Client.selectedSpellActionName, Client.selectedSpellName + " " + "->" + " " + class149.colorStartTag(16776960) + var5, 8, var1, var2, var3);
                     }
                  } else {
                     ...
                     if (var7 != null) {
                        for(var11 = 4; var11 >= 0; --var11) {
                           if (var0.method560(var11) && var7[var11] != null && !var7[var11].equalsIgnoreCase("Attack")) {
                              var9 = 0;
                              if (var11 == 0) {
                                 var9 = var6 + 9;
                              }
                              ...
                              WorldMapManager.insertMenuItemNoShift(var7[var11], class149.colorStartTag(16776960) + var5, var9, var1, var2, var3);
                           }
                        }
                     }
