...
public class WorldMapSection0 implements WorldMapSection {
	...
	static final void updateNpcs(boolean var0, PacketBuffer var1) {
		...
		for (var2 = 0; var2 < Client.field550; ++var2) {
			...
			if ((var16 & 2) != 0) {
				var14.spotAnimation = var1.method8444();
				var6 = var1.readInt();
				var14.field1159 = var6 >> 16;
				var14.field1186 = (var6 & 65535) + Client.cycle;
			...
			if ((var16 & 8) != 0) {
				...
				if (var7 > 0) {
					for (var8 = 0; var8 < var7; ++var8) {
						...
						if (var10 != 32767) {
							var17 = var1.readUShortSmart();
							var12 = var1.method8623();
							int var13 = var10 > 0 ? var1.method8435() : var12;
			...
			if ((var16 & 512) != 0) {
				var14.field1212 = var1.method8456();
			}
			...
			if ((var16 & 1024) != 0) {
				var14.field1150 = var1.method8617();
				var14.field1190 = var1.method8469();
				var14.field1189 = var1.method8617();
				...
				var14.field1194 = var1.method8446();
				var14.pathLength = 1;
				var14.field1211 = 0;
			...
			if ((var16 & 4096) != 0) {
				var14.field1197 = Client.cycle + var1.method8446();
				var14.field1198 = Client.cycle + var1.method8484();
				var14.field1199 = var1.readByte();
				var14.field1200 = var1.method8440();
				var14.field1185 = var1.readByte();
				var14.field1202 = (byte)var1.readUnsignedByte();
			}

			if ((var16 & 1) != 0) {
				var14.targetIndex = var1.method8444();
				if (GameObject.field2733) {
					var14.targetIndex += var1.method8435() << 16;
					var6 = 16777215;
				} else {
					var6 = 65535;
				}
			...
			if ((var16 & 16) != 0) {
				var14.definition = HealthBarDefinition.getNpcDefinition(var1.method8444());
			...
			if ((var16 & 256) != 0) {
				var14.method2489(var1.method8435());
			}
		}
