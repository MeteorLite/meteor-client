...
public abstract class AbstractArchive {
	...
	void decodeIndex(byte[] var1) {
		...
		int var2 = class174.method885(var1, 0, var3);
		this.hash = var2;
	...
	public byte[] takeFileEncrypted(int var1, int var2, int[] var3) {
		if (var1 >= 0 && var1 < this.files.length && this.files[var1] != null && var2 >= 0 && var2 < this.files[var1].length) {
			...
			byte[] var5 = class128.method694(this.files[var1][var2], false);
	...
	public boolean method1930(int var1) {
	...
	public byte[] getFile(int var1, int var2) {
		if (var1 >= 0 && var1 < this.files.length && this.files[var1] != null && var2 >= 0 && var2 < this.files[var1].length) {
			...
			byte[] var4 = class128.method694(this.files[var1][var2], false);
			return var4;
		} else {
			return null;
		}
		...
		if (this.groups[var1] == null) {
			...
			if (var6) {
				...
				if (var2 != null && (var2[0] != 0 || var2[1] != 0 || var2[2] != 0 || var2[3] != 0)) {
					var18 = class128.method694(this.groups[var1], true);
					Buffer var8 = new Buffer(var18);
					var8.xteaDecrypt(var2, 5, var8.array.length);
				} else {
					var18 = class128.method694(this.groups[var1], false);
				}
				...
				if (var3 > 1) {
					...
					for (var15 = 0; var15 < var3; ++var15) {
						if (!this.shallowFiles) {
							var5[var4[var15]] = VarcInt.method899(var19[var15], false);
						} else {
							var5[var4[var15]] = var19[var15];
						}
					}
				} else if (!this.shallowFiles) {
					var5[var4[0]] = VarcInt.method899(var20, false);
				} else {
					var5[var4[0]] = var20;
				}
