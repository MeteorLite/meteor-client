...
public abstract class AbstractArchive {
	...
	void decodeIndex(byte[] var1) {
		...
		if (var5 >= 5 && var5 <= 7) {
			...
			if (var5 >= 7) {
				this.groupCount = var15.method2562();
			} else {
			...
			if (var5 >= 7) {
				for (var9 = 0; var9 < this.groupCount; ++var9) {
					this.groupIds[var9] = var7 += var15.method2562();
			...
			if (var5 >= 7) {
				for (var9 = 0; var9 < this.groupCount; ++var9) {
					...
					for (var13 = 0; var13 < var11; ++var13) {
						var14 = this.fileIds[var10][var13] = var7 += var15.method2562();
						if (var14 > var12) {
							var12 = var14;
						}
					}
	...
	public byte[] takeFileEncrypted(int var1, int var2, int[] var3) {
		if (var1 >= 0 && var1 < this.files.length && this.files[var1] != null && var2 >= 0 && var2 < this.files[var1].length) {
			...
			byte[] var5 = class126.method699(this.files[var1][var2], false);
	...
	public boolean method1906(int var1) {
	...
	public byte[] getFile(int var1, int var2) {
		if (var1 >= 0 && var1 < this.files.length && this.files[var1] != null && var2 >= 0 && var2 < this.files[var1].length) {
			...
			byte[] var4 = class126.method699(this.files[var1][var2], false);
			return var4;
		} else {
			return null;
		}
		...
		if (this.groups[var1] == null) {
			...
			if (var6) {
				...
				if (var2 != null && (var2[0] != 0 || var2[1] != 0 || var2[2] != 0 || var2[3] != 0)) {
					var21 = class126.method699(this.groups[var1], true);
					Buffer var8 = new Buffer(var21);
					var8.xteaDecrypt(var2, 5, var8.array.length);
				} else {
					var21 = class126.method699(this.groups[var1], false);
				}
	...
	static void readPlayerUpdate(PacketBuffer var0, int var1) {
		...
		if (var3 == 0) {
			if (var2) {
				...
				Players.Players_regions[var1] = (var4.plane << 28) + (class47.baseY + var4.pathY[0] >> 13) + (UrlRequester.baseX + var4.pathX[0] >> 13 << 14);
			...
			if (var3 == 1) {
				...
				if (var5 == 0) {
					...
					var8 = var6 >> 14 & 16383;
					var9 = var6 & 16383;
					var10 = (var8 + UrlRequester.baseX + var4.pathX[0] & 16383) - UrlRequester.baseX;
					var11 = (var9 + class47.baseY + var4.pathY[0] & 16383) - class47.baseY;
					if (Client.localPlayerIndex != var1 || var4.x >= 1536 && var4.y >= 1536 && var4.x < 11776 && var4.y < 11776) {
						if (var2) {
							var4.hasMovementPending = true;
							var4.tileX = var10;
