...
public class DevicePcmPlayer extends PcmPlayer {
	...
	@Export("init")
	public void init() {
		this.format = new AudioFormat((float)PcmPlayer.field179, 16, class306.PcmPlayer_stereo ? 2 : 1, true, false);
	...
	public void open(int var1) throws LineUnavailableException {
		try {
			...
			if (WorldMapLabel.method1569(var1) != 1) {
				this.open(EnumComposition.method999(var1));
			} else {
				this.line = null;
				throw var3;
			}
