...
public class class144 extends class152 {
   ...
   static int method3143(int var0, Script var1, boolean var2) {
      if (var0 == 5000) {
         ...
         PacketBufferNode var13 = class136.getPacketBufferNode(ClientPacket.field3085, Client.packetWriter.isaacCipher);
         ...
         if (var0 == 5002) {
            ...
            var6 = class136.getPacketBufferNode(ClientPacket.field3087, Client.packetWriter.isaacCipher);
            ...
            if (var0 == 5003) {
               ...
               if (var0 == 5004) {
                  ...
                  if (var0 == 5008) {
                     ...
                     var12 = class136.getPacketBufferNode(ClientPacket.field3118, Client.packetWriter.isaacCipher);
               ...
               if (var9.contentType == 1337) {
                  ...
                  if (var9.isIf3) {
                     ...
                     if (var9.hasListener) {
                        ...
                        if (var9.onInvTransmit != null && Client.changedItemContainersCount > var9.field3668) {
                           if (var9.invTransmitTriggers != null && Client.changedItemContainersCount - var9.field3668 <= 32) {
                              label809:
                              for(var39 = var9.field3668; var39 < Client.changedItemContainersCount; ++var39) {
                           ...
                           var9.field3668 = Client.changedItemContainersCount;
                        }
