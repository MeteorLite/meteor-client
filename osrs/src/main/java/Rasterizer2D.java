...
public class Rasterizer2D extends DualNode {
	...
	@ObfuscatedName("dr")
	protected static void method2659(int[] var0, int var1, int var2, float[] var3) {
	...
	public static void Rasterizer2D_drawRectangle(int var0, int var1, int var2, int var3, int var4) {
		method2675(var0, var1, var2, var4);
		method2675(var0, var3 + var1 - 1, var2, var4);
		method2677(var0, var1, var3, var4);
		method2677(var0 + var2 - 1, var1, var3, var4);
	}
	...
	@ObfuscatedName("ek")
	public static void method2675(int var0, int var1, int var2, int var3) {
	...
	@ObfuscatedName("ez")
	public static void method2677(int var0, int var1, int var2, int var3) {
	...
	public static void Rasterizer2D_drawLine(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var3 == 0) {
			if (var2 >= 0) {
				method2675(var0, var1, var2 + 1, var4);
			} else {
				method2675(var0 + var2, var1, -var2 + 1, var4);
			}

		} else if (var2 == 0) {
			if (var3 >= 0) {
				method2677(var0, var1, var3 + 1, var4);
			} else {
				method2677(var0, var3 + var1, -var3 + 1, var4);
			}
	...
	public static void method2682() {
		if (field4244 != null) {
			...
			if (Rasterizer2D_xClipStart == 0 && Rasterizer2D_xClipEnd == Rasterizer2D_width && Rasterizer2D_yClipStart == 0 && Rasterizer2D_yClipEnd == Rasterizer2D_height) {
				var0 = field4244.length;
				var1 = var0 - (var0 & 7);

				for (var2 = 0; var2 < var1; field4244[var2++] = 0.0F) {
					field4244[var2++] = 0.0F;
					field4244[var2++] = 0.0F;
					field4244[var2++] = 0.0F;
					field4244[var2++] = 0.0F;
	...
	public static void method2683() {
		if (field4244 != null) {
			int var0 = field4244.length;

			for (int var1 = 0; var1 < var0; ++var1) {
				if (var1 % Rasterizer2D_width < Rasterizer2D_width / 2 && field4244[var1] > 0.0F) {
					float var3 = field4244[var1];
					float var4 = 75.0F;
					float var5 = 10000.0F;
