...
public class Rasterizer2D extends DualNode {
	...
	@ObfuscatedName("eh")
	protected static void method2637(int[] var0, int var1, int var2, float[] var3) {
	...
	public static void method2660() {
		if (field4245 != null) {
			...
			if (Rasterizer2D_xClipStart == 0 && Rasterizer2D_xClipEnd == Rasterizer2D_width && Rasterizer2D_yClipStart == 0 && Rasterizer2D_yClipEnd == Rasterizer2D_height) {
				var0 = field4245.length;
				var1 = var0 - (var0 & 7);

				for (var2 = 0; var2 < var1; field4245[var2++] = 0.0F) {
					field4245[var2++] = 0.0F;
					field4245[var2++] = 0.0F;
					field4245[var2++] = 0.0F;
					field4245[var2++] = 0.0F;
	...
	public static void method2661() {
		if (field4245 != null) {
			int var0 = field4245.length;

			for (int var1 = 0; var1 < var0; ++var1) {
				if (var1 % Rasterizer2D_width < Rasterizer2D_width / 2 && field4245[var1] > 0.0F) {
					float var3 = field4245[var1];
					float var4 = 75.0F;
					float var5 = 10000.0F;
