...
public class ScriptFrame {
   ...
   static final void method331(int var0, int var1, int var2) {
      int var3;
   ...
   public static final PcmPlayer method329(TaskHandler var0, int var1, int var2) {
      if (PcmPlayer.field198 == 0) {
         ...
         try {
            ...
            if (class34.field95 > 0 && PcmPlayer.soundSystem == null) {
   ...
   static final void method333(String var0, String var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   static final void method332(int var0, int var1) {
      ClanChannel var2 = var0 >= 0 ? Client.currentClanChannels[var0] : VarcInt.guestClanChannel;
      if (var2 != null && var1 >= 0 && var1 < var2.method828()) {
         ClanChannelMember var3 = (ClanChannelMember)var2.members.get(var1);
         if (var3.rank == -1) {
            String var4 = var3.username.getName();
            PacketBufferNode var5 = class136.getPacketBufferNode(ClientPacket.field2526, Client.packetWriter.isaacCipher);
   ...
   static String method330(String var0, boolean var1) {
