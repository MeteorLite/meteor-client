					...
					if (var3.sequenceId != -1 || var3.sequenceId2 != -1) {
						...
						if (var5 != -1) {
							...
							if (!var6.isCachedModelIdSet()) {
								for (var3.modelFrameCycle += Client.field460; var3.modelFrameCycle > var6.frameLengths[var3.modelFrame]; ClanChannelMember.invalidateWidget(var3)) {
