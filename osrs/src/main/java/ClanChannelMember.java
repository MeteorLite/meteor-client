...
public class ClanChannelMember {
	...
	static final int method775(int var0, int var1, int var2, int var3) {
	...
	static final void method777(Actor var0) {
		...
		int var7;
		if (var0.pathLength == 0 || var0.field1021 > 0) {
			var7 = -1;
			if (var0.field988 != -1 && var0.field989 != -1) {
				var2 = var0.field988 * 128 - UrlRequester.baseX * 128 + 64;
				var3 = var0.field989 * 128 - class47.baseY * 128 + 64;
				var4 = var0.x - var2;
		...
		if (var7 != 0) {
			...
			++var0.field1010;
			var4 = var7 > 1024 ? -1 : 1;
			var0.rotation += var0.field1017 * var4;
			boolean var12 = true;
			if (var7 < var0.field1017 || var7 > 2048 - var0.field1017) {
				var0.rotation = var0.orientation;
				var12 = false;
			}

			if (var0.field1017 > 0 && var0.movementSequence == var0.idleSequence && (var0.field1010 > 25 || var12)) {
	...
	static final void method778(Widget var0) {
		String var1;
		int var2;
		int var3;
		...
		if (var0.buttonType == 2 && !Client.isSpellSelected) {
			...
			if (var1 != null) {
				var9 = MoveSpeed.colorStartTag(65280) + var0.field3097;
				var3 = var0.id;
				var4 = var0.itemId;
		...
		if (var0.isIf3) {
			...
			if (Client.isSpellSelected) {
				var2 = NewShit.getWidgetFlags(var0);
				boolean var10 = (var2 >> 21 & 1) != 0;
				if (var10 && (Canvas.selectedSpellFlags & 32) == 32) {
					var11 = Client.field600;
					var12 = Client.field601 + " " + "->" + " " + var0.dataText;
				...
				for (int var16 = 9; var16 >= 5; --var16) {
					var4 = NewShit.getWidgetFlags(var0);
				...
				for (var2 = 4; var2 >= 0; --var2) {
					var5 = NewShit.getWidgetFlags(var0);
				...
				var3 = NewShit.getWidgetFlags(var0);
