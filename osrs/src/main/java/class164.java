...
public class class164 {
	...
	public static int[] method863(byte[] var0) {
		if (var0 != null && var0.length != 0 && var0.length <= 8) {
			int[] var1 = new int[var0.length];

			for (int var2 = 0; var2 < var0.length; ++var2) {
				if (var0[var2] < 0 || var0[var2] > class538.field4284.length) {
					return null;
				}

				var1[var2] = class538.field4284[var0[var2]];
			}
	...
	static final void method864() {
		if (Client.field538 != HealthBar.Client_plane) {
			Client.field538 = HealthBar.Client_plane;
			class17.method50(HealthBar.Client_plane);
		}
	...
	static final void drawScrollBar(int var0, int var1, int var2, int var3, int var4) {
		...
		Rasterizer2D.Rasterizer2D_fillRectangle(var0, var1 + 16, 16, var3 - 32, Client.field462);
		...
		Rasterizer2D.Rasterizer2D_drawVerticalLine(var0, var6 + var1 + 16, var5, Client.field460);
		Rasterizer2D.Rasterizer2D_drawVerticalLine(var0 + 1, var6 + var1 + 16, var5, Client.field460);
		Rasterizer2D.Rasterizer2D_drawHorizontalLine(var0, var6 + var1 + 16, 16, Client.field460);
		Rasterizer2D.Rasterizer2D_drawHorizontalLine(var0, var6 + var1 + 17, 16, Client.field460);
