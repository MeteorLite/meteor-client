...
final class class108 implements class337 {
	...
	public void vmethod5708() {
		if (this.val$cc != null && this.val$cc.method1880().field2935 != null) {
			ScriptEvent var1 = new ScriptEvent();
			var1.method470(this.val$cc);
			var1.setArgs(this.val$cc.method1880().field2935);
	...
	static int method619(PacketBuffer var0) {
	...
	static final void addSceneMenuOptions(int var0, int var1, int var2, int var3) {
		...
		while (true) {
			...
			if (var6 != var26) {
				label309: {
					var6 = var26;
					int var15 = HealthBar.method575(var8);
					int var16 = class228.method1169(var8);
					long var19 = ViewportMouse.ViewportMouse_entityTags[var8];
					int var18 = (int)(var19 >>> 14 & 3L);
					int var28 = GrandExchangeOfferOwnWorldComparator.method348(var8);
					int var23;
					if (var18 == 2 && class10.scene.getObjectFlags(class87.Client_plane, var15, var16, var26) >= 0) {
						...
						for (PendingSpawn var22 = (PendingSpawn)Client.pendingSpawns.last(); var22 != null; var22 = (PendingSpawn)Client.pendingSpawns.previous()) {
							if (var22.plane == class87.Client_plane && var15 == var22.x && var16 == var22.y && var28 == var22.id) {
								var21 = var22;
								break;
							}
						}
						...
						if (Client.isItemSelected == 1) {
							class153.insertMenuItemNoShift("Use", Client.field598 + " " + "->" + " " + Client.colorStartTag(65535) + var20.name, 1, var28, var15, var16);
						} else if (Client.isSpellSelected) {
							if ((class31.field82 & 4) == 4) {
								class153.insertMenuItemNoShift(Client.field599, Client.field600 + " " + "->" + " " + Client.colorStartTag(65535) + var20.name, 2, var28, var15, var16);
							}
						} else {
							String[] var36 = var20.actions;
							if (var36 != null) {
								for (var23 = 4; var23 >= 0; --var23) {
									if ((var21 == null || var21.method507(var23)) && var36[var23] != null) {
										short var24 = 0;
										if (var23 == 0) {
											var24 = 3;
										}
					...
					if (var18 == 3) {
						...
						if (var34 != null) {
							for (TileItem var35 = (TileItem)var34.first(); var35 != null; var35 = (TileItem)var34.next()) {
								...
								if (Client.isItemSelected == 1) {
									class153.insertMenuItemNoShift("Use", Client.field598 + " " + "->" + " " + Client.colorStartTag(16748608) + var39.name, 16, var35.id, var15, var16);
								} else if (Client.isSpellSelected) {
									if ((class31.field82 & 1) == 1) {
										class153.insertMenuItemNoShift(Client.field599, Client.field600 + " " + "->" + " " + Client.colorStartTag(16748608) + var39.name, 17, var35.id, var15, var16);
									}
								} else {
									String[] var31 = var39.groundActions;

									for (int var40 = 4; var40 >= 0; --var40) {
										if (var35.method612(var40)) {
	...
	static final void updateInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		for (int var8 = 0; var8 < var0.length; ++var8) {
			...
			if (var9 != null && var9.parentId == var1 && (var9.method1859() || MouseRecorder.getWidgetFlags(var9) != 0 || var9 == Client.clickedWidgetParent)) {
				if (var9.isIf3) {
				...
				if (var9.type == 11) {
					if (var9.method1874(class33.widgetDefinition, AbstractWorldMapIcon.urlRequester)) {
						...
						if (var9.field3117 != null) {
							ScriptEvent var10 = new ScriptEvent();
							var10.widget = var9;
							var10.args = var9.field3117;
				...
				if (var9 == Client.clickedWidget) {
					...
					Client.field521 = var26;
					Client.field517 = var11;
				}

				boolean var34 = false;
				if (var9.field2998) {
					switch(Client.field508) {
					case 0:
						var34 = true;
					case 1:
					default:
						break;
					case 2:
						if (Client.field505 == var9.id >>> 16) {
							var34 = true;
						}
						break;
					case 3:
						if (var9.id == Client.field505) {
							var34 = true;
						}
					}
				}
					...
					if (var9.contentType == 1337) {
						...
						if (!Client.isMenuOpen && var35) {
							if (var9.contentType == 1400) {
								...
								FloorDecoration.method1226(var9);
							}
						}
						...
						int var23;
						if (var34) {
							for (int var20 = 0; var20 < var9.field3006.length; ++var20) {
								var21 = false;
								boolean var22 = false;
								if (!var21 && var9.field3006[var20] != null) {
									for (var23 = 0; var23 < var9.field3006[var20].length; ++var23) {
										boolean var24 = false;
										if (var9.field3080 != null) {
											var24 = Client.keyHandlerInstance.getKeyPressed(var9.field3006[var20][var23]);
										}

										if (class131.method707(var9.field3006[var20][var23]) || var24) {
											var21 = true;
											if (var9.field3080 != null && var9.field3080[var20] > Client.cycle) {
												break;
											}

											byte var25 = var9.field3005[var20][var23];
								...
								if (var22) {
									if (var20 < 10) {
										...
										class286.method1575();
										class478.method2385(var9.id, var9.childIndex, KitDefinition.Widget_unpackTargetMask(MouseRecorder.getWidgetFlags(var9)), var9.itemId);
										Client.field599 = class155.Widget_getSpellActionName(var9);
										if (Client.field599 == null) {
											Client.field599 = "null";
										}

										Client.field600 = var9.dataText + Client.colorStartTag(16777215);
									}

									var23 = var9.field3074[var20];
									if (var9.field3080 == null) {
										var9.field3080 = new int[var9.field3006.length];
									}

									if (var9.field3075 == null) {
										var9.field3075 = new int[var9.field3006.length];
									}

									if (var23 != 0) {
										if (var9.field3080[var20] == 0) {
											var9.field3080[var20] = var23 + Client.cycle + var9.field3075[var20];
										} else {
						...
						if (var9.isIf3) {
							...
							if (var9.method1860()) {
								if (var21) {
									Client.field626.addFirst(new class225(0, MouseHandler.MouseHandler_x - var26, MouseHandler.MouseHandler_y - var11, var9));
								}

								if (var36) {
									Client.field626.addFirst(new class225(1, MouseHandler.MouseHandler_x - var26, MouseHandler.MouseHandler_y - var11, var9));
								}
							}

							if (var9.contentType == 1400) {
								class434.worldMap.method2424(var17, var18, var35 & var36, var35 & var21);
							}

							if (Client.clickedWidget != null && var9 != Client.clickedWidget && var35 && class517.method2527(MouseRecorder.getWidgetFlags(var9))) {
								Client.draggedOnWidget = var9;
							}

							if (var9 == Client.clickedWidgetParent) {
								Client.field396 = true;
								Client.field516 = var26;
								Client.field514 = var11;
							}
							...
							if (var9.hasListener) {
								...
								if (var9.field3002 && var36 && var9.onClickRepeat != null) {
									var28 = new ScriptEvent();
									var28.field861 = true;
									var28.widget = var9;
								...
								if (var9.field3002 && !var36) {
									var9.field3002 = false;
								...
								if (var9.field3000 && var35 && var9.onMouseRepeat != null) {
									var28 = new ScriptEvent();
									var28.field861 = true;
									var28.widget = var9;
									var28.mouseX = MouseHandler.MouseHandler_x - var26;
								...
								int var37;
								int var38;
								if (var9.onVarTransmit != null && Client.changedVarpCount > var9.field3068) {
									if (var9.varTransmitTriggers != null && Client.changedVarpCount - var9.field3068 <= 32) {
										label647:
										for (var37 = var9.field3068; var37 < Client.changedVarpCount; ++var37) {
									...
									var9.field3068 = Client.changedVarpCount;
								}

								if (var9.onInvTransmit != null && Client.changedItemContainersCount > var9.field3070) {
									if (var9.invTransmitTriggers != null && Client.changedItemContainersCount - var9.field3070 <= 32) {
										label623:
										for (var37 = var9.field3070; var37 < Client.changedItemContainersCount; ++var37) {
									...
									var9.field3070 = Client.changedItemContainersCount;
								}

								if (var9.onStatTransmit != null && Client.changedSkillsCount > var9.field3064) {
									if (var9.statTransmitTriggers != null && Client.changedSkillsCount - var9.field3064 <= 32) {
										label599:
										for (var37 = var9.field3064; var37 < Client.changedSkillsCount; ++var37) {
									...
									var9.field3064 = Client.changedSkillsCount;
								}

								if (Client.chatCycle > var9.field3071 && var9.onChatTransmit != null) {
									var28 = new ScriptEvent();
									var28.widget = var9;
								...
								if (Client.field511 > var9.field3071 && var9.onFriendTransmit != null) {
									var28 = new ScriptEvent();
									var28.widget = var9;
								...
								if (Client.field530 > var9.field3071 && var9.onClanTransmit != null) {
									var28 = new ScriptEvent();
									var28.widget = var9;
								...
								if (Client.field525 > var9.field3071 && var9.field3113 != null) {
									var28 = new ScriptEvent();
									var28.widget = var9;
									var28.args = var9.field3113;
									Client.scriptEvents.addFirst(var28);
								}

								if (Client.field528 > var9.field3071 && var9.field3096 != null) {
									var28 = new ScriptEvent();
									var28.widget = var9;
									var28.args = var9.field3096;
									Client.scriptEvents.addFirst(var28);
								}

								if (Client.field529 > var9.field3071 && var9.onStockTransmit != null) {
									var28 = new ScriptEvent();
									var28.widget = var9;
								...
								if (Client.field526 > var9.field3071 && var9.field3118 != null) {
									var28 = new ScriptEvent();
									var28.widget = var9;
									var28.args = var9.field3118;
									Client.scriptEvents.addFirst(var28);
								}

								if (Client.field527 > var9.field3071 && var9.onMiscTransmit != null) {
									var28 = new ScriptEvent();
									var28.widget = var9;
								...
								if (var9.field3100 != null) {
									...
									for (var23 = 0; var23 < var39.length; ++var23) {
										...
										var31.args = var9.field3100;
										Client.scriptEvents.addFirst(var31);
									}
								}

								if (var9.field3104 != null) {
									var39 = Client.keyHandlerInstance.method1153();

									for (var23 = 0; var23 < var39.length; ++var23) {
										var31 = new ScriptEvent();
										var31.widget = var9;
										var31.keyTyped = var39[var23];
										var31.args = var9.field3104;
										Client.scriptEvents.addFirst(var31);
									}
								}
							}
						...
						if (!var9.isIf3) {
							...
							if (var9.type == 8 && MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14 && MouseHandler.MouseHandler_y < var15) {
								GrandExchangeOfferNameComparator.field3615 = var9;
							}

							if (var9.scrollHeight > var9.height) {
								class305.method1638(var9, var26 + var9.width, var11, var9.height, var9.scrollHeight, MouseHandler.MouseHandler_x, MouseHandler.MouseHandler_y);
							}
						}
						...
						if (var9.type == 0) {
							...
							if (var32 != null) {
								...
								class511.updateRootInterface(var32.group, var12, var13, var14, var15, var26, var11);
							}
						}
					}
				}
