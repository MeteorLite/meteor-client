...
public class class151 extends class161 {
	...
	void vmethod3238(Buffer var1) {
		...
		this.field1344 = var1.readUnsignedShort();
		var1.readLong();
		this.field1345 = var1.readStringCp1252NullTerminated();
	}
	...
	void vmethod3239(ClanChannel var1) {
		...
		var2.rank = this.field1342;
		var2.world = this.field1344;
		var2.username = new Username(this.field1345);
	}
	...
	static final void loadRegions(boolean var0, PacketBuffer var1) {
		...
		if (!Client.isInInstance) {
			...
			MouseRecorder.method478(var3, var2, true);
		} else {
			...
			MouseRecorder.method478(var4, var2, !var15);
		}
