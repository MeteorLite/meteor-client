				...
				if (var7 == '<') {
					...
					if (var4 == -1) {
						...
						if (AbstractFont_strike != -1) {
							Rasterizer2D.method2617(var2, var3 + (int)((double)this.ascent * 0.7D), var13, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) {
							Rasterizer2D.method2617(var2, var3 + this.ascent + 1, var13, AbstractFont_underline);
						}
			...
			if (var1.charAt(var10) != 0) {
				...
				if (var11 == '<') {
					...
					if (var7 == -1) {
						...
						if (AbstractFont_strike != -1) {
							Rasterizer2D.method2617(var2, var3 + (int)((double)this.ascent * 0.7D), var17, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) {
							Rasterizer2D.method2617(var2, var3 + this.ascent, var17, AbstractFont_underline);
						}
