...
public final class class410 {
   ...
   float[] method7780() {
      ...
      if ((double)this.field4612[2] < 0.999D && (double)this.field4612[2] > -0.999D) {
         ...
         var1[0] = 0.0F;
         var1[1] = (float)Math.atan2((double)this.field4612[2], 0.0D);
   ...
   public void method7830(class410 var1) {
      for(int var2 = 0; var2 < this.field4612.length; ++var2) {
         this.field4612[var2] += var1.field4612[var2];
      }
   ...
   public int hashCode() {
      boolean var1 = true;
      byte var2 = 1;
      int var3 = 31 * var2 + Arrays.hashCode(this.field4612);
      return var3;
   }
