...
public class FloorOverlayDefinition extends DualNode {
	...
	static int method1038(int var0, Script var1, boolean var2) {
		Widget var3;
		if (var0 == 2700) {
			...
			var3 = HealthBarDefinition.widgetDefinition.method1733(Interpreter.Interpreter_intStack[--DbTableType.Interpreter_intStackSize]);
			return GrandExchangeOfferTotalQuantityComparator.method1965(var3);
		} else {
			return 2;
		}
	}
	...
	static void widgetDefaultMenuAction(int var0, int var1, int var2, int var3, String var4) {
		...
		if (var5 != null) {
			...
			if (var5.contentType > 0) {
				var8 = class101.method597(var5);
			}

			if (var8) {
				if (GraphicsObject.method428(class361.getWidgetFlags(var5), var0 - 1)) {
