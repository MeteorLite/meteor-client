...
public class PacketWriter {
	...
	ServerPacket field1167;
	@ObfuscatedName("ax")
	@ObfuscatedSignature(
		descriptor = "Llu;"
	)
	ServerPacket field1168;
	@ObfuscatedName("as")
	@ObfuscatedSignature(
		descriptor = "Llu;"
	)
	ServerPacket field1166;
	...
	static void method643() {
		try {
			...
			if (var0.exists()) {
				...
				label34:
				for (int var1 = 0; var1 < class85.field859.length; ++var1) {
					for (var2 = 0; var2 < GameObject.field2480.length; ++var2) {
						File var3 = new File(GameObject.field2480[var2] + class85.field859[var1] + File.separatorChar + "random.dat");
						if (var3.exists()) {
