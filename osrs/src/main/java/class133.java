...
public class class133 implements class124 {
	...
	@ObfuscatedName("aw")
	static double method726(double var0) {
	...
	static int method728(Widget var0) {
		if (var0.type != 11) {
			Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize - 1] = "";
			return 1;
		} else {
			String var1 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
			Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var0.method1797(var1);
			return 1;
		}
	}
