...
public class WorldMapData_0 extends AbstractWorldMapData {
	...
	void init(Buffer var1) {
		...
		if (var2 != class251.field2079.field2080) {
	...
	public static AbstractSocket method1178(Socket var0, int var1, int var2) throws IOException {
	...
	public static String method1179(CharSequence var0) {
