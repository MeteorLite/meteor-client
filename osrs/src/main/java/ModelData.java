...
public class ModelData extends Renderable {
	...
	public ModelData(ModelData[] var1, int var2) {
		...
		if (var9) {
			this.field2149 = new int[this.verticesCount][];
			this.field2151 = new int[this.verticesCount][];
		}
		...
		for (var10 = 0; var10 < var2; ++var10) {
			...
			if (var11 != null) {
				...
				for (var12 = 0; var12 < var11.faceCount; ++var12) {
					...
					this.indices1[this.faceCount] = this.method1389(var11, var11.indices1[var12]);
					this.indices2[this.faceCount] = this.method1389(var11, var11.indices2[var12]);
					this.indices3[this.faceCount] = this.method1389(var11, var11.indices3[var12]);
					++this.faceCount;
				}
				...
				for (var12 = 0; var12 < var11.textureTriangleCount; ++var12) {
					...
					if (var13 == 0) {
						this.texTriangleX[this.textureTriangleCount] = (short)this.method1389(var11, var11.texTriangleX[var12]);
						this.texTriangleY[this.textureTriangleCount] = (short)this.method1389(var11, var11.texTriangleY[var12]);
						this.texTriangleZ[this.textureTriangleCount] = (short)this.method1389(var11, var11.texTriangleZ[var12]);
					}
	...
	ModelData(byte[] var1) {
		...
		if (var1[var1.length - 1] == -3 && var1[var1.length - 2] == -1) {
			...
			this.method1388(var1);
		}

	}

	@ObfuscatedSignature(
		descriptor = "(Lkq;ZZZZ)V",
		garbageValue = "1"
	)
	...
	void method1385(byte[] var1) {
		...
		if (var18 == 1) {
			for (var53 = 0; var53 < var9; ++var53) {
				...
				this.field2149[var53] = new int[var54];
				this.field2151[var53] = new int[var54];

				for (var55 = 0; var55 < var54; ++var55) {
					this.field2149[var53][var55] = var6.readUnsignedByte();
					this.field2151[var53][var55] = var6.readUnsignedByte();
				}
			}
		}
	...
	void method1386(byte[] var1) {
		...
		if (var17 == 1) {
			for (var40 = 0; var40 < var9; ++var40) {
				...
				this.field2149[var40] = new int[var41];
				this.field2151[var40] = new int[var41];

				for (var42 = 0; var42 < var41; ++var42) {
					this.field2149[var40][var42] = var8.readUnsignedByte();
					this.field2151[var40][var42] = var8.readUnsignedByte();
				}
			}
		}
	...
	final int method1389(ModelData var1, int var2) {
		int var3 = -1;
		...
		if (var3 == -1) {
			...
			if (var1.field2149 != null) {
				this.field2149[this.verticesCount] = var1.field2149[var2];
				this.field2151[this.verticesCount] = var1.field2151[var2];
			}
	...
	@ObfuscatedName("ax")
	@ObfuscatedSignature(
		descriptor = "([[IIIIZI)Lkq;"
	)
	public ModelData method1391(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
		this.calculateBounds();
		int var7 = var2 + this.field2139;
		int var8 = var2 + this.field2135;
		int var9 = var4 + this.field2137;
		int var10 = var4 + this.field2136;
	...
	@ObfuscatedName("am")
	public void method1396(int var1) {
	...
	void calculateBounds() {
		if (!this.isBoundsCalculated) {
			super.height = 0;
			this.field2138 = 0;
			this.field2139 = 999999;
			this.field2135 = -999999;
			this.field2136 = -99999;
			this.field2137 = 99999;

			for (int var1 = 0; var1 < this.verticesCount; ++var1) {
				int var2 = this.verticesX[var1];
				int var3 = this.verticesY[var1];
				int var4 = this.verticesZ[var1];
				if (var2 < this.field2139) {
					this.field2139 = var2;
				}

				if (var2 > this.field2135) {
					this.field2135 = var2;
				}

				if (var4 < this.field2137) {
					this.field2137 = var4;
				}

				if (var4 > this.field2136) {
					this.field2136 = var4;
				}
	...
	public final Model toModel(int var1, int var2, int var3, int var4, int var5) {
		...
		if (this.textureTriangleCount > 0 && this.textureCoords != null) {
			...
			var8.field2396 = new int[var8.field2421];
			var8.field2397 = new int[var8.field2421];
			var8.field2407 = new int[var8.field2421];
			var10 = 0;

			int var11;
			for (var11 = 0; var11 < this.textureTriangleCount; ++var11) {
				if (var9[var11] > 0 && this.textureRenderTypes[var11] == 0) {
					var8.field2396[var10] = this.texTriangleX[var11] & '\uffff';
					var8.field2397[var10] = this.texTriangleY[var11] & '\uffff';
					var8.field2407[var10] = this.texTriangleZ[var11] & '\uffff';
					var9[var11] = var10++;
				} else {
					var9[var11] = -1;
				}
			...
			var8.field2390 = new byte[this.faceCount];

			for (var11 = 0; var11 < this.faceCount; ++var11) {
				if (this.textureCoords[var11] != -1) {
					var8.field2390[var11] = (byte)var9[this.textureCoords[var11] & 255];
				} else {
					var8.field2390[var11] = -1;
				}
			}
		}
			...
			if (var12 == -1) {
				if (var17 != 0) {
					if (var17 == 1) {
						...
						var8.faceColors1[var16] = method1407(this.faceColors[var16] & '\uffff', var14);
					...
					var8.faceColors1[var16] = method1407(var15, var14);
					...
					var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
					var8.faceColors2[var16] = method1407(var15, var14);
					...
					var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
					var8.faceColors3[var16] = method1407(var15, var14);
				}
			} else if (var17 != 0) {
				if (var17 == 1) {
					var19 = this.faceNormals[var16];
					var14 = (var4 * var19.y + var5 * var19.z + var3 * var19.x) / (var7 / 2 + var7) + var1;
					var8.faceColors1[var16] = method1408(var14);
					var8.faceColors3[var16] = -1;
				} else {
					var8.faceColors3[var16] = -2;
				}
				...
				var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
				var8.faceColors2[var16] = method1408(var14);
				if (this.vertexVertices != null && this.vertexVertices[this.indices3[var16]] != null) {
					var13 = this.vertexVertices[this.indices3[var16]];
				} else {
					var13 = this.vertexNormals[this.indices3[var16]];
				...
				var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
				var8.faceColors3[var16] = method1408(var14);
			}
		}
		...
		var8.field2411 = this.field2151;
		return var8;
	}

	@ObfuscatedName("at")
	@ObfuscatedSignature(
		descriptor = "(Lol;II)Lkq;"
	)
	...
	@ObfuscatedName("be")
	@ObfuscatedSignature(
		descriptor = "(Lkq;Lkq;IIIZ)V"
	)
	static void method1405(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
		...
		for (var9 = 0; var9 < var0.verticesCount; ++var9) {
			...
			if (var10.magnitude != 0) {
				...
				if (var11 <= var1.field2138) {
					int var12 = var0.verticesX[var9] - var2;
					if (var12 >= var1.field2139 && var12 <= var1.field2135) {
						int var13 = var0.verticesZ[var9] - var4;
						if (var13 >= var1.field2137 && var13 <= var1.field2136) {
							for (int var14 = 0; var14 < var8; ++var14) {
								...
								if (var12 == var7[var14] && var13 == var1.verticesZ[var14] && var11 == var1.verticesY[var14] && var15.magnitude != 0) {
									...
									++var6;
									field2122[var9] = field2120;
									field2123[var14] = field2120;
								}
							}
						}
					}
		...
		if (var6 >= 3 && var5) {
			for (var9 = 0; var9 < var0.faceCount; ++var9) {
				if (field2122[var0.indices1[var9]] == field2120 && field2122[var0.indices2[var9]] == field2120 && field2122[var0.indices3[var9]] == field2120) {
			...
			for (var9 = 0; var9 < var1.faceCount; ++var9) {
				if (field2120 == field2123[var1.indices1[var9]] && field2120 == field2123[var1.indices2[var9]] && field2120 == field2123[var1.indices3[var9]]) {
	...
	@ObfuscatedName("bl")
	static final int method1407(int var0, int var1) {
	...
	@ObfuscatedName("bi")
	static final int method1408(int var0) {
		if (var0 < 2) {
			var0 = 2;
		} else if (var0 > 126) {
			var0 = 126;
