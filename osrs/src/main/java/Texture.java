...
public class Texture extends Node {
	...
	Texture(Buffer var1) {
		...
		this.field2171 = var1.readUnsignedByte() == 1;
		...
		if (var2 >= 1 && var2 <= 4) {
			...
			if (var2 > 1) {
				this.field2176 = new int[var2 - 1];

				for (var3 = 0; var3 < var2 - 1; ++var3) {
					this.field2176[var3] = var1.readUnsignedByte();
				}
			}
			...
			if (var2 > 1) {
				...
				for (var3 = 0; var3 < var2 - 1; ++var3) {
					this.field2177[var3] = var1.readUnsignedByte();
				}
			}

			this.field2179 = new int[var2];

			for (var3 = 0; var3 < var2; ++var3) {
				this.field2179[var3] = var1.readInt();
			}
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) {
			...
			IndexedSprite var7;
			if (!EnumComposition.method926(var4, var8)) {
				var7 = null;
			} else {
