...
public class Texture extends Node {
	...
	Texture(Buffer var1) {
		...
		this.field2323 = var1.readUnsignedByte() == 1;
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) {
			...
			if (var10 == null) {
				...
				class428.SpriteBuffer_decode(var10);
				var9 = true;
			}
			...
			if (!var9) {
				...
				var11.width = SecureRandomCallable.SpriteBuffer_spriteWidth;
				var11.height = class402.SpriteBuffer_spriteHeight;
				var11.xOffset = class458.SpriteBuffer_xOffsets[0];
				var11.yOffset = class458.SpriteBuffer_yOffsets[0];
				var11.subWidth = ApproximateRouteStrategy.SpriteBuffer_spriteWidths[0];
				var11.subHeight = UserComparator9.SpriteBuffer_spriteHeights[0];
				var11.palette = class458.SpriteBuffer_spritePalette;
				var11.pixels = FileSystem.SpriteBuffer_pixels[0];
