...
public class Texture extends Node {
	...
	Texture(Buffer var1) {
		...
		this.field1987 = var1.readUnsignedByte() == 1;
		...
		if (var2 >= 1 && var2 <= 4) {
			...
			if (var2 > 1) {
				this.field1995 = new int[var2 - 1];

				for (var3 = 0; var3 < var2 - 1; ++var3) {
					this.field1995[var3] = var1.readUnsignedByte();
				}
			}

			if (var2 > 1) {
				this.field1992 = new int[var2 - 1];

				for (var3 = 0; var3 < var2 - 1; ++var3) {
					this.field1992[var3] = var1.readUnsignedByte();
				}
			}
			...
			for (var3 = 0; var3 < var2; ++var3) {
				this.field1993[var3] = var1.readInt();
			}
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) {
			...
			IndexedSprite var7;
			if (!Decimator.method313(var4, var8)) {
				var7 = null;
			} else {
				var7 = class493.method2466();
			}

			var7.normalize();
			byte[] var10 = var7.pixels;
			int[] var11 = var7.palette;
			int var12 = this.field1993[var6];
