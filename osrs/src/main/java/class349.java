...
public class class349 {
	...
	static final void method1874(boolean var0, PacketBuffer var1) {
		while (true) {
			byte var2 = 16;
			int var3 = 1 << var2;
			if (var1.bitsRemaining(Client.packetWriter.serverPacketLength) >= var2 + 12) {
				...
				if (var4 != var3 - 1) {
					...
					int var11 = Client.field561[var1.readBits(3)];
					if (var5) {
					...
					ItemLayer.method1152(var6);
					if (var6.field1017 == 0) {
						var6.rotation = 0;
					}

					var6.method583(VarbitComposition.localPlayer.pathX[0] + var8, VarbitComposition.localPlayer.pathY[0] + var9, var7 == 1);
					continue;
				}
			}
