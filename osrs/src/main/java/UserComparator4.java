...
public class UserComparator4 implements Comparator {
	...
	static final int method666(Widget var0, int var1) {
		if (var0.cs1Instructions != null && var1 < var0.cs1Instructions.length) {
			try {
				...
				while (true) {
					...
					if (var6 == 18) {
						var7 = (class229.localPlayer.x >> 7) + NewShit.baseX;
					}

					if (var6 == 19) {
						var7 = (class229.localPlayer.y >> 7) + class101.baseY;
					}
	...
	static final void method667(int var0, int var1) {
		if (Client.currentClanChannels[var0] != null) {
			if (var1 >= 0 && var1 < Client.currentClanChannels[var0].method857()) {
				ClanChannelMember var2 = (ClanChannelMember)Client.currentClanChannels[var0].members.get(var1);
				if (var2.rank == -1) {
					PacketBufferNode var3 = class113.getPacketBufferNode(ClientPacket.f83, Client.packetWriter.isaacCipher);
