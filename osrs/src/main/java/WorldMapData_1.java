...
public class WorldMapData_1 extends AbstractWorldMapData {
	...
	void init(Buffer var1) {
		...
		if (var2 != class271.field2455.field2457) {
	...
	public static final SpritePixels method1484(byte[] var0) {
	...
	static boolean method1486(CharSequence var0, int var1, boolean var2) {
		if (var1 >= 2 && var1 <= 36) {
			boolean var3 = false;
			boolean var4 = false;
			int var5 = 0;
