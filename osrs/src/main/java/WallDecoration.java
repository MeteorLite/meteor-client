   ...
   static void method1305() {
      ...
      if (Login.Login_username.length() == 0) {
         ...
         if (0L == var1) {
            ...
            var6.encryptRsa(class70.field711, class70.field712);
            var7.writeByte(10);
            ...
            var7.writeLong(var5.nextLong());
            var7.encryptRsa(class70.field711, class70.field712);
            ...
            String var20 = GrandExchangeEvents.method1856(var18.array);

            byte var3;
            try {
               URL var13 = new URL(class154.method822("services", false) + "m=accountappeal/login.ws");
               ...
               var15.write("data2=" + class431.method2221(var20) + "&dest=" + class431.method2221("passwordchoice.ws"));
               var15.flush();
         ...
         switch(var0) {
         case 2:
            Tile.setLoginResponseString(Strings.field3103, Strings.field3332, Strings.field3333);
            class14.method52(6);
            break;
         case 3:
