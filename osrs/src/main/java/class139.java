...
public class class139 extends class129 {
	...
	void vmethod3313(ClanSettings var1) {
		var1.method3129(this.field1621, this.field1620);
	}
	...
	public static void method3104() {
		synchronized(ArchiveDiskActionHandler.ArchiveDiskActionHandler_lock) {
			if (ArchiveDiskActionHandler.field4018 != 0) {
				ArchiveDiskActionHandler.field4018 = 1;
	...
	static boolean updateExternalPlayer(PacketBuffer var0, int var1) {
		...
		if (var2 == 0) {
			...
			if (Client.players[var1] != null) {
				...
				var9 = var7 >> 14 & 255;
				var10 = var7 & 255;
				var11.pathTraversed[0] = Players.field1291[var1];
				var11.plane = (byte)var8;
				var11.resetPath((var9 << 13) + var3 - class128.baseX * 64, (var10 << 13) + var4 - WorldMapData_1.baseY * 64);
				var11.field1103 = false;
				return true;
			}
		} else if (var2 == 1) {
