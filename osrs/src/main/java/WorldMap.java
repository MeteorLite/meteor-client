...
public class WorldMap {
	...
	public void init(AbstractArchive var1, AbstractArchive var2, AbstractArchive var3, Font var4, HashMap var5, IndexedSprite[] var6) {
		...
		int var7 = this.WorldMap_archive.getGroupId(WorldMapCacheName.field2095.name);
		...
		for (int var10 = 0; var10 < var9; ++var10) {
			...
			var12.method1205(var11, var8[var10], Client.param25 >= 217);
	...
	public void onCycle(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
		if (this.cacheLoader.isLoaded()) {
			...
			if (var3) {
				...
				List var10 = this.worldMapManager.method1270(this.centerTileX - var8 / 2 - 1, this.centerTileY - var9 / 2 - 1, var8 / 2 + this.centerTileX + 1, var9 / 2 + this.centerTileY + 1, var4, var5, var6, var7, var1, var2);
				...
				for (var12 = var10.iterator(); var12.hasNext(); class157.runScriptEvent(var14)) {
					...
					if (this.field4045.contains(var13)) {
						var14.setType(17);
					} else {
						var14.setType(15);
					}
	...
	public void method2400(int var1, int var2, boolean var3, boolean var4) {
		long var5 = SpotAnimationDefinition.method962();
		this.method2401(var1, var2, var4, var5);
		if (!this.hasTarget() && (var4 || var3) && !PacketBufferNode.method1639()) {
			if (var4) {
				this.field4027 = var1;
				this.field4029 = var2;
				this.field4024 = this.centerTileX;
				this.field4026 = this.centerTileY;
			}

			if (this.field4024 != -1) {
				int var7 = var1 - this.field4027;
				int var8 = var2 - this.field4029;
				this.setWorldMapPosition(this.field4024 - (int)((float)var7 / this.zoomTarget), (int)((float)var8 / this.zoomTarget) + this.field4026, false);
			}
		} else {
			this.method2405();
		}
	...
	@ObfuscatedName("ab")
	void method2401(int var1, int var2, boolean var3, long var4) {
		if (this.currentMapArea != null) {
			...
			if (this.mouseCoord != null && var3) {
				class223 var8 = Client.keyHandlerInstance;
				...
				if (var10 && var8.getKeyPressed(82) && var8.getKeyPressed(81)) {
					...
					PacketBufferNode var14 = class113.getPacketBufferNode(ClientPacket.f20, Client.packetWriter.isaacCipher);
					var14.packetBuffer.writeInt(0);
					var14.packetBuffer.writeIntME(var16);
					var14.packetBuffer.writeIntME(var12);
					var14.packetBuffer.writeByte(var13);
					Client.packetWriter.addNode(var14);
				} else {
					boolean var11 = true;
					if (this.field4012) {
						var12 = var1 - this.field4032;
						var13 = var2 - this.field4022;
						if (var4 - this.field4052 > 500L || var12 < -25 || var12 > 25 || var13 < -25 || var13 > 25) {
							var11 = false;
						}
					}

					if (var11) {
						PacketBufferNode var15 = class113.getPacketBufferNode(ClientPacket.field2580, Client.packetWriter.isaacCipher);
						var15.packetBuffer.writeIntIME(this.mouseCoord.packed());
	...
	final void setWorldMapPosition(int var1, int var2, boolean var3) {
		...
		SpotAnimationDefinition.method962();
		if (var3) {
			this.method2405();
		}
	...
	public void method2408(int var1, int var2, int var3, boolean var4) {
	...
	public void method2414(WorldMapArea var1, Coord var2, Coord var3, boolean var4) {
		if (var1 != null) {
			if (this.currentMapArea == null || var1 != this.currentMapArea) {
				this.initializeWorldMapManager(var1);
			}
	...
	public void draw(int var1, int var2, int var3, int var4, int var5) {
		...
		if (var7 < 100) {
			...
			if (!this.worldMapManager.isLoaded()) {
				this.worldMapManager.method1264(this.WorldMap_archive, this.currentMapArea.getInternalName(), Client.isMembersWorld, Client.param25 >= 217);
				if (!this.worldMapManager.isLoaded()) {
					return;
				}
			}

			Rasterizer2D.Rasterizer2D_fillRectangle(var1, var2, var3, var4, this.worldMapManager.method1273());
			...
			if (!this.elementsDisabled) {
				var10 = false;
				if (var5 - this.field4033 > 100) {
					this.field4033 = var5;
					var10 = true;
				}

				this.worldMapManager.drawElements(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2, var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1, var2 + var4, this.field4043, this.flashingElements, this.flashCycle, this.cyclesPerFlash, var10);
			}

			this.method2418(var1, var2, var3, var4, var8, var9);
	...
	boolean method2417(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (this.sprite == null) {
			return true;
			...
			if (this.worldMapManager.pixelsPerTile != this.cachedPixelsPerTile) {
				return true;
			} else if (this.field4035 != Client.field369) {
				return true;
	...
	void method2418(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (MidiPcmStream.field2799 != null) {
			...
			if (this.method2417(var8, var9, var13, var14, var3, var4)) {
				...
				MidiPcmStream.field2799.method1987(this.minCachedTileX, this.minCachedTileY, this.sprite, (float)this.cachedPixelsPerTile / var10);
				this.field4035 = Client.field369;
			...
			if (1.0F == var10) {
				this.sprite.method2695(var13, var14, 192);
			} else {
				this.sprite.method2698(var13, var14, (int)((float)var8 * var10), (int)((float)var9 * var10), 192);
			}
		}
	...
	void method2450() {
		...
		this.field4043.addAll(this.enabledElements);
		this.field4043.addAll(this.enabledElementIds);
	}
	...
	public void addElementMenuOptions(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (this.cacheLoader.isLoaded()) {
			...
			List var9 = this.worldMapManager.method1270(this.centerTileX - var7 / 2 - 1, this.centerTileY - var8 / 2 - 1, var7 / 2 + this.centerTileX + 1, var8 / 2 + this.centerTileY + 1, var1, var2, var3, var4, var5, var6);
			if (!var9.isEmpty()) {
	...
	public Coord method2452(int var1, Coord var2) {
		if (!this.cacheLoader.isLoaded()) {
			return null;
	...
	static final void method2456(Actor var0) {
		int var2;
		int var3;
		int var4;
		if (var0.targetIndex != -1) {
			...
			if (var1 != null) {
				...
				if (var3 != 0 || var4 != 0) {
					var0.orientation = SequenceDefinition.method1040(var3, var4);
				}
			} else if (var0.false0) {
				var0.targetIndex = -1;
				var0.false0 = false;
		...
		int var7;
		if (var0.pathLength == 0 || var0.field1028 > 0) {
			var7 = -1;
			if (var0.field995 != -1 && var0.field997 != -1) {
				var2 = var0.field995 * 128 - NewShit.baseX * 128 + 64;
				var3 = var0.field997 * 128 - class101.baseY * 128 + 64;
				var4 = var0.x - var2;
				int var5 = var0.y - var3;
				if (var4 != 0 || var5 != 0) {
					var7 = SequenceDefinition.method1040(var4, var5);
				}
		...
		if (var7 != 0) {
			...
			++var0.field1011;
			var4 = var7 > 1024 ? -1 : 1;
			var0.rotation += var0.field1018 * var4;
			boolean var10 = true;
			if (var7 < var0.field1018 || var7 > 2048 - var0.field1018) {
				var0.rotation = var0.orientation;
				var10 = false;
			}

			if (var0.field1018 > 0 && var0.movementSequence == var0.idleSequence && (var0.field1011 > 25 || var10)) {
