...
public class WorldMap {
   ...
   public void init(AbstractArchive var1, AbstractArchive var2, AbstractArchive var3, Font var4, HashMap var5, IndexedSprite[] var6) {
      ...
      int var7 = this.WorldMap_archive.getGroupId(WorldMapCacheName.field2394.name);
   ...
   public void onCycle(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
      if (this.cacheLoader.isLoaded()) {
         ...
         if (var3) {
            ...
            List var10 = this.worldMapManager.method1400(this.centerTileX - var8 / 2 - 1, this.centerTileY - var9 / 2 - 1, var8 / 2 + this.centerTileX + 1, var9 / 2 + this.centerTileY + 1, var4, var5, var6, var7, var1, var2);
            ...
            for(var12 = var10.iterator(); var12.hasNext(); class9.runScriptEvent(var14)) {
               ...
               if (this.field3873.contains(var13)) {
                  var14.setType(17);
               } else {
                  var14.setType(15);
               }
   ...
   public void method2252(int var1, int var2, boolean var3, boolean var4) {
      long var5 = WorldMapSection2.clockNow();
      this.method2303(var1, var2, var4, var5);
      if (!this.hasTarget() && (var4 || var3) && !class83.method462()) {
         if (var4) {
            this.field3834 = var1;
            this.field3859 = var2;
            this.field3856 = this.centerTileX;
            this.field3857 = this.centerTileY;
         }

         if (this.field3856 != -1) {
            int var7 = var1 - this.field3834;
            int var8 = var2 - this.field3859;
            this.setWorldMapPosition(this.field3856 - (int)((float)var7 / this.zoomTarget), (int)((float)var8 / this.zoomTarget) + this.field3857, false);
         }
      } else {
         this.method2307();
      }
   ...
   @ObfuscatedName("an")
   void method2303(int var1, int var2, boolean var3, long var4) {
      if (this.currentMapArea != null) {
         ...
         if (this.mouseCoord != null && var3) {
            class208 var8 = Calendar.method1780();
            if (class72.method423() && var8.getKeyPressed(82) && var8.getKeyPressed(81)) {
               class163.method857(this.mouseCoord.x, this.mouseCoord.y, this.mouseCoord.plane, false);
            } else {
               boolean var9 = true;
               if (this.field3863) {
                  int var10 = var1 - this.field3861;
                  int var11 = var2 - this.field3862;
                  if (var4 - this.field3860 > 500L || var10 < -25 || var10 > 25 || var11 < -25 || var11 > 25) {
                     var9 = false;
                  }
               }

               if (var9) {
                  PacketBufferNode var12 = UserComparator9.getPacketBufferNode(ClientPacket.field2479, Client.packetWriter.isaacCipher);
                  var12.packetBuffer.method2454(this.mouseCoord.packed());
   ...
   public void method2255(int var1, int var2, int var3, boolean var4) {
   ...
   public void method2292(WorldMapArea var1, Coord var2, Coord var3, boolean var4) {
      if (var1 != null) {
         if (this.currentMapArea == null || var1 != this.currentMapArea) {
            this.initializeWorldMapManager(var1);
         }
   ...
   public void draw(int var1, int var2, int var3, int var4, int var5) {
      ...
      if (var7 < 100) {
         ...
         if (!this.elementsDisabled) {
            boolean var10 = false;
            if (var5 - this.field3869 > 100) {
               this.field3869 = var5;
               var10 = true;
            }

            this.worldMapManager.drawElements(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2, var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1, var2 + var4, this.field3880, this.flashingElements, this.flashCycle, this.cyclesPerFlash, var10);
         }

         this.method2295(var1, var2, var3, var4, var8, var9);
         if (class72.method423() && this.showCoord && this.mouseCoord != null) {
   ...
   boolean method2304(int var1, int var2, int var3, int var4, int var5, int var6) {
      if (this.sprite == null) {
         return true;
         ...
         if (this.worldMapManager.pixelsPerTile != this.cachedPixelsPerTile) {
            return true;
         } else if (this.field3876 != Client.field447) {
            return true;
   ...
   void method2295(int var1, int var2, int var3, int var4, int var5, int var6) {
      if (Language.field3504 != null) {
         ...
         if (this.method2304(var8, var9, var13, var14, var3, var4)) {
            ...
            Language.field3504.method1883(this.minCachedTileX, this.minCachedTileY, this.sprite, (float)this.cachedPixelsPerTile / var10);
            this.field3876 = Client.field447;
         ...
         if (var10 == 1.0F) {
            this.sprite.method2535(var13, var14, 192);
         } else {
            this.sprite.method2538(var13, var14, (int)((float)var8 * var10), (int)(var10 * (float)var9), 192);
         }
      }
   ...
   void method2283() {
      this.field3880.clear();
      this.field3880.addAll(this.enabledElements);
      this.field3880.addAll(this.enabledElementIds);
   }
   ...
   public void addElementMenuOptions(int var1, int var2, int var3, int var4, int var5, int var6) {
      if (this.cacheLoader.isLoaded()) {
         ...
         List var9 = this.worldMapManager.method1400(this.centerTileX - var7 / 2 - 1, this.centerTileY - var8 / 2 - 1, var7 / 2 + this.centerTileX + 1, var8 / 2 + this.centerTileY + 1, var1, var2, var3, var4, var5, var6);
         if (!var9.isEmpty()) {
   ...
   public Coord method2285(int var1, Coord var2) {
      if (!this.cacheLoader.isLoaded()) {
         return null;
   ...
   public AbstractWorldMapIcon iconStart() {
      if (!this.cacheLoader.isLoaded()) {
         ...
         this.field3870 = new LinkedList();
         Iterator var2 = var1.values().iterator();

         while(var2.hasNext()) {
            List var3 = (List)var2.next();
            this.field3870.addAll(var3);
         }

         this.iconIterator = this.field3870.iterator();
