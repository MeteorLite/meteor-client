...
@ObfuscatedName("qi")
public class class453 implements class342 {
	@ObfuscatedName("sb")
	@ObfuscatedSignature(
		descriptor = "Lal;"
	)
	...
	public static final class453 field4834;
	@ObfuscatedName("f")
	@ObfuscatedSignature(
		descriptor = "Lqi;"
	)
	public static final class453 field4828;
	@ObfuscatedName("c")
	@ObfuscatedSignature(
		descriptor = "Lqi;"
	)
	public static final class453 field4836;
	@ObfuscatedName("n")
	...
	static {
		field4834 = new class453(0, 0, Integer.class, new class450());
		field4828 = new class453(2, 1, Long.class, new class452());
		field4836 = new class453(1, 2, String.class, new class454());
	}
	...
	static void resumePauseWidget(int var0, int var1) {
		PacketBufferNode var2 = FloorUnderlayDefinition.getPacketBufferNode(ClientPacket.field3066, Client.packetWriter.isaacCipher);
