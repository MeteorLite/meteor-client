...
public class SoundSystem implements Runnable {
	...
	static void Login_promptCredentials(boolean var0) {
		if (!SpriteMask.client.method364() && !SpriteMask.client.method366() && !SpriteMask.client.method365()) {
			Login.Login_response1 = "";
			Login.Login_response2 = "Enter your username/email & password.";
			Login.Login_response3 = "";
			UserComparator7.method674(2);
			if (var0) {
	...
	static int method232(int var0, Script var1, boolean var2) {
		int var3;
		if (var0 == 5504) {
				...
				if (!var10.isIf3 || !class11.isComponentHidden(var10)) {
					...
					if (var10 == Client.clickedWidget) {
						if (var1 != -1412584499 && !var10.isScrollBar) {
							UserComparator10.field1197 = var0;
							ParamComposition.field1629 = var6;
							PendingSpawn.field950 = var7;
							continue;
						}
						...
						if (Client.isDraggingWidget && Client.field396) {
							...
							if (var15 < Client.field512) {
								var15 = Client.field512;
							}

							if (var15 + var10.width > Client.field512 + Client.clickedWidgetParent.width) {
								var15 = Client.field512 + Client.clickedWidgetParent.width - var10.width;
							}
					...
					if (!var10.isIf3 || var15 < var17 && var16 < var18) {
						if (var10.contentType != 0) {
							if (var10.contentType == 1336) {
								if (WorldMapIcon_1.clientPreferences.method547()) {
									var13 += 15;
							...
							if (var10.contentType == 1339) {
								MilliClock.method1103(var10, var12, var13, var11);
								Rasterizer2D.Rasterizer2D_setClip(var2, var3, var4, var5);
								continue;
							}

							if (var10.contentType == 1400) {
								NewShit.worldMap.draw(var12, var13, var10.width, var10.height, Client.cycle);
							}

							if (var10.contentType == 1401) {
								NewShit.worldMap.drawOverview(var12, var13, var10.width, var10.height);
							}

							if (var10.contentType == 1402) {
								EnumComposition.field1505.draw(var12, Client.cycle);
							}
						}
						...
						if (Client.isResizable || Client.field409[var11] || Client.gameDrawingMode > 1) {
							...
							if (var10.type != 1) {
								if (var10.type == 3) {
									...
									if (var10.fill) {
										switch(var10.fillMode.field4261) {
										case 1:
									...
									if (var40 == null) {
										...
										if (!var10.isIf3) {
											var42 = HitSplatDefinition.method998(var42, var10);
										}

										var40.method2111(var42, var12, var13, var10.width, var10.height, var20, var10.textShadowed ? 0 : -1, class478.method2364(var10.transparencyTop), var10.textXAlignment, var10.textYAlignment, var10.textLineHeight);
									}
								} else {
									int var23;
									int var24;
									...
									if (var10.type == 5) {
											...
											if (var38 == null) {
												...
												if (!var10.spriteTiling) {
													...
													if (var10.spriteAngle != 0) {
														var38.method2704(var10.width / 2 + var12, var10.height / 2 + var13, var10.spriteAngle, var22);
													} else if (var14 != 0) {
													...
													for (var24 = 0; var24 < var22; ++var24) {
														for (var25 = 0; var25 < var23; ++var25) {
															if (var10.spriteAngle != 0) {
																var38.method2704(var20 / 2 + var12 + var20 * var24, var21 / 2 + var13 + var21 * var25, var10.spriteAngle, 4096);
															} else if (var14 != 0) {
										...
										if (var10.type == 6) {
											...
											if (var10.itemId != -1) {
												...
												var39 = var10.field3125.getModel((SequenceDefinition)null, -1, DynamicObject.SequenceDefinition_get(class229.localPlayer.idleSequence), class229.localPlayer.movementFrame);
											} else {
												...
												var34 = -1;
												if (var20 != -1) {
													var33 = DynamicObject.SequenceDefinition_get(var20);
													var34 = var10.modelFrame;
												}

												var39 = var10.getModel(HealthBarDefinition.widgetDefinition, var33, var34, var36, class229.localPlayer.appearance, var45, var32);
												if (var39 == null && Widget.field2976) {
													class159.invalidateWidget(var10);
												}
											}

											Rasterizer3D.method1430(var10.width / 2 + var12, var10.height / 2 + var13);
											var23 = Rasterizer3D.Rasterizer3D_sine[var10.modelAngleX] * var10.modelZoom >> 16;
											var24 = Rasterizer3D.Rasterizer3D_cosine[var10.modelAngleX] * var10.modelZoom >> 16;
											if (var39 != null) {
												if (!var10.isIf3) {
													var39.method1556(0, var10.modelAngleY, 0, var10.modelAngleX, 0, var23, var24);
												} else {
													var39.calculateBoundsCylinder();
													if (var10.modelOrthog) {
														var39.method1557(0, var10.modelAngleY, var10.modelAngleZ, var10.modelAngleX, var10.modelOffsetX, var23 + var22 + var10.modelOffsetY, var24 + var10.modelOffsetY, var10.modelZoom);
													} else {
														var39.method1556(0, var10.modelAngleY, var10.modelAngleZ, var10.modelAngleX, var10.modelOffsetX, var22 + var23 + var10.modelOffsetY, var24 + var10.modelOffsetY);
													}
												}
											}

											Rasterizer3D.method1429();
										} else {
											Font var29;
											if (var10.type == 8 && var10 == SwapSongTask.field3744 && Client.field492 == Client.field493) {
												var19 = 0;
												var20 = 0;
												...
												String var31;
												for (var30 = HitSplatDefinition.method998(var30, var10); var30.length() > 0; var20 = var20 + var29.ascent + 1) {
												...
												for (var30 = HitSplatDefinition.method998(var30, var10); var30.length() > 0; var34 = var34 + var29.ascent + 1) {
											...
											if (var10.type == 9) {
												...
												if (var10.lineWid == 1) {
													...
													UrlRequest.method661(var19, var20, var21, var22, var10.color, var10.lineWid);
												}
											} else if (var10.type == 12) {
												class341 var37 = var10.method1871();
												class336 var35 = var10.method1872();
												if (var37 != null && var35 != null && var37.method1815()) {
													...
													if (var29 != null) {
														...
														if (!var37.method1810() && var37.method1807().method2053()) {
															...
															Client.field649.method2713(var10.color, var22, var35.field2923, var35.field2921);
															Client.field649.method2714(var37.method1807(), var29);
														}
	...
	static final void method235(int var0) {
		...
		WorldMapIcon_1.clientPreferences.setCurrentSoundEffectVolume(var0);
	}
}