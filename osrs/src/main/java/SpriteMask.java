...
public class SpriteMask extends DualNode {
   ...
   public static int method1623(float[] var0, int var1, float var2, boolean var3, float var4, boolean var5, float[] var6) {
      float var7 = 0.0F;
               ...
               for(int var20 = 0; var20 <= var14; ++var20) {
                  ...
                  if (var15) {
                     ...
                     if (Math.abs(var26) < class121.field1175) {
                        ...
                        float var27 = AbstractUserComparator.method2095(var41.field3795, var41.field3792, var19);
                           ...
                           do {
                              ...
                              if (var40) {
                                 if (Math.abs(var30) >= var38 && Math.abs(var26) > Math.abs(var27)) {
                                    ...
                                    var34 = var30;
                                    var30 = var29;
                                    if (var31 * 2.0F < var32 * var39 * 3.0F - Math.abs(var38 * var32) && var31 < Math.abs(var32 * var34 * 0.5F)) {
                                       var29 = var31 / var32;
                                    } else {
                                       var29 = var39;
                                       var30 = var39;
                                 ...
                                 var27 = AbstractUserComparator.method2095(var41.field3795, var41.field3792, var25);
   ...
   static void playSong(int var0) {
      if (var0 == -1 && !Client.playingJingle) {
         class177.method905();
      } else if (var0 != -1 && var0 != Client.currentTrackGroupId && PacketWriter.clientPreferences.getCurrentMusicVolume() != 0 && !Client.playingJingle) {
         class284.method1542(2, class153.archive6, var0, 0, PacketWriter.clientPreferences.getCurrentMusicVolume(), false);
      }
