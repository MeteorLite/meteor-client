...
public class class478 {
	...
	static {
		field3942 = new int[32768];

		for (int var0 = 0; var0 < 32768; ++var0) {
			field3942[var0] = method2363(var0);
		}

		if (field3940 == null) {
			field3940 = new int[65536];
	...
	static final int method2363(int var0) {
	...
	public static int method2364(int var0) {
		return 255 - (var0 & 255);
	}
		...
		if (Client.menuOptionsCount >= 2 || Client.isItemSelected != 0 || Client.isSpellSelected) {
			if (Client.showMouseOverText) {
				...
				if (Client.isItemSelected == 1 && Client.menuOptionsCount < 2) {
					var4 = "Use" + " " + Client.field597 + " " + "->";
				} else if (Client.isSpellSelected && Client.menuOptionsCount < 2) {
					var4 = Client.field599 + " " + Client.field598 + " " + "->";
				} else {
					var4 = ReflectionCheck.method187(var2);
				}
