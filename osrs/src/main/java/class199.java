...
public class class199 implements class30 {
	...
	public class199() {
		this.field2253 = new char[128];
		this.field2244 = new int[128];
		this.field2246 = new int[128];
		this.field2247 = 0;
		this.field2260 = new int[128];
		this.field2255 = 0;
		this.field2250 = 0;
		this.field2249 = 0;
		this.field2258 = 0;
		this.field2251 = new boolean[112];
		this.field2254 = new boolean[112];
		this.field2257 = new boolean[112];
	}
