...
class class11 implements TlsAuthentication {
   ...
   static final int method40(int var0, int var1) {
   ...
   static void getLoginError(int var0) {
      ...
      class19.updateGameState(10);
      boolean var3 = var1 != Decimator.method305();
      if (!var3 && Client.field393.method2484()) {
         class14.method52(9);
      }
   ...
   static final void method37() {
      PendingSpawn.method502(class364.field3540, Coord.field2766, class307.field2776);
      class278.method1536(WorldMapRectangle.field2359, class28.field84);
      if (class381.cameraX == class364.field3540 && class351.cameraY == Coord.field2766 && class471.cameraZ == class307.field2776 && class311.cameraPitch == WorldMapRectangle.field2359 && class110.cameraYaw == class28.field84) {
         Client.field609 = false;
         Client.isCameraLocked = false;
         class167.cameraLookAtX = 0;
         Canvas.cameraLookAtY = 0;
         MidiPcmStream.cameraLookAtHeight = 0;
         GrandExchangeOfferUnitPriceComparator.cameraLookAtSpeed = 0;
         Skeleton.cameraLookAtAcceleration = 0;
         class313.cameraMoveToAcceleration = 0;
         class19.cameraMoveToSpeed = 0;
         class4.cameraMoveToX = 0;
         WorldMapSectionType.cameraMoveToY = 0;
         class269.cameraMoveToHeight = 0;
      }
   ...
   static final boolean method41(Widget var0) {
      ...
      if (var1 == 205) {
         ...
         if (var1 >= 314 && var1 <= 323) {
            var2 = (var1 - 314) / 2;
            var3 = var1 & 1;
            Client.playerAppearance.method1644(var2, var3 == 1);
         }

         if (var1 == 324) {
            Client.playerAppearance.method1645(0);
         }

         if (var1 == 325) {
            Client.playerAppearance.method1645(1);
         }

         if (var1 == 326) {
            PacketBufferNode var4 = UserComparator9.getPacketBufferNode(ClientPacket.field2454, Client.packetWriter.isaacCipher);
