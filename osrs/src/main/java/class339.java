...
public class class339 {
	...
	static double method1823(int var0, int var1, int var2) {
	...
	static int method1824(int var0, Script var1, boolean var2) {
		...
		if (var0 == 4200) {
			...
			if (var0 == 4201) {
				...
				if (var0 == 4205) {
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					var6 = class125.ItemDefinition_get(var3);
					...
					class146.findItemDefinitions(var7, var4 == 1);
					...
					if (var0 == 4212) {
						...
						var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
						var4 = class125.ItemDefinition_get(var3).getShiftClickIndex();
						if (var4 == -1) {
						...
						var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
						var6 = class125.ItemDefinition_get(var3);
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var6.field1781;
						return 1;
					} else {
						return 2;
					}
