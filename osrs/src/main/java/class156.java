...
public class class156 extends class160 {
	...
	void vmethod3239(ClanChannel var1) {
		...
		var2.username = new Username(this.field1396);
		var2.world = this.field1395;
		var2.rank = this.field1394;
		var1.addMember(var2);
	}
	...
	static final void method823(Scene var0, CollisionMap[] var1) {
		int var2;
		int var3;
		int var4;
		int var5;
		...
		int var18;
		for (var2 = 0; var2 < 4; ++var2) {
			byte[][] var45 = class93.field948[var2];
			boolean var54 = true;
			boolean var55 = true;
			boolean var6 = true;
			boolean var7 = true;
			...
			for (var11 = 1; var11 < 103; ++var11) {
				for (var12 = 1; var12 < 103; ++var12) {
					...
					Tiles.field843[var12][var11] = var19 - var20;
				}
			}
			...
			for (var11 = 0; var11 < 104; ++var11) {
				...
				WorldMapLabelSize.field1943[var11] = 0;
			}
			...
			for (var11 = -5; var11 < 109; ++var11) {
				for (var12 = 0; var12 < 104; ++var12) {
					...
					if (var13 >= 0 && var13 < 104) {
						...
						if (var17 > 0) {
							FloorUnderlayDefinition var48 = class101.method596(var17 - 1);
							...
							var10002 = WorldMapLabelSize.field1943[var12]++;
						}
					}
					...
					if (var14 >= 0 && var14 < 104) {
						...
						if (var18 > 0) {
							FloorUnderlayDefinition var51 = class101.method596(var18 - 1);
							var10000 = class337.Tiles_hue;
				...
				if (var11 >= 1 && var11 < 103) {
					...
					for (var17 = -5; var17 < 109; ++var17) {
						...
						if (var18 >= 0 && var18 < 104) {
							...
							var16 += WorldMapLabelSize.field1943[var18];
						}
						...
						if (var19 >= 0 && var19 < 104) {
							...
							var16 -= WorldMapLabelSize.field1943[var19];
						}
						...
						if (var17 >= 1 && var17 < 103 && (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var11][var17] & 2) != 0 || (Tiles.Tiles_renderFlags[var2][var11][var17] & 16) == 0)) {
							...
							if (var23 > 0 || var24 > 0) {
								...
								int var29 = Tiles.field843[var11][var17];
								int var30 = Tiles.field843[var11 + 1][var17];
								int var31 = Tiles.field843[var11 + 1][var17 + 1];
								int var32 = Tiles.field843[var11][var17 + 1];
								int var33 = -1;
								int var34 = -1;
								int var35;
								int var36;
								if (var23 > 0) {
									...
									var33 = Messages.method634(var35, var36, var37);
									...
									var34 = Messages.method634(var35, var36, var37);
								}
								...
								if (var2 > 0) {
									...
									if (var24 > 0 && !Canvas.method85(var24 - 1).hideUnderlay) {
										var60 = false;
									}

									if (var60 && var26 == var25 && var25 == var27 && var25 == var28) {
										var10000 = class344.field3130[var2][var11];
										var10000[var17] |= 2340;
									}
								}
								...
								var35 = 0;
								if (var34 != -1) {
									var35 = Rasterizer3D.Rasterizer3D_colorPalette[ClanChannel.method861(var34, 96)];
								}

								if (var24 == 0) {
									var0.addTile(var2, var11, var17, 0, 0, -1, var25, var26, var27, var28, ClanChannel.method861(var33, var29), ClanChannel.method861(var33, var30), ClanChannel.method861(var33, var31), ClanChannel.method861(var33, var32), 0, 0, 0, 0, var35, 0);
								} else {
									var36 = ViewportMouse.Tiles_shapes[var2][var11][var17] + 1;
									byte var61 = class369.field3559[var2][var11][var17];
									FloorOverlayDefinition var38 = Canvas.method85(var24 - 1);
									...
									if (var39 >= 0) {
										...
										var40 = Messages.method634(var38.hue, var38.saturation, var38.lightness);
										...
										var41 = Messages.method634(var42, var38.saturation, var43);
									}

									var42 = 0;
									if (var41 != -2) {
										var42 = Rasterizer3D.Rasterizer3D_colorPalette[class403.method2044(var41, 96)];
									}
									...
									if (var38.secondaryRgb != -1) {
										...
										var41 = Messages.method634(var43, var38.secondarySaturation, var44);
										var42 = Rasterizer3D.Rasterizer3D_colorPalette[class403.method2044(var41, 96)];
									}

									var0.addTile(var2, var11, var17, var36, var61, var39, var25, var26, var27, var28, ClanChannel.method861(var33, var29), ClanChannel.method861(var33, var30), ClanChannel.method861(var33, var31), ClanChannel.method861(var33, var32), class403.method2044(var40, var29), class403.method2044(var40, var30), class403.method2044(var40, var31), class403.method2044(var40, var32), var35, var42);
								}
							}
						}
					}
			...
			for (var11 = 1; var11 < 103; ++var11) {
				for (var12 = 1; var12 < 103; ++var12) {
					var0.setTileMinPlane(var2, var12, var11, class185.method929(var2, var12, var11));
				}
			}
			...
			class369.field3559[var2] = null;
			class93.field948[var2] = null;
		}

		var0.method1488(-50, -10, -50);
			...
			for (int var56 = 0; var56 <= var5; ++var56) {
				for (int var57 = 0; var57 <= 104; ++var57) {
					for (int var58 = 0; var58 <= 104; ++var58) {
						short var59;
						if ((class344.field3130[var56][var58][var57] & var2) != 0) {
							var9 = var57;
							var10 = var57;
							var11 = var56;

							for (var12 = var56; var9 > 0 && (class344.field3130[var56][var58][var9 - 1] & var2) != 0; --var9) {
							}

							while (var10 < 104 && (class344.field3130[var56][var58][var10 + 1] & var2) != 0) {
								++var10;
							}
							...
							while (var11 > 0) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((class344.field3130[var11 - 1][var58][var13] & var2) == 0) {
										break label336;
									}
								}
							...
							while (var12 < var5) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((class344.field3130[var12 + 1][var58][var13] & var2) == 0) {
										break label325;
									}
								}
							...
							if (var13 >= 8) {
								...
								for (var17 = var11; var17 <= var12; ++var17) {
									for (var18 = var9; var18 <= var10; ++var18) {
										var10000 = class344.field3130[var17][var58];
										var10000[var18] &= ~var2;
									}
								}
							}
						...
						if ((class344.field3130[var56][var58][var57] & var3) != 0) {
							var9 = var58;
							var10 = var58;
							var11 = var56;

							for (var12 = var56; var9 > 0 && (class344.field3130[var56][var9 - 1][var57] & var3) != 0; --var9) {
							}

							while (var10 < 104 && (class344.field3130[var56][var10 + 1][var57] & var3) != 0) {
								++var10;
							}
							...
							while (var11 > 0) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((class344.field3130[var11 - 1][var13][var57] & var3) == 0) {
										break label389;
									}
								}
							...
							while (var12 < var5) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((class344.field3130[var12 + 1][var13][var57] & var3) == 0) {
										break label378;
									}
								}
							...
							if (var13 >= 8) {
								...
								for (var17 = var11; var17 <= var12; ++var17) {
									for (var18 = var9; var18 <= var10; ++var18) {
										var10000 = class344.field3130[var17][var18];
										var10000[var57] &= ~var3;
									}
								}
							}
						...
						if ((class344.field3130[var56][var58][var57] & var4) != 0) {
							var9 = var58;
							var10 = var58;
							var11 = var57;

							for (var12 = var57; var11 > 0 && (class344.field3130[var56][var58][var11 - 1] & var4) != 0; --var11) {
							}

							while (var12 < 104 && (class344.field3130[var56][var58][var12 + 1] & var4) != 0) {
								++var12;
							}
							...
							while (var9 > 0) {
								for (var13 = var11; var13 <= var12; ++var13) {
									if ((class344.field3130[var56][var9 - 1][var13] & var4) == 0) {
										break label442;
									}
								}
							...
							while (var10 < 104) {
								for (var13 = var11; var13 <= var12; ++var13) {
									if ((class344.field3130[var56][var10 + 1][var13] & var4) == 0) {
										break label431;
									}
								}
							...
							if ((var10 - var9 + 1) * (var12 - var11 + 1) >= 4) {
								...
								for (var14 = var9; var14 <= var10; ++var14) {
									for (var15 = var11; var15 <= var12; ++var15) {
										var10000 = class344.field3130[var56][var14];
										var10000[var15] &= ~var4;
									}
								}
							}
