...
public final class PointInterface {
	...
	private void drawExperienceConfig() {
		...
		int nextLevelExpA = mc.getLevelXPs()[ATTACK];
		nextLevelExpA = mc.getLevelXPs()[mc.getPlayerStatBase(ATTACK) - 1];
		...
		int nextLevelExpD = mc.getLevelXPs()[DEFENSE];
		nextLevelExpD = mc.getLevelXPs()[mc.getPlayerStatBase(DEFENSE) - 1];
		...
		int nextLevelExpS = mc.getLevelXPs()[STRENGTH];
		nextLevelExpS = mc.getLevelXPs()[mc.getPlayerStatBase(STRENGTH) - 1];
		...
		int nextLevelExpR = mc.getLevelXPs()[RANGED];
		nextLevelExpR = mc.getLevelXPs()[mc.getPlayerStatBase(RANGED) - 1];
		...
		int nextLevelExpP = mc.getLevelXPs()[PRAYER];
		nextLevelExpP = mc.getLevelXPs()[mc.getPlayerStatBase(PRAYER) - 1];
		...
		int nextLevelExpM = mc.getLevelXPs()[6];
		nextLevelExpM = mc.getLevelXPs()[mc.getPlayerStatBase(6) - 1];
