...
public class class36 {
	...
	static final void drawWidgets(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		if (ModeWhere.loadInterface(var0)) {
			class162.field1420 = null;
			class135.drawInterface(PacketBufferNode.Widget_interfaceComponents[var0], -1, var1, var2, var3, var4, var5, var6, var7);
			if (class162.field1420 != null) {
				class135.drawInterface(class162.field1420, -1412584499, var1, var2, var3, var4, class134.field1294, class326.field2893, var7);
				class162.field1420 = null;
			}
