...
public class class36 {
	...
	public static int method182(CharSequence var0) {
		return class230.method1184(var0, 10, true);
	}
	...
	static final void method183(int var0, int var1) {
		if (Client.currentClanChannels[var0] != null) {
			if (var1 >= 0 && var1 < Client.currentClanChannels[var0].method868()) {
				ClanChannelMember var2 = (ClanChannelMember)Client.currentClanChannels[var0].members.get(var1);
				if (var2.rank == -1) {
					PacketBufferNode var3 = ClanChannelMember.getPacketBufferNode(ClientPacket.f83, Client.packetWriter.isaacCipher);
