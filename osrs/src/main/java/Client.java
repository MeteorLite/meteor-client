...
public final class Client extends GameEngine implements Usernamed, OAuthApi {
	...
	static {
		...
		field631 = new int[]{768, 1024, 1280, 512, 1536, 256, 0, 1792};
	...
	protected final void setUp() {
		...
		class159.worldPort = gameBuild == 0 ? 43594 : worldId + 40000;
		class131.js5Port = gameBuild == 0 ? 443 : worldId + 50000;
	...
	void method1186(String var1) throws IOException {
		...
		OtlTokenRequester var6 = this.field537;
		if (var6 != null) {
								...
								if (var8 == class420.NetCache_responseArchiveBuffer.offset) {
									if (16711935L == UserComparator6.NetCache_currentResponse.key) {
										...
										if (var10 != UserComparator6.NetCache_currentResponse.crc) {
											...
											NetCache.field4180 = (byte)((int)(Math.random() * 255.0D + 1.0D));
											var1 = false;
											break label246;
										}
		...
		try {
			...
			if (loginState == 21) {
				if (this.field538 != null) {
					...
					try {
						OtlTokenRequester var3 = (OtlTokenRequester)this.field538.get();
/*						if (!var3.isSuccess()) {
							class129.getLoginError(65);
							this.field538 = null;
							return;
			...
			if (loginState == 5) {
				...
				var5.packetBuffer.method8437(class143.archive13.hash);
				var5.packetBuffer.writeInt(class157.archive2.hash);
				var5.packetBuffer.method8635(class310.archive19.hash);
				var5.packetBuffer.writeInt(class142.archive8.hash);
				var5.packetBuffer.method8437(SecureRandomFuture.archive9.hash);
				var5.packetBuffer.method8635(0);
				var5.packetBuffer.method8453(MouseHandler.field251.hash);
				var5.packetBuffer.method8635(ClanChannel.archive15.hash);
				var5.packetBuffer.writeInt(WorldMapRegion.archive10.hash);
				var5.packetBuffer.method8437(class150.archive5.hash);
				var5.packetBuffer.method8453(NetCache.archive18.hash);
				var5.packetBuffer.method8437(ReflectionCheck.archive6.hash);
				var5.packetBuffer.method8635(PlayerType.archive7.hash);
				var5.packetBuffer.method8453(class7.field32.hash);
				var5.packetBuffer.method8635(WorldMapSectionType.archive11.hash);
				var5.packetBuffer.writeInt(field522.hash);
				var5.packetBuffer.method8453(ChatChannel.archive14.hash);
				var5.packetBuffer.method8453(class382.archive17.hash);
				var5.packetBuffer.method8635(class139.archive20.hash);
				var5.packetBuffer.writeInt(Canvas.archive4.hash);
				var5.packetBuffer.method8453(class188.archive12.hash);
			...
			if (loginState == 9 && this.field544.method33()) {
				...
				var31.packetBuffer.method8397(this.field585);
				packetWriter.addNode(var31);
				packetWriter.flush();
				this.field585 = null;
				ReflectionCheck.method713(6);
						...
						while (true) {
							if (var9 >= var44) {
								if (BufferedSink.clientPreferences.parameters.size() >= 10 && !BufferedSink.clientPreferences.parameters.containsKey(var14)) {
									Iterator var45 = BufferedSink.clientPreferences.parameters.entrySet().iterator();
									var45.next();
									var45.remove();
								}
			...
			if (gameState == 30) {
				while (true) {
					...
					if (!var29) {
						...
						int var15;
						if (timer.field4399) {
							var14 = FloorUnderlayDefinition.getPacketBufferNode(ClientPacket.field3023, packetWriter.isaacCipher);
							var14.packetBuffer.writeByte(0);
							var15 = var14.packetBuffer.offset;
							timer.write(var14.packetBuffer);
							var14.packetBuffer.method8433(var14.packetBuffer.offset - var15);
						...
						synchronized(GrandExchangeOfferOwnWorldComparator.mouseRecorder.lock) {
							if (!field517) {
								...
								if (var30 != null) {
									var30.packetBuffer.method8433(var30.packetBuffer.offset - var3);
						...
						if (MouseHandler.MouseHandler_lastButton == 1 || !class82.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) {
							...
							var5 = (int)var16;
							PacketBufferNode var18 = FloorUnderlayDefinition.getPacketBufferNode(ClientPacket.field3051, packetWriter.isaacCipher);
						...
						if (field589 && field779 <= 0) {
							field779 = 20;
							field589 = false;
							var14 = FloorUnderlayDefinition.getPacketBufferNode(ClientPacket.field3034, packetWriter.isaacCipher);
						...
						if (ChatChannel.hasFocus && !hadFocus) {
							hadFocus = true;
							var14 = FloorUnderlayDefinition.getPacketBufferNode(ClientPacket.field3016, packetWriter.isaacCipher);
						...
						if (UserComparator3.method2773() && field733.method3956(82) && field733.method3956(81) && mouseWheelRotation != 0) {
							...
							if (var3 != class296.localPlayer.plane) {
								class143.method3054(class296.localPlayer.pathX[0] + class26.baseX * 64, class296.localPlayer.pathY[0] + class158.baseY * 64, var3, false);
							}
															...
															while (true) {
																...
																if (var53 == null) {
																		...
																		if (MouseHandler.MouseHandler_currentButton == 0) {
																			if (field616) {
																				if (VerticalAlignment.dragInventoryWidget == class168.hoveredItemContainer && dragItemSlotSource != dragItemSlotDestination) {
																					...
																					var26 = FloorUnderlayDefinition.getPacketBufferNode(ClientPacket.field3057, packetWriter.isaacCipher);
																					var26.packetBuffer.method8635(VerticalAlignment.dragInventoryWidget.id);
																					var26.packetBuffer.method8434(var34);
																					var26.packetBuffer.method8443(dragItemSlotSource);
																				...
																				if (var50 != null) {
																					PacketBufferNode.method5389(var50.param0, var50.param1, var50.opcode, var50.identifier, var50.field883, var50.action, var50.field889, var3, var4);
																				}
																	...
																	if (Scene.shouldSendWalk()) {
																		...
																		var52.packetBuffer.method8619(class26.baseX * 64 + var3);
																	...
																	if (MouseHandler.MouseHandler_currentButton == 4 && class82.mouseCam) {
																		var3 = MouseHandler.MouseHandler_y - field743;
																		field576 = var3 * 2;
																		field743 = var3 != -1 && var3 != 1 ? (field743 + MouseHandler.MouseHandler_y) / 2 : MouseHandler.MouseHandler_y;
																		var4 = field577 - MouseHandler.MouseHandler_x;
																		field575 = var4 * 2;
																		field577 = var4 != -1 && var4 != 1 ? (field577 + MouseHandler.MouseHandler_x) / 2 : MouseHandler.MouseHandler_x;
																	} else {
																		...
																		field743 = MouseHandler.MouseHandler_y;
																		field577 = MouseHandler.MouseHandler_x;
																	}

																	camAngleY = field575 / 2 + camAngleY & 2047;
																	camAngleX += field576 / 2;
																	if (camAngleX < 128) {
																		camAngleX = 128;
																	}
																	...
																	if (var3 > 15000 && var5 > 15000) {
																		...
																		var26 = FloorUnderlayDefinition.getPacketBufferNode(ClientPacket.field3084, packetWriter.isaacCipher);
																		packetWriter.addNode(var26);
																	}
																	...
																	if (packetWriter.pendingWrites > 50) {
																		var26 = FloorUnderlayDefinition.getPacketBufferNode(ClientPacket.field3040, packetWriter.isaacCipher);
																		packetWriter.addNode(var26);
																	}
					...
					var30 = FloorUnderlayDefinition.getPacketBufferNode(ClientPacket.field3000, packetWriter.isaacCipher);
					var30.packetBuffer.writeByte(0);
					var3 = var30.packetBuffer.offset;
	...
	final void drawLoggedIn() {
		...
		if (rootInterface != -1) {
			rootWidgetCount = 0;
			KeyHandler.drawWidgets(rootInterface, 0, 0, GameEngine.canvasWidth, class10.canvasHeight, 0, 0, -1);
		}
		...
		if (!isMenuOpen) {
			...
			UserComparator8.method2749(class103.menuX, class108.menuY, class174.menuWidth, WorldMapScaleHandler.menuHeight);
		}
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3142 == var1.serverPacket) {
					var20 = var3.method8458();
					var5 = var3.method8484();
				...
				if (ServerPacket.field3170 == var1.serverPacket) {
					var20 = var3.method8436();
					var5 = var3.method8436();
				...
				if (ServerPacket.field3182 == var1.serverPacket) {
					DevicePcmPlayerProvider.field122 = var3.method8436();
					class11.field64 = var3.method8435();
				...
				if (ServerPacket.field3192 == var1.serverPacket) {
					...
					if (!var66) {
						field775[field732] = var11;
						field732 = (field732 + 1) % 100;
				...
				if (ServerPacket.field3141 == var1.serverPacket) {
					...
					var20 = var3.method8484();
					var5 = var3.method8446();
					if (var5 == 65535) {
						var5 = -1;
					}
				...
				if (ServerPacket.field3220 == var1.serverPacket) {
					rebootTimer = var3.method8484() * 30;
					field499 = cycleCntr;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3195 == var1.serverPacket) {
					...
					PacketBufferNode var57 = FloorUnderlayDefinition.getPacketBufferNode(ClientPacket.field3070, packetWriter.isaacCipher);
					var57.packetBuffer.writeInt(var20);
					var57.packetBuffer.method8437(var5);
					var57.packetBuffer.method8546(var22);
					var57.packetBuffer.method8434(GameEngine.fps);
				...
				if (ServerPacket.field3137 == var1.serverPacket) {
					var20 = var3.method8484();
					var5 = var3.method8444();
					var22 = var3.method8446();
					var27 = var3.readInt();
				...
				if (ServerPacket.field3135 == var1.serverPacket) {
					var20 = var3.method8444();
					var5 = var3.method8444();
					var22 = var3.method8458();
				...
				if (ServerPacket.field3153 == var1.serverPacket) {
					...
					field694[++field695 - 1 & 31] = var5 & 32767;
					var1.serverPacket = null;
					return true;
				}

				if (ServerPacket.field3165 == var1.serverPacket) {
					publicChatMode = var3.method8435();
				...
				if (ServerPacket.field3144 == var1.serverPacket) {
					class11.field64 = var3.method8623();
				...
				if (ServerPacket.field3193 == var1.serverPacket) {
					...
					class11.field62 = var3.readUnsignedByte() * 128;
					...
					if (UrlRequest.field1398 >= 100) {
						...
						class313.cameraZ = class11.field62 * 16384 + 64;
				...
				if (ServerPacket.field3243 == var1.serverPacket) {
					...
					if (var27 >= 0 && var26 >= 0 && var27 < 104 && var26 < 104) {
						var27 = var27 * 128 + 64;
						var26 = var26 * 128 + 64;
						GraphicsObject var86 = new GraphicsObject(var30, ApproximateRouteStrategy.Client_plane, var27, var26, class132.getTileHeight(var27, var26, ApproximateRouteStrategy.Client_plane) - var36, var37, cycle);
						graphicsObjects.addFirst(var86);
					}
				...
				if (ServerPacket.field3180 == var1.serverPacket) {
					...
					var81 = var3.method8617();
					var15 = var3.method8484();
					var16 = var3.method8484();
					var13 = var3.readUnsignedByte() * 4;
					var87 = var3.method8617();
					var18 = var3.readUnsignedByte();
					var37 = var3.method8465();
					var17 = var3.method8436();
					var22 = var3.readMedium();
					var20 = var22 >> 16;
					var5 = var22 >> 8 & 255;
					var27 = var20 + (var22 >> 4 & 7);
					var26 = var5 + (var22 & 7);
					var83 = var3.method8435() * 4;
					var30 = var81 + var27;
					var36 = var87 + var26;
					if (var27 >= 0 && var26 >= 0 && var27 < 104 && var26 < 104 && var30 >= 0 && var36 >= 0 && var30 < 104 && var36 < 104 && var39 != 65535) {
						...
						var30 = var30 * 128 + 64;
						var36 = var36 * 128 + 64;
						var19 = new Projectile(var39, ApproximateRouteStrategy.Client_plane, var27, var26, class132.getTileHeight(var27, var26, ApproximateRouteStrategy.Client_plane) - var13, var15 + cycle, var16 + cycle, var17, var18, var37, var83);
						var19.setDestination(var30, var36, class132.getTileHeight(var30, var36, ApproximateRouteStrategy.Client_plane) - var83, var15 + cycle);
				...
				if (ServerPacket.field3234 == var1.serverPacket) {
					...
					var15 = var3.method8446();
					var18 = var3.method8436();
					var22 = var3.readMedium();
					var20 = var22 >> 16;
					var5 = var22 >> 8 & 255;
					var27 = var20 + (var22 >> 4 & 7);
					...
					var13 = var3.method8436() * 4;
					var87 = var3.readByte();
					var83 = var3.method8623() * 4;
					var81 = var3.readByte();
				...
				if (ServerPacket.field3191 == var1.serverPacket) {
					var20 = var3.readInt();
					var5 = var3.method8484();
					var6 = class281.getWidget(var20);
				...
				if (ServerPacket.field3231 == var1.serverPacket) {
					...
					for (var26 = 0; var26 < var27; ++var26) {
						var30 = var3.method8444();
						var36 = var3.method8623();
						if (var36 == 255) {
				...
				if (ServerPacket.field3178 == var1.serverPacket) {
					var20 = var3.method8623();
					var5 = var3.method8456();
					var22 = var3.method8484();
				...
				if (ServerPacket.field3196 == var1.serverPacket) {
					...
					var22 = var3.method8456();
					var5 = var3.method8484();
					if (var56 != null) {
						var56.spotAnimation = var5;
						var56.field1159 = var22 >> 16;
						var56.field1186 = (var22 & 65535) + cycle;
				...
				if (ServerPacket.field3176 == var1.serverPacket) {
					...
					field694[++field695 - 1 & 31] = var20 & 32767;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3217 == var1.serverPacket) {
					...
					if (!var85) {
						field775[field732] = var9;
						field732 = (field732 + 1) % 100;
						var40 = class296.method5721(var3);
						var83 = var68 >= 0 ? 43 : 46;
						ItemContainer.addChatMessage(var83, "", var40, var38.name);
					}
				...
				if (ServerPacket.field3134 == var1.serverPacket) {
					class11.field64 = var3.method8435();
					DevicePcmPlayerProvider.field122 = var3.method8435();
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3173 == var1.serverPacket) {
					var20 = var3.method8444();
					var7 = npcs[var20];
					var22 = var3.method8444();
					var5 = var3.method8457();
					if (var7 != null) {
						var7.spotAnimation = var22;
						var7.field1159 = var5 >> 16;
						var7.field1186 = (var5 & 65535) + cycle;
				...
				if (ServerPacket.field3164 == var1.serverPacket) {
					isCameraLocked = true;
					field758 = false;
					class4.field11 = var3.readUnsignedByte() * 128;
					...
					if (HealthBarDefinition.field1912 >= 100) {
						...
						class408.cameraPitch = (int)(Math.atan2((double)var26, (double)var36) * 325.9490051269531D) & 2047;
						WorldMapSection1.cameraYaw = (int)(Math.atan2((double)var27, (double)var30) * -325.9490051269531D) & 2047;
				...
				if (ServerPacket.field3130 == var1.serverPacket) {
					var13 = var3.method8484();
					var30 = var3.method8435();
					var36 = var30 >> 2;
					var37 = var30 & 3;
				...
				var21 = "" + (var1.serverPacket != null ? var1.serverPacket.id : -1) + "," + (var1.field1373 != null ? var1.field1373.id : -1) + "," + (var1.field1381 != null ? var1.field1381.id : -1) + "," + var1.serverPacketLength + "," + (class296.localPlayer.pathX[0] + class26.baseX * 64) + "," + (class296.localPlayer.pathY[0] + class158.baseY * 64) + ",";
		...
		if (VerticalAlignment.dragInventoryWidget == null) {
			if (clickedWidget == null) {
				...
				label273: {
					...
					if (isMenuOpen) {
						if (var21 != 1 && (class82.mouseCam || var21 != 4)) {
							...
							if (var2 < class103.menuX - 10 || var2 > class103.menuX + class174.menuWidth + 10 || var3 < class108.menuY - 10 || var3 > WorldMapScaleHandler.menuHeight + class108.menuY + 10) {
								isMenuOpen = false;
								AbstractArchive.method6439(class103.menuX, class108.menuY, class174.menuWidth, WorldMapScaleHandler.menuHeight);
							}
						}
						...
						if (var21 == 1 || !class82.mouseCam && var21 == 4) {
							...
							if (var22 != -1 && var22 >= 0) {
								...
								int var12 = field647[var22];
								String var13 = menuActions[var22];
								String var14 = menuTargets[var22];
								PacketBufferNode.method5389(var8, var23, var10, var18, var12, var13, var14, MouseHandler.MouseHandler_lastPressedX, MouseHandler.MouseHandler_lastPressedY);
							}
						...
						if ((var21 == 1 || !class82.mouseCam && var21 == 4) && menuOptionsCount > 0 && var2 >= 0) {
							...
							PacketBufferNode.method5389(var3, var4, var5, var24, var22, var16, var17, MouseHandler.MouseHandler_lastPressedX, MouseHandler.MouseHandler_lastPressedY);
						}
				...
				if (VerticalAlignment.dragInventoryWidget != null && !field616 && menuOptionsCount > 0 && !this.shouldLeftClickOpenMenu()) {
					...
					if (var11 != null) {
						PacketBufferNode.method5389(var11.param0, var11.param1, var11.opcode, var11.identifier, var11.field883, var11.action, var11.field889, var23, var10);
					}
		...
		if (field640 && field684) {
			...
			if (MouseHandler.MouseHandler_currentButton == 0) {
				if (isDraggingWidget) {
					...
					if (draggedOnWidget != null) {
						...
						if (var18 != null) {
							PacketBufferNode var19 = FloorUnderlayDefinition.getPacketBufferNode(ClientPacket.field3054, packetWriter.isaacCipher);
							...
							var19.packetBuffer.writeIntME(draggedOnWidget.itemId);
					...
					if (var10 != null) {
						PacketBufferNode.method5389(var10.param0, var10.param1, var10.opcode, var10.identifier, var10.field883, var10.action, var10.field889, var14, var9);
					}
			...
			if (Script.widgetDragDuration > 1) {
				if (!isDraggingWidget && menuOptionsCount > 0) {
					...
					if (var17 != null) {
						PacketBufferNode.method5389(var17.param0, var17.param1, var17.opcode, var17.identifier, var17.field883, var17.action, var17.field889, var1, var2);
					}
	...
	static void changeWorld(World var0) {
		...
		class159.worldPort = gameBuild == 0 ? 43594 : var0.id + 40000;
		class131.js5Port = gameBuild == 0 ? 443 : var0.id + 50000;
		class454.currentPort = class159.worldPort;
	}
