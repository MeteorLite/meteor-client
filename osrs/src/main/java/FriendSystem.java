...
public class FriendSystem {
   ...
   final void processFriendUpdates() {
      for(class391 var1 = (class391)this.friendsList.field4504.method6844(); var1 != null; var1 = (class391)this.friendsList.field4504.method6846()) {
         if ((long)var1.field4520 < Message.method1197() / 1000L - 5L) {
            if (var1.field4522 > 0) {
               KitDefinition.addGameMessage(5, "", var1.field4521 + " has logged in.");
            }

            if (var1.field4522 == 0) {
               KitDefinition.addGameMessage(5, "", var1.field4521 + " has logged out.");
            }
      ...
      if (var1 != null) {
         ...
         if (var2.hasCleanName()) {
            if (this.friendsList.removeByUsername(var2)) {
               ...
               PacketBufferNode var3 = class136.getPacketBufferNode(ClientPacket.field3150, Client.packetWriter.isaacCipher);
               var3.packetBuffer.writeByte(class13.stringCp1252NullTerminatedByteSize(var1));
               var3.packetBuffer.writeStringCp1252NullTerminated(var1);
               Client.packetWriter.addNode(var3);
            }
      ...
      if (var1 != null) {
         ...
         if (var2.hasCleanName()) {
            if (this.ignoreList.removeByUsername(var2)) {
               Client.field715 = Client.cycleCntr;
               PacketBufferNode var3 = class136.getPacketBufferNode(ClientPacket.field3148, Client.packetWriter.isaacCipher);
               var3.packetBuffer.writeByte(class13.stringCp1252NullTerminatedByteSize(var1));
               var3.packetBuffer.writeStringCp1252NullTerminated(var1);
               Client.packetWriter.addNode(var3);
            }
   ...
   static final void method1860(PacketBuffer var0) {
      ...
      for(var2 = 0; var2 < Players.Players_count; ++var2) {
         ...
         if ((Players.field1370[var5] & 1) == 0) {
            if (var1 > 0) {
               --var1;
               Players.field1370[var5] = (byte)(Players.field1370[var5] | 2);
            } else {
            ...
            if (var1 != 0) {
               ...
               if (var1 != 0) {
                  ...
                  for(var2 = 1; var2 < 2048; ++var2) {
                     Players.field1370[var2] = (byte)(Players.field1370[var2] >> 1);
