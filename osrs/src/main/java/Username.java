   ...
   public Username(String var1, LoginType var2) {
      ...
      if (var1 == null) {
         ...
         label115: {
            ...
            int var6;
            for(var6 = var1.length(); var5 < var6 && MenuAction.method417(var1.charAt(var5)); ++var5) {
               ;
            }

            while(var6 > var5 && MenuAction.method417(var1.charAt(var6 - 1))) {
               --var6;
            }
