...
public class Username implements Comparable {
	...
	public Username(String var1, LoginType var2) {
		this.name = var1;
		this.cleanName = class14.method52(var1, var2);
	}
	...
	public Username(String var1) {
		...
		if (var1 == null) {
			...
			label100: {
				...
				int var6;
				for (var6 = var1.length(); var5 < var6 && class489.method2381(var1.charAt(var5)); ++var5) {
				}

				while (var6 > var5 && class489.method2381(var1.charAt(var6 - 1))) {
					--var6;
				}
				...
				if (var7 >= 1) {
					...
					if (var7 <= var9) {
						...
						for (int var17 = var5; var17 < var6; ++var17) {
							...
							if (var11) {
								char var16 = FriendsChat.method2219(var10);
								if (var16 != 0) {
									var15.append(var16);
								}
							}
