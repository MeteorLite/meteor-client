...
public class Rasterizer3D extends Rasterizer2D {
	...
	static {
		...
		field2433 = new int[512];
		field2423 = new int[2048];
		Rasterizer3D_sine = new int[2048];
		Rasterizer3D_cosine = new int[2048];

		int var0;
		for (var0 = 1; var0 < 512; ++var0) {
			field2433[var0] = 32768 / var0;
		}

		for (var0 = 1; var0 < 2048; ++var0) {
			field2423[var0] = 65536 / var0;
		}
	...
	static final void Rasterizer3D_setClip(int var0, int var1, int var2, int var3) {
		...
		if (Rasterizer3D_rowOffsets.length < Rasterizer3D_clipHeight) {
			Rasterizer3D_rowOffsets = new int[class37.method712(Rasterizer3D_clipHeight)];
		}
	...
	@ObfuscatedName("x")
	public static final void method4192(int var0, int var1) {
	...
	@ObfuscatedName("n")
	public static void method4233(int var0, int var1, int var2) {
		field2420 = var0 < 0 || var0 > Rasterizer3D_clipWidth || var1 < 0 || var1 > Rasterizer3D_clipWidth || var2 < 0 || var2 > Rasterizer3D_clipWidth;
	}

	@ObfuscatedName("r")
	static final void method4158(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		int var9 = var4 - var3;
		int var10 = var1 - var0;
		int var11 = var5 - var3;
		int var12 = var2 - var0;
	...
	@ObfuscatedName("l")
	static final void method4159(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, byte var9, byte var10, byte var11, byte var12) {
		var6 = method4160(var6, var9, var10, var11, var12);
		var7 = method4160(var7, var9, var10, var11, var12);
		var8 = method4160(var8, var9, var10, var11, var12);
		method4158(var0, var1, var2, var3, var4, var5, var6, var7, var8);
	}

	@ObfuscatedName("s")
	static int method4160(int var0, byte var1, byte var2, byte var3, byte var4) {
		int var5 = var0 >> 10 & 63;
		int var6 = var0 >> 7 & 7;
		int var7 = var0 & 127;
		int var8 = var4 & 255;
				...
				if (Rasterizer3D_alpha == 0) {
					...
					if (var3 > 0) {
						do {
							...
							var11 = var0[var1];
							var0[var1++] = ((var11 & 16711935) * var8 >> 8 & 16711935) + var2 + (var8 * (var11 & 65280) >> 8 & 65280);
							var11 = var0[var1];
							var0[var1++] = ((var11 & 16711935) * var8 >> 8 & 16711935) + var2 + (var8 * (var11 & 65280) >> 8 & 65280);
							var11 = var0[var1];
							var0[var1++] = ((var11 & 16711935) * var8 >> 8 & 16711935) + var2 + (var8 * (var11 & 65280) >> 8 & 65280);
	...
	@ObfuscatedName("b")
	public static final void method4220(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		int var7 = 0;
		if (var0 != var1) {
	...
	@ObfuscatedName("o")
	static final void method4163(int var0, int var1, int var2, int var3, int var4, int var5, int var6, byte var7, byte var8, byte var9, byte var10) {
		int var11 = method4160(var6, var7, var8, var9, var10);
		var6 = Rasterizer3D_colorPalette[var11];
		method4220(var0, var1, var2, var3, var4, var5, var6);
	}
	...
	@ObfuscatedName("z")
	static final void method4165(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
		int[] var19 = Rasterizer3D_textureLoader.getTexturePixels(var18);
		int var20;
		if (var19 == null) {
			var20 = Rasterizer3D_textureLoader.getAverageTextureRGB(var18);
			method4158(var0, var1, var2, var3, var4, var5, method4168(var20, var6), method4168(var20, var7), method4168(var20, var8));
		} else {
			Rasterizer3D_isLowDetailTexture = Rasterizer3D_textureLoader.isLowDetail(var18);
			field2430 = Rasterizer3D_textureLoader.vmethod4645(var18);
			var20 = var4 - var3;
			int var21 = var1 - var0;
			int var22 = var5 - var3;
			int var23 = var2 - var0;
	...
	@ObfuscatedName("i")
	static final int method4190(int var0, int var1, int var2, int var3) {
		return var0 * var2 + var3 * var1 >> 16;
	}

	@ObfuscatedName("e")
	static final int method4170(int var0, int var1, int var2, int var3) {
		return var2 * var1 - var3 * var0 >> 16;
	}

	@ObfuscatedName("g")
	static final int method4214(int var0, int var1, int var2, int var3) {
		return var0 * var2 - var3 * var1 >> 16;
	}

	@ObfuscatedName("k")
	static final int method4172(int var0, int var1, int var2, int var3) {
		return var3 * var0 + var2 * var1 >> 16;
	}

	@ObfuscatedName("v")
	static final int method4189(int var0, int var1, int var2, int var3) {
		return var0 * var2 + var3 * var1 >> 16;
	}

	@ObfuscatedName("aj")
	static final int method4199(int var0, int var1, int var2, int var3) {
		return var2 * var1 - var3 * var0 >> 16;
	}
}
