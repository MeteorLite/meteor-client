...
public class Rasterizer3D extends Rasterizer2D {
   @ObfuscatedName("aj")
   static boolean field1962 = false;
   @ObfuscatedName("al")
   static boolean field1958 = false;
   @ObfuscatedName("ac")
   ...
   @ObfuscatedName("aa")
   static int[] field1975 = new int[512];
   @ObfuscatedName("ah")
   static int[] field1964 = new int[2048];
   @ObfuscatedName("ad")
   ...
   static {
      ...
      for(var0 = 1; var0 < 512; ++var0) {
         field1975[var0] = '耀' / var0;
      }

      for(var0 = 1; var0 < 2048; ++var0) {
         field1964[var0] = 65536 / var0;
      }
   ...
   static final void Rasterizer3D_setClip(int var0, int var1, int var2, int var3) {
      ...
      if (Rasterizer3D_rowOffsets.length < Rasterizer3D_clipHeight) {
         Rasterizer3D_rowOffsets = new int[WorldMapLabelSize.method1313(Rasterizer3D_clipHeight)];
      }
   ...
   @ObfuscatedName("ab")
   public static final void method1170(int var0, int var1) {
   ...
   @ObfuscatedName("ap")
   public static void method1174(int var0, int var1, int var2) {
      field1962 = var0 < 0 || var0 > Rasterizer3D_clipWidth || var1 < 0 || var1 > Rasterizer3D_clipWidth || var2 < 0 || var2 > Rasterizer3D_clipWidth;
   }

   @ObfuscatedName("ar")
   static final void method1156(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = var4 - var3;
      int var10 = var1 - var0;
      int var11 = var5 - var3;
      int var12 = var2 - var0;
   ...
   @ObfuscatedName("ak")
   static final void method1166(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, byte var9, byte var10, byte var11, byte var12) {
      var6 = method1171(var6, var9, var10, var11, var12);
      var7 = method1171(var7, var9, var10, var11, var12);
      var8 = method1171(var8, var9, var10, var11, var12);
      method1156(var0, var1, var2, var3, var4, var5, var6, var7, var8);
   }

   @ObfuscatedName("ax")
   static int method1171(int var0, byte var1, byte var2, byte var3, byte var4) {
      int var5 = var0 >> 10 & 63;
      int var6 = var0 >> 7 & 7;
      int var7 = var0 & 127;
      int var8 = var4 & 255;
   ...
   @ObfuscatedName("am")
   static final void method1169(int var0, int var1, int var2, int var3, int var4, int var5, int var6, byte var7, byte var8, byte var9, byte var10) {
      int var11 = method1171(var6, var7, var8, var9, var10);
   ...
   @ObfuscatedName("ae")
   static final void method1176(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
      int[] var19 = Rasterizer3D_textureLoader.getTexturePixels(var18);
      int var20;
      if (var19 == null) {
         var20 = Rasterizer3D_textureLoader.getAverageTextureRGB(var18);
         method1156(var0, var1, var2, var3, var4, var5, method1162(var20, var6), method1162(var20, var7), method1162(var20, var8));
      } else {
         Rasterizer3D_isLowDetailTexture = Rasterizer3D_textureLoader.isLowDetail(var18);
         field1958 = Rasterizer3D_textureLoader.vmethod4645(var18);
         var20 = var4 - var3;
         int var21 = var1 - var0;
         int var22 = var5 - var3;
         int var23 = var2 - var0;
   ...
   @ObfuscatedName("ah")
   static final int method1175(int var0, int var1, int var2, int var3) {
