...
public class BufferedFile {
	...
	@ObfuscatedName("x")
	@ObfuscatedGetter(
		longValue = -5642031004138481959L
	)
	...
	@ObfuscatedName("y")
	@ObfuscatedGetter(
		longValue = -8498939649239068171L
	)
	...
	@ObfuscatedName("n")
	@ObfuscatedGetter(
		longValue = 6440253106442464501L
	)
	@Export("offset")
	long offset;
	@ObfuscatedName("r")
	@ObfuscatedGetter(
		longValue = -8794727664200577907L
	)
	@Export("fileLength")
	long fileLength;
	@ObfuscatedName("l")
	@ObfuscatedGetter(
		longValue = -5606896970923425505L
	)
	@Export("length")
	long length;
	@ObfuscatedName("s")
	@ObfuscatedGetter(
		longValue = -2021836636153546571L
	)
	@Export("fileOffset")
	long fileOffset;
	...
	void flush() throws IOException {
		if (this.writeBufferOffset != -1L) {
			...
			this.fileOffset += (long)(this.writeBufferLength * -1321221861) * -128732909L;
			if (this.fileOffset > this.fileLength) {
				this.fileLength = this.fileOffset;
			}
