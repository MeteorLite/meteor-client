...
public class class208 extends DualNode {
	...
	public static EvictingDualNodeHashTable field1648;

	static {
		field1648 = new EvictingDualNodeHashTable(64);
	}
	...
	static final boolean method1028(byte[] var0, int var1, int var2) {
		boolean var3 = true;
