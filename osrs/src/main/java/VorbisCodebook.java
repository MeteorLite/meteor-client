...
public class VorbisCodebook {
	...
	VorbisCodebook() {
		...
		if (var1) {
			...
			for (var3 = VorbisSample.readBits(5) + 1; var2 < this.entries; ++var3) {
				int var4 = VorbisSample.readBits(Archive.iLog(this.entries - var2));
		...
		if (var2 > 0) {
			...
			this.field367 = new int[var7];

			int var8;
			for (var8 = 0; var8 < var7; ++var8) {
				this.field367[var8] = VorbisSample.readBits(var5);
			}

			this.field370 = new float[this.entries][this.dimensions];
			float var9;
			int var10;
			int var11;
			if (var2 == 1) {
				for (var8 = 0; var8 < this.entries; ++var8) {
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) {
						...
						float var13 = (float)this.field367[var12] * var16 + var15 + var9;
						this.field370[var8][var11] = var13;
						if (var6) {
							var9 = var13;
						}
				...
				for (var8 = 0; var8 < this.entries; ++var8) {
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) {
						float var17 = (float)this.field367[var10] * var16 + var15 + var9;
						this.field370[var8][var11] = var17;
						if (var6) {
							var9 = var17;
						}
	...
	@ObfuscatedName("n")
	float[] method1045() {
		return this.field370[this.method1044()];
	}
