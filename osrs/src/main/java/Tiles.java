...
public final class Tiles {
	...
	static {
		...
		Tiles_minPlane = 99;
		field849 = new int[]{1, 2, 4, 8};
		field847 = new int[]{16, 32, 64, 128};
		field850 = new int[]{1, 0, -1, 0};
	...
	static final void method455(byte[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, Scene var8, CollisionMap[] var9) {
