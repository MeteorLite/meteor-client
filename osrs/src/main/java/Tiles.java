...
public final class Tiles {
	...
	static {
		...
		field991 = new int[]{1, 0, -1, 0};
		field1003 = new int[]{0, -1, 0, 1};
		field993 = new int[]{1, -1, -1, 1};
		field1004 = new int[]{-1, -1, 1, 1};
			...
			while (true) {
				...
				if (var17 == var4 && var16 >= var5 && var16 < var5 + 8 && var15 >= var6 && var15 < var6 + 8) {
					...
					if (var22 > 0 && var23 > 0 && var22 < 103 && var23 < 103) {
						...
						class456.addObjects(var1, var22, var23, var11, var20 + var7 & 3, var19, var8, var25);
					}
				}
			}
		}
