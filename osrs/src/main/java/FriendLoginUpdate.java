...
public class FriendLoginUpdate extends Link {
   @ObfuscatedName("f")
   public int field3701 = (int)(class153.clockNow() / 1000L);
    @ObfuscatedName("w")
    @ObfuscatedSignature(
            descriptor = "Lsi;"
    )
   ...
   static String method2081() {
      String var0;
      if (PacketWriter.clientPreferences.getIsUsernameHidden()) {
         String var2 = Login.Login_username;
         String var1 = KeyHandler.method94('*', var2.length());
         var0 = var1;
      } else {
