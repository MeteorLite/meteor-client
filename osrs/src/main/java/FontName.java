...
public class FontName {
	...
	static final boolean method2446(int var0, int var1, int var2, RouteStrategy var3, CollisionMap var4, class216 var5) {
		int var6 = var5.method1132();
		int var7 = var5.method1133();
		int[][] var8 = var5.method1135();
		int[][] var9 = var5.method1134();
		int[] var10 = var5.method1136();
		int[] var11 = var5.method1137();
		int var12 = var5.method1138();
		int var13 = var0;
		int var14 = var1;
		int var15 = var6 >> 1;
		int var16 = var7 >> 1;
	...
	static void method2447(int var0) {
		SequenceDefinition var1 = EnumComposition.SequenceDefinition_get(var0);
		if (var1.isCachedModelIdSet()) {
			if (ClientPreferences.method571(var1.SequenceDefinition_cachedModelId) == 2) {
				Client.field609.add(var1.SequenceDefinition_cachedModelId);
			}
