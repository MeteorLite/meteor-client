               ...
               if (!var10.isIf3 || var15 < var17 && var16 < var18) {
                  if (var10.contentType != 0) {
                     ...
                     if (var10.contentType == 1402) {
                        class154.field1782.draw(var12, Client.cycle);
                     }
                  }
                                          ...
                                          if (var10 == class368.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
                                             ...
                                             if (var1 != -1) {
                                                ...
                                                if (var23 + var25 < Rasterizer2D.Rasterizer2D_yClipStart && var28.scrollY > 0) {
                                                   var29 = (Rasterizer2D.Rasterizer2D_yClipStart - var23 - var25) * Client.field563 / 3;
                                                   if (var29 > Client.field563 * 10) {
                                                ...
                                                if (var23 + var25 + 32 > Rasterizer2D.Rasterizer2D_yClipEnd && var28.scrollY < var28.scrollHeight - var28.height) {
                                                   var29 = (var23 + var25 + 32 - Rasterizer2D.Rasterizer2D_yClipEnd) * Client.field563 / 3;
                                                   if (var29 > Client.field563 * 10) {
                                                      var29 = Client.field563 * 10;
                                                   }
