...
public enum WorldMapSectionType implements class349 {
   ...
   @ObfuscatedSignature(
      ...
      garbageValue = "-801815823"
   )
   static void method1440(int var0, byte[] var1, ArchiveDisk var2) {
   ...
   static int method1439(AbstractArchive var0, AbstractArchive var1) {
      int var2 = 0;
      String[] var3 = Login.field774;
   ...
   static void method1441(Font var0, Font var1) {
      int var4;
      int var5;
      if (class491.worldSelectBackSprites == null) {
         ...
         SpritePixels[] var2 = AABB.method1240(var3, var4, var5);
         class491.worldSelectBackSprites = var2;
      }

      if (class307.worldSelectFlagSprites == null) {
         class307.worldSelectFlagSprites = class125.method705(WorldMapEvent.archive8, "sl_flags", "");
      }

      if (class391.worldSelectArrows == null) {
         class391.worldSelectArrows = class125.method705(WorldMapEvent.archive8, "sl_arrows", "");
      }

      if (KeyHandler.worldSelectStars == null) {
         KeyHandler.worldSelectStars = class125.method705(WorldMapEvent.archive8, "sl_stars", "");
      }
         ...
         for(var16 = var5 * var15; var16 < World.World_count && var15 - Login.worldSelectPage < var4; ++var16) {
            ...
            if (var17.isBeta()) {
               if (var17.isMembersOnly()) {
                  var20 = class103.field1101.field1107;
               } else {
                  var20 = class103.field1100.field1107;
               }
            } else if (var17.isDeadman()) {
               var21 = 16711680;
               if (var17.isMembersOnly()) {
                  var20 = class103.field1099.field1107;
               } else {
                  var20 = class103.field1098.field1107;
               }
            } else if (var17.method375()) {
               if (var17.isMembersOnly()) {
                  var20 = class103.field1103.field1107;
               } else {
                  var20 = class103.field1102.field1107;
               }
            } else if (var17.isPvp()) {
               if (var17.isMembersOnly()) {
                  var20 = class103.field1094.field1107;
               } else {
                  var20 = class103.field1096.field1107;
               }
            } else if (var17.method379()) {
               if (var17.isMembersOnly()) {
                  var20 = class103.field1105.field1107;
               } else {
                  var20 = class103.field1104.field1107;
               }
            } else if (var17.method380()) {
               if (var17.isMembersOnly()) {
                  var20 = class103.field1106.field1107;
               } else {
                  var20 = class103.field1095.field1107;
               }
            }

            if (var20 == -1 || var20 >= class491.worldSelectBackSprites.length) {
               if (var17.isMembersOnly()) {
                  var20 = class103.field1110.field1107;
               } else {
                  var20 = class103.field1109.field1107;
               }
            }
   ...
   static int method1438(int var0, Script var1, boolean var2) {
      ...
      if (var4 != null) {
         ...
         if (Client.minimapState != 2 && Client.minimapState != 5) {
            ...
            for(var8 = 0; var8 < Client.mapIconCount; ++var8) {
               var9 = Client.mapIconXs[var8] * 4 + 2 - class387.localPlayer.x / 32;
               var10 = Client.mapIconYs[var8] * 4 + 2 - class387.localPlayer.y / 32;
               class31.drawSpriteOnMinimap(var1, var2, var9, var10, Client.mapIcons[var8], var4);
            }
            ...
            for(var8 = 0; var8 < 104; ++var8) {
               for(var9 = 0; var9 < 104; ++var9) {
                  NodeDeque var14 = Client.groundItems[class103.Client_plane][var8][var9];
                  if (var14 != null) {
                     var11 = var8 * 4 + 2 - class387.localPlayer.x / 32;
                     var12 = var9 * 4 + 2 - class387.localPlayer.y / 32;
            ...
            for(var8 = 0; var8 < Client.npcCount; ++var8) {
               ...
               if (var15 != null && var15.isVisible()) {
                  ...
                  if (var17 != null && var17.drawMapDot && var17.isInteractable) {
                     var11 = var15.x / 32 - class387.localPlayer.x / 32;
                     var12 = var15.y / 32 - class387.localPlayer.y / 32;
            ...
            for(var10 = 0; var10 < var8; ++var10) {
               ...
               if (var16 != null && var16.isVisible() && !var16.isHidden && var16 != class387.localPlayer) {
                  var12 = var16.x / 32 - class387.localPlayer.x / 32;
                  int var13 = var16.y / 32 - class387.localPlayer.y / 32;
                  if (var16.isFriend()) {
                     class31.drawSpriteOnMinimap(var1, var2, var12, var13, UrlRequest.mapDotSprites[3], var4);
                  } else if (class387.localPlayer.team != 0 && var16.team != 0 && var16.team == class387.localPlayer.team) {
            ...
            if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
               ...
               if (Client.hintArrowType == 2) {
                  var10 = Client.hintArrowX * 4 - ParamComposition.baseX * 4 + 2 - class387.localPlayer.x / 32;
                  var11 = Client.hintArrowY * 4 - Client.baseY * 4 + 2 - class387.localPlayer.y / 32;
