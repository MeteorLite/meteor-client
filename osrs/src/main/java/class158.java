...
public class class158 extends class161 {
	...
	void vmethod3238(Buffer var1) {
		...
		var1.readLong();
		this.field1391 = var1.readStringCp1252NullTerminated();
		var1.readUnsignedByte();
	}
	...
	void vmethod3239(ClanChannel var1) {
		ClanChannelMember var2 = (ClanChannelMember)var1.members.get(this.field1389);
		var2.rank = this.field1388;
		var2.world = this.field1390;
		var2.username = new Username(this.field1391);
	}
	...
	static void runScriptLogic(ScriptEvent var0, Script var1, int var2, int var3) {
		...
		label860: {
			label861: {
				try {
					...
					try {
						...
						for (var13 = 1; var13 < var4.length; ++var13) {
							if (var4[var13] instanceof Integer) {
								...
								if (var14 == -2147483645) {
									var14 = var0.widget != null ? var0.widget.id * 41171959 * -749799993 : -1;
								}
								...
								if (var14 == -2147483643) {
									var14 = var0.widget != null ? var0.widget.childIndex * 125148757 * 1641180925 : -1;
								}

								if (var14 == -2147483642) {
									var14 = var0.dragTarget != null ? var0.dragTarget.id * 41171959 * -749799993 : -1;
								}

								if (var14 == -2147483641) {
									var14 = var0.dragTarget != null ? var0.dragTarget.childIndex * 125148757 * 1641180925 : -1;
								}
						...
						Interpreter.field706 = var0.field864;
						...
						while (true) {
							...
							if (var32 >= 100) {
								...
								var14 = ViewportMouse.method1389(var32, var1, var34);
								switch(var14) {
								case 0:
									var29 = false;
									break label841;
								...
								var13 = var7[var5];
								class130.method704(var13, Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
							} else if (var32 == 31) {
								Interpreter.Interpreter_intStackSize -= 2;
								if (Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize] <= Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]) {
									var5 += var7[var5];
								...
								var20 = class316.method1656(Interpreter.Interpreter_stringStack, class180.Interpreter_stringStackSize, var13);
								...
								if (var32 != 40) {
									if (var32 == 42) {
										...
										if (var32 == 47) {
											...
											Integer var38;
											if (var32 == 74) {
												var38 = class295.field2496.getTitleGroupValue(var7[var5]);
												if (var38 == null) {
												...
												var38 = SequenceDefinition.varclan.method2358(var7[var5]);
												if (var38 == null) {
													Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = -1;
												} else {
													Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var38;
					...
					if (var29) {
						while (Interpreter.field713.size() > 0) {
							class104 var19 = (class104)Interpreter.field713.remove(0);
							TextureProvider.widgetDefaultMenuAction(var19.method600(), var19.method601(), var19.method602(), var19.method603(), "");
						}

						if (Interpreter.field701) {
							Interpreter.field701 = false;
							GrandExchangeOfferOwnWorldComparator.method351();
						}

						if (!var9 && var3 > 0 && var10 >= var3) {
							class190.RunException_sendStackTrace("Warning: Script " + var1.field820 + " finished at op count " + var10 + " of max " + var2, (Throwable)null);
						}
				...
				while (Interpreter.field713.size() > 0) {
					class104 var33 = (class104)Interpreter.field713.remove(0);
					TextureProvider.widgetDefaultMenuAction(var33.method600(), var33.method601(), var33.method602(), var33.method603(), "");
				}
			...
			while (Interpreter.field713.size() > 0) {
				class104 var40 = (class104)Interpreter.field713.remove(0);
				TextureProvider.widgetDefaultMenuAction(var40.method600(), var40.method601(), var40.method602(), var40.method603(), "");
			}
		...
		while (Interpreter.field713.size() > 0) {
			class104 var25 = (class104)Interpreter.field713.remove(0);
			TextureProvider.widgetDefaultMenuAction(var25.method600(), var25.method601(), var25.method602(), var25.method603(), "");
		}
	...
	public static final SpritePixels getItemSprite(int var0, int var1, int var2, int var3, int var4, boolean var5) {
		...
		if (var20 == null) {
			...
			float[] var15 = Rasterizer2D.field4244;
			int[] var16 = new int[4];
			Rasterizer2D.Rasterizer2D_getClipArray(var16);
			var8 = new SpritePixels(36, 32);
			Rasterizer3D.method1247(var8.pixels, 36, 32, (float[])null);
			Rasterizer2D.Rasterizer2D_clear();
			Rasterizer3D.method1248();
			Rasterizer3D.method1251(16, 16);
			Rasterizer3D.clips.field2289 = false;
			...
			var20.method1379(0, var9.yan2d, var9.zan2d, var9.xan2d, var9.offsetX2d, var20.height / 2 + var18 + var9.offsetY2d, var19 + var9.offsetY2d);
			if (var9.notedId != -1) {
				var21.drawTransBgAt(0, 0);
			}
			...
			if (var4 == 1 || var4 == 2 && var9.isStackable == 1) {
				class142.ItemDefinition_fontPlain11.draw(class481.method2388(var1), 0, 9, 16776960, 1);
			}
			...
			Rasterizer3D.method1247(var12, var13, var14, var15);
			Rasterizer2D.Rasterizer2D_setClipArray(var16);
			Rasterizer3D.method1248();
			Rasterizer3D.clips.field2289 = true;
			return var8;
		}
	}
}