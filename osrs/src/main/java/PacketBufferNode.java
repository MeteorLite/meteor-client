...
public class PacketBufferNode extends Node {
	...
	public static int method1646(float[] var0, int var1, float var2, boolean var3, float var4, boolean var5, float[] var6) {
		float var7 = 0.0F;
		...
		float var44 = (Math.abs(var2) + Math.abs(var4)) * (float)(var1 + 1) * class128.field1202;
		if (var7 <= var44) {
			return -1;
		} else {
			...
			if (var1 == 0) {
				...
				class467 var41 = new class467(var9, var1);
				...
				int var14 = method1646(var42, var1 - 1, var2, false, var4, false, var43);
				if (var14 == -1) {
					return 0;
				} else {
					boolean var15 = false;
					...
					for (int var20 = 0; var20 <= var14; ++var20) {
						...
						if (var20 == 0) {
							var16 = var2;
							var18 = Frames.method1338(var9, var1, var2);
						...
						var17 = Frames.method1338(var9, var1, var19);
						if (var15) {
							var15 = false;
							...
							float var24 = var16;
							float var25 = var19;
							float var26 = Frames.method1338(var41.field3922, var41.field3923, var16);
							float var23;
							if (Math.abs(var26) < class128.field1202) {
								var23 = var16;
							} else {
								float var27 = Frames.method1338(var41.field3922, var41.field3923, var19);
								if (Math.abs(var27) < class128.field1202) {
									var23 = var19;
								} else {
									float var28 = 0.0F;
									float var29 = 0.0F;
									...
									do {
										...
										float var38 = class128.field1201 * Math.abs(var25) + 0.0F;
										...
										if (var40) {
											if (Math.abs(var30) >= var38 && Math.abs(var26) > Math.abs(var27)) {
												...
												if (var24 == var28) {
													...
													var31 = var34 * ((var32 - var33) * 2.0F * var39 * var32 - (var33 - 1.0F) * (var25 - var24));
												...
												var34 = var30;
												var30 = var29;
												if (var31 * 2.0F < var39 * 3.0F * var32 - Math.abs(var38 * var32) && var31 < Math.abs(var32 * 0.5F * var34)) {
													var29 = var31 / var32;
												} else {
													var29 = var39;
													var30 = var39;
											...
											var27 = Frames.method1338(var41.field3922, var41.field3923, var25);
