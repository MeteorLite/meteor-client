...
public class PacketBufferNode extends Node {
	...
	public static void method1611(int[] var0, int[] var1) {
		if (var0 != null && var1 != null) {
			...
			for (int var2 = 0; var2 < class416.ByteArrayPool_alternativeSizes.length; ++var2) {
				...
				ByteArrayPool.field3746.add(var0[var2]);
			}

			Collections.sort(ByteArrayPool.field3746);
		} else {
	...
	public static int method1609(int var0) {
