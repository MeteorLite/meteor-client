...
public class ArchiveLoader {
	...
	boolean isLoaded() {
		...
		for (int var1 = 0; var1 < this.groupCount; ++var1) {
			if (!this.archive.method1898(var1) || this.archive.method1897(var1)) {
				++this.loadedCount;
			}
		}
	...
	public static Frames method464(AbstractArchive var0, AbstractArchive var1, int var2, boolean var3) {
		boolean var4 = true;
	...
	@ObfuscatedName("au")
	public static final int method463(double var0, double var2, double var4) {
		double var6 = var4;
		double var8 = var4;
		double var10 = var4;
		if (var2 != 0.0D) {
	...
	static class128 method466(int var0) {
		class128 var1 = (class128)KeyHandler.findEnumerated(FileSystem.method912(), var0);
		if (var1 == null) {
			var1 = class128.field1229;
		}
	...
	static final void Widget_setKeyIgnoreHeld(Widget var0, int var1) {
		if (var0.field2977 == null) {
			...
			if (var0.field3055 == null) {
				var0.field3055 = new int[var0.field2977.length];
			}

			var0.field3055[var1] = Integer.MAX_VALUE;
		}
	}
}