...
final class class105 implements class323 {
	...
	public void vmethod5708() {
		if (this.val$cc != null && this.val$cc.method1847().field2899 != null) {
			ScriptEvent var1 = new ScriptEvent();
			var1.method479(this.val$cc);
			var1.setArgs(this.val$cc.method1847().field2899);
	...
	static void drawTitle(Font var0, Font var1, Font var2) {
		...
		if (Login.worldSelectOpen) {
			if (class74.worldSelectBackSprites == null) {
				class74.worldSelectBackSprites = class20.method67(PcmPlayer.archive8, "sl_back", "");
			}

			if (SoundCache.worldSelectFlagSprites == null) {
				SoundCache.worldSelectFlagSprites = class219.method1149(PcmPlayer.archive8, "sl_flags", "");
			}

			if (MusicPatchPcmStream.worldSelectArrows == null) {
				MusicPatchPcmStream.worldSelectArrows = class219.method1149(PcmPlayer.archive8, "sl_arrows", "");
			}

			if (SecureRandomCallable.worldSelectStars == null) {
				SecureRandomCallable.worldSelectStars = class219.method1149(PcmPlayer.archive8, "sl_stars", "");
			}
			...
			if (MusicPatchPcmStream.worldSelectArrows != null) {
				...
				if (World.World_sortOption1[0] == 3 && World.World_sortOption2[0] == 0) {
					MusicPatchPcmStream.worldSelectArrows[2].drawAt(var26, 4);
				} else {
					MusicPatchPcmStream.worldSelectArrows[0].drawAt(var26, 4);
				}

				if (World.World_sortOption1[0] == 3 && World.World_sortOption2[0] == 1) {
					MusicPatchPcmStream.worldSelectArrows[3].drawAt(var26 + 15, 4);
				} else {
					MusicPatchPcmStream.worldSelectArrows[1].drawAt(var26 + 15, 4);
				}
			...
			if (class74.worldSelectBackSprites != null) {
				...
				do {
					var48 = var26;
					var25 = var43;
					if (var26 * (var43 - 1) >= World.World_count) {
						--var43;
					}

					if (var43 * (var26 - 1) >= World.World_count) {
						--var26;
					}
				...
				} while(var48 != var26 || var25 != var43);

				var48 = (765 - var3 * var43) / (var43 + 1);
				if (var48 > 5) {
					var48 = 5;
				}

				var25 = (480 - var39 * var26) / (var26 + 1);
				if (var25 > 5) {
					var25 = 5;
				}

				var9 = (765 - var43 * var3 - var48 * (var43 - 1)) / 2;
				int var29 = (480 - var26 * var39 - var25 * (var26 - 1)) / 2;
				var36 = (var26 + World.World_count - 1) / var26;
				...
				for (var17 = var26 * var40; var17 < World.World_count && var40 - Login.worldSelectPage < var43; ++var17) {
					...
					int var22 = 0;
					if (var32.isBeta()) {
						var21 = var32.isMembersOnly() ? class108.field1133 : class108.field1138;
					} else if (var32.isDeadman()) {
						var21 = var32.isMembersOnly() ? class108.field1124 : class108.field1135;
					} else if (var32.method391()) {
						var22 = 16711680;
						var21 = var32.isMembersOnly() ? class108.field1129 : class108.field1125;
					} else if (var32.method393()) {
						var21 = var32.isMembersOnly() ? class108.field1128 : class108.field1123;
					} else if (var32.isPvp()) {
						var21 = var32.isMembersOnly() ? class108.field1136 : class108.field1132;
					} else if (var32.method394()) {
						var21 = var32.isMembersOnly() ? class108.field1134 : class108.field1126;
					} else if (var32.method395()) {
						var21 = var32.isMembersOnly() ? class108.field1131 : class108.field1130;
					}

					if (var21 == null || var21.field1139 >= class74.worldSelectBackSprites.length) {
						var21 = var32.isMembersOnly() ? class108.field1127 : class108.field1137;
					}
					...
					if (MouseHandler.MouseHandler_x >= var30 && MouseHandler.MouseHandler_y >= var38 && MouseHandler.MouseHandler_x < var30 + var3 && MouseHandler.MouseHandler_y < var38 + var39 && var19) {
						...
						class74.worldSelectBackSprites[var21.field1139].drawTransOverlayAt(var30, var38, 128, 16777215);
						var15 = true;
					} else {
						class74.worldSelectBackSprites[var21.field1139].drawAt(var30, var38);
					}
					...
					var38 = var38 + var39 + var25;
					++var31;
					if (var31 >= var26) {
						var38 = var29 + 23;
						var30 = var30 + var3 + var48;
						var31 = 0;
						++var40;
					}
				}
			...
			if (Client.gameState == 20) {
				...
				if (Login.loginIndex != 4 && Login.loginIndex != 10) {
					...
					for (var5 = class238.method1310(); var0.stringWidth(var5) > var35; var5 = var5.substring(0, var5.length() - 1)) {
					}

					var0.draw(AbstractFont.escapeBrackets(var5), Login.loginBoxX + 180 - 70, var34, 16777215, 0);
					var34 += 15;
					var7 = Login.Login_password;
					var6 = class270.method1538('*', var7.length());
			...
			if (Client.gameState == 10 || Client.gameState == 11 || Client.gameState == 50) {
				...
				if (Login.loginIndex == 0) {
					...
					if (Login.loginIndex == 2) {
						...
						for (var5 = class238.method1310(); var0.stringWidth(var5) > var35; var5 = var5.substring(1)) {
						}

						var0.draw(AbstractFont.escapeBrackets(var5) + (Login.currentLoginField == 0 & Client.cycle % 40 < 20 ? MoveSpeed.colorStartTag(16776960) + "|" : ""), class452.loginBoxCenter - 70, var34, 16777215, 0);
						var34 += 15;
						var7 = Login.Login_password;
						var6 = class270.method1538('*', var7.length());
						...
						var0.draw("Password: " + var8 + (Login.currentLoginField == 1 & Client.cycle % 40 < 20 ? MoveSpeed.colorStartTag(16776960) + "|" : ""), class452.loginBoxCenter - 108, var34, 16777215, 0);
						var34 += 15;
						var33 = 277;
						var9 = class452.loginBoxCenter + -117;
						boolean var11 = Client.Login_isUsernameRemembered;
						boolean var12 = Login.field745;
						var10 = var11 ? (var12 ? VerticalAlignment.field1631 : UserComparator6.options_buttons_2Sprite) : (var12 ? Skills.field3145 : Login.options_buttons_0Sprite);
						...
						var15 = class449.clientPreferences.getIsUsernameHidden();
						boolean var16 = Login.field744;
						IndexedSprite var14 = var15 ? (var16 ? VerticalAlignment.field1631 : UserComparator6.options_buttons_2Sprite) : (var16 ? Skills.field3145 : Login.options_buttons_0Sprite);
						...
						case 2:
							class151.field1365 = "Having trouble logging in?";
							break;
						default:
							class151.field1365 = "Can't login? Click here.";
						}

						class102.field1090 = new Bounds(class452.loginBoxCenter, var33, var1.stringWidth(class151.field1365), 11);
						class90.field887 = new Bounds(class452.loginBoxCenter, var33, var1.stringWidth("Still having trouble logging in?"), 11);
						var1.drawCentered(class151.field1365, class452.loginBoxCenter, var33, 16777215, 0);
						...
						var7 = class369.otp;
						var6 = class270.method1538('*', var7.length());
						var0.draw(var5 + var6 + (Client.cycle % 40 < 20 ? MoveSpeed.colorStartTag(16776960) + "|" : ""), Login.loginBoxX + 180 - 108, var34, 16777215, 0);
						var34 -= 8;
						...
						var25 = Login.loginBoxX + 180 - 9 + var0.stringWidth("for 30 days: ") + 15;
						...
						var0.draw(AbstractFont.escapeBrackets(var5) + (Client.cycle % 40 < 20 ? MoveSpeed.colorStartTag(16776960) + "|" : ""), Login.loginBoxX + 180 - 34, var34, 16777215, 0);
						var34 += 15;
						var26 = Login.loginBoxX + 180 - 80;
						short var27 = 321;
						class219.titlebuttonSprite.drawAt(var26 - 73, var27 - 20);
						var0.drawCentered("Recover", var26, var27 + 5, 16777215, 0);
						var26 = Login.loginBoxX + 180 + 80;
						class219.titlebuttonSprite.drawAt(var26 - 73, var27 - 20);
						var0.drawCentered("Back", var26, var27 + 5, 16777215, 0);
						var27 = 356;
						var1.drawCentered("Still having trouble logging in?", class452.loginBoxCenter, var27, 268435455, 0);
						...
						if (ModeWhere.field3613 && !Client.onMobile) {
							...
							for (var43 = 0; var43 < 8; ++var43) {
								class219.titlebuttonSprite.method2654(var4, var34, 30, 40);
								boolean var45 = var43 == Login.field752 & Client.cycle % 40 < 20;
								var0.draw((Login.field768[var43] == null ? "" : Login.field768[var43]) + (var45 ? MoveSpeed.colorStartTag(16776960) + "|" : ""), var4 + 10, var34 + 27, 16777215, 0);
								if (var43 != 1 && var43 != 3) {
									var4 += 35;
								} else {
									var4 += 50;
							...
							short var46 = 321;
							class219.titlebuttonSprite.drawAt(var43 - 73, var46 - 20);
							var0.drawCentered("Submit", var43, var46 + 5, 16777215, 0);
							var43 = class452.loginBoxCenter + 80;
							class219.titlebuttonSprite.drawAt(var43 - 73, var46 - 20);
							var0.drawCentered("Cancel", var43, var46 + 5, 16777215, 0);
						} else {
							var33 = 216;
						...
						var4 = var35 + 20;
						Login.field777.drawAt(var34 - 109, var4);
						if (Login.field764.isEmpty()) {
							ItemContainer.field853.drawAt(var34 - 48, var4 + 18);
						} else {
							ItemContainer.field853.drawAt(var34 - 48, var4 + 5);
							var0.drawCentered(Login.field764, var34, var4 + 68 - 15, 16776960, 0);
						}
						...
						short var44 = 276;
						class219.titlebuttonSprite.drawAt(var48 - 73, var44 - 20);
						if (Login.field750 == 1) {
							var0.drawCentered("Recover Account", var48, var44 + 5, 16777215, 0);
						} else {
							var0.drawCentered("View Appeal Options", var48, var44 + 5, 16777215, 0);
						}

						var48 = Login.loginBoxX + 180;
						var44 = 326;
						class219.titlebuttonSprite.drawAt(var48 - 73, var44 - 20);
						var0.drawCentered("Back", var48, var44 + 5, 16777215, 0);
			...
			if (Client.gameState >= 10) {
				...
				class139.field1323.draw(Login.xPadding - 22, Client.cycle);
				class139.field1323.draw(Login.xPadding + 22 + 765 - 128, Client.cycle);
				Rasterizer2D.Rasterizer2D_setClipArray(var28);
			}

			class13.title_muteSprite[class449.clientPreferences.getTitleMusicDisabled() ? 1 : 0].drawAt(Login.xPadding + 765 - 40, 463);
			if (Client.gameState > 5 && Language.Language_EN == ClanChannelMember.clientLanguage) {
				if (VarcInt.field1534 != null) {
					var34 = Login.xPadding + 5;
					var35 = 463;
					byte var49 = 100;
					byte var47 = 35;
					VarcInt.field1534.drawAt(var34, var35);
					var0.drawCentered("World" + " " + Client.worldId, var49 / 2 + var34, var47 / 2 + var35 - 2, 16777215, 0);
					if (WorldMapLabelSize.World_request != null) {
						var1.drawCentered("Loading...", var49 / 2 + var34, var47 / 2 + var35 + 12, 16777215, 0);
					} else {
						var1.drawCentered("Click to switch", var49 / 2 + var34, var47 / 2 + var35 + 12, 16777215, 0);
					}
				} else {
					VarcInt.field1534 = class172.SpriteBuffer_getIndexedSpriteByName(PcmPlayer.archive8, "sl_button", "");
				}
			}
	...
	static void method615() {
		...
		Client.packetWriter.field1159 = null;
		Client.packetWriter.field1157 = null;
		Client.packetWriter.field1158 = null;
		Client.packetWriter.serverPacketLength = 0;
		Client.packetWriter.field1154 = 0;
