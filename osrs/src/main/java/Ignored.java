...
public class Ignored extends User {
   ...
   static final int method2123(long var0, String var2) {
      ...
      var4.encryptRsa(class68.field727, class68.field726);
      var5.writeByte(10);
      ...
      UserComparator3.method656(var5);
      var5.writeLong(var3.nextLong());
      var5.encryptRsa(class68.field727, class68.field726);
      ...
      for(int var15 = 0; var15 < var13 + 0; var15 += 3) {
         ...
         var14.append(class363.field3571[var16 >>> 2]);
         if (var15 < var13 - 1) {
            var17 = var11[var15 + 1] & 255;
            var14.append(class363.field3571[(var16 & 3) << 4 | var17 >>> 4]);
            if (var15 < var13 - 2) {
               int var18 = var11[var15 + 2] & 255;
               var14.append(class363.field3571[(var17 & 15) << 2 | var18 >>> 6]).append(class363.field3571[var18 & 63]);
            } else {
               var14.append(class363.field3571[(var17 & 15) << 2]).append("=");
            }
         } else {
            var14.append(class363.field3571[(var16 & 3) << 4]).append("==");
         }
      }
      ...
      try {
         URL var19 = new URL(class310.method1760("services", false) + "m=accountappeal/login.ws");
         ...
         var20.write("data2=" + GameObject.method1310(var12) + "&dest=" + GameObject.method1310("passwordchoice.ws"));
         var20.flush();
    ...
    public static DbRowType getDbRowType(int var0) {
      ...
      if (var1 != null) {
         ...
         byte[] var2 = DbRowType.field3995.takeFile(38, var0);
         var1 = new DbRowType();
         if (var2 != null) {
            var1.method2352(new Buffer(var2));
         }
