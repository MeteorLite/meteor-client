...
public class GrandExchangeOfferOwnWorldComparator implements Comparator {
	...
	static final void setViewportShape(int var0, int var1, int var2, int var3, boolean var4) {
		...
		if (var5 < 0) {
			...
			var6 = (Client.field640 - Client.field638) * var5 / 100 + Client.field638;
		}
		...
		int var9;
		short var17;
		if (var7 < Client.field641) {
			var17 = Client.field641;
			var6 = var17 * var2 * 334 / (var3 * 512);
			if (var6 > Client.field634) {
		...
		if (var2 != Client.viewportWidth || var3 != Client.viewportHeight) {
			...
			for (var9 = 0; var9 < var16.length; ++var9) {
				...
				int var11 = class172.method907(var10);
