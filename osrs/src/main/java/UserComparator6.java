...
public class UserComparator6 extends AbstractUserComparator {
	...
	static boolean method694() {
		Date var0;
		try {
			var0 = SpotAnimationDefinition.method1003();
		} catch (ParseException var6) {
			WorldMapScaleHandler.method1587("Date not valid.", "Please ensure date follows the format", "DD/MM/YYYY and is after 01/01/1900");
			return false;
		}
		...
		if (var0 == null) {
			...
			boolean var4 = ModelData0.method1383(var0);
			Date var3 = class312.method1686();
			...
			if (!var2) {
				...
				if (!var4) {
					class72.field730 = 8388607;
				} else {
					class72.field730 = (int)(var0.getTime() / 86400000L - 11745L);
				}
