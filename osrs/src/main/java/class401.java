	...
	static final void checkIfMinimapClicked(Widget var0, int var1, int var2) {
		if (Client.minimapState == 0 || Client.minimapState == 3) {
			if (!Client.isMenuOpen && (MouseHandler.MouseHandler_lastButton == 1 || !UserComparator8.mouseCam && MouseHandler.MouseHandler_lastButton == 4)) {
				SpriteMask var3 = var0.method1857(class33.widgetDefinition, true);
				if (var3 == null) {
					return;
				}
				...
				if (var3.contains(var4, var5)) {
					...
					PacketBufferNode var13 = ClanChannelMember.getPacketBufferNode(ClientPacket.f51, Client.packetWriter.isaacCipher);
					var13.packetBuffer.writeByte(18);
					var13.packetBuffer.writeShortAdd(var12 + class19.baseY);
					var13.packetBuffer.writeByte(Client.keyHandlerInstance.getKeyPressed(82) ? (Client.keyHandlerInstance.getKeyPressed(81) ? 2 : 1) : 0);
					var13.packetBuffer.writeShortAdd(var11 + class20.baseX);
