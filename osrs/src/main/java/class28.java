...
public class class28 {
	...
	public class28() {
		this.field147 = new int[112];
		this.field150 = new int[192];
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			if (var29 != 100) {
				...
				class174.spriteIds = new GraphicsDefaults();
				class174.spriteIds.decode(class382.archive17);
