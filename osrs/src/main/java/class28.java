...
public class class28 {
   ...
   static void method121(boolean var0) {
      byte var1 = 0;
      boolean var2 = WorldMapSectionType.clientPreferences.method537() >= Client.param21;
      if (!var2) {
         var1 = 12;
      } else if (class392.client.method349() || class392.client.method374() || class392.client.method350()) {
         var1 = 10;
      }

      class14.method52(var1);
      if (var0) {
   ...
   static void method123(int var0, int var1) {
      ...
      for(int var3 = 0; var3 < var2.length; ++var3) {
         ...
         int var6 = Occluder.method1251(var5, var1);
