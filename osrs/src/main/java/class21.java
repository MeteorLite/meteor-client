...
public class class21 {
	...
	static final void method297(PacketBuffer var0) {
		for (int var1 = 0; var1 < Players.Players_pendingUpdateCount; ++var1) {
			...
			int var14;
			if ((var4 & 8) != 0) {
				var6 = var0.method8484();
				if (var6 == 65535) {
					var6 = -1;
				}

				var14 = var0.method8435();
				FontName.performPlayerAnimation(var3, var6, var14);
			}

			if ((var4 & 2048) != 0) {
				var3.field1197 = Client.cycle + var0.method8444();
				var3.field1198 = Client.cycle + var0.method8446();
				var3.field1199 = var0.readByte();
				var3.field1200 = var0.method8617();
				var3.field1185 = var0.readByte();
				var3.field1202 = (byte)var0.method8623();
			}
			...
			if ((var4 & 16384) != 0) {
				var3.field1150 = var0.method8469();
				var3.field1190 = var0.method8617();
				var3.field1189 = var0.method8617();
				var3.field1188 = var0.method8469();
				var3.field1192 = var0.method8446() + Client.cycle;
				var3.field1193 = var0.method8444() + Client.cycle;
			...
			if ((var4 & 8192) != 0) {
				var3.spotAnimation = var0.method8446();
				var6 = var0.method8458();
				var3.field1159 = var6 >> 16;
				var3.field1186 = (var6 & 65535) + Client.cycle;
			...
			if ((var4 & 128) != 0) {
				var6 = var0.method8484();
				PlayerType var18 = (PlayerType)WallDecoration.findEnumerated(class303.PlayerType_values(), var0.method8435());
				boolean var20 = var0.method8623() == 1;
				var9 = var0.method8436();
				var10 = var0.offset;
				if (var3.username != null && var3.appearance != null) {
					...
					if (!var19 && Client.field687 == 0 && !var3.isHidden) {
						...
						var0.method8477(Players.field1325.array, 0, var9);
						Players.field1325.offset = 0;
			...
			if ((var4 & 1024) != 0) {
				Players.field1314[var2] = (class202)WallDecoration.findEnumerated(BufferedSink.method7548(), var0.method8440());
			}
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		for (var12 = 0; var12 < 5; ++var12) {
			if (Client.field556[var12]) {
				var13 = (int)(Math.random() * (double)(Client.field760[var12] * 2 + 1) - (double)Client.field760[var12] + Math.sin((double)Client.field762[var12] / 100.0D * (double)Client.field763[var12]) * (double)Client.field665[var12]);
				if (var12 == 0) {
		...
		if (Client.isLoading) {
			byte var16 = 0;
			int var18 = var16 + NetCache.NetCache_pendingPriorityResponsesCount + NetCache.NetCache_pendingPriorityWritesCount;
			if (var18 == 0) {
