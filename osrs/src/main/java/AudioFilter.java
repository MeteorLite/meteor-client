...
public class AudioFilter {
   ...
   int compute(int var1, float var2) {
      ...
      if (var1 == 0) {
         ...
         var3 *= 0.0030517578F;
         field448 = (float)Math.pow(0.1D, (double)(var3 / 20.0F));
      ...
      if (this.pairs[var1] == 0) {
         ...
         for(var4 = 1; var4 < this.pairs[var1]; ++var4) {
            ...
            for(int var7 = var4 * 2 - 1; var7 >= 2; --var7) {
               field445[var1][var7] += field445[var1][var7 - 1] * var5 + field445[var1][var7 - 2] * var6;
            }

            field445[var1][1] += field445[var1][0] * var5 + var6;
            field445[var1][0] += var5;
         }

         if (var1 == 0) {
            for(var4 = 0; var4 < this.pairs[0] * 2; ++var4) {
               field445[0][var4] *= field448;
            }
         }
