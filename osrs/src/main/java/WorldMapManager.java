...
public final class WorldMapManager {
	...
	public void method1264(AbstractArchive var1, String var2, boolean var3, boolean var4) {
		if (!this.field1987) {
			this.loaded = false;
			this.field1987 = true;
			System.nanoTime();
			int var5 = var1.getGroupId(WorldMapCacheName.field2095.name);
			int var6 = var1.getFileId(var5, var2);
			Buffer var7 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field2095.name, var2));
			Buffer var8 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field2093.name, var2));
			System.nanoTime();
			System.nanoTime();
			this.mapAreaData = new WorldMapAreaData();

			try {
				this.mapAreaData.method1363(var7, var8, var6, var3, var4);
			...
			Iterator var11 = this.mapAreaData.field2100.iterator();
			...
			while (var11.hasNext()) {
				...
				this.regions[var15][var16] = new WorldMapRegion(var13, var14, this.mapAreaData.method1218(), this.fonts);
			...
			for (int var18 = 0; var18 < var17; ++var18) {
				for (int var19 = 0; var19 < var10; ++var19) {
					if (this.regions[var18][var19] == null) {
						this.regions[var18][var19] = new WorldMapRegion(this.mapAreaData.getRegionLowX() + var18, this.mapAreaData.getRegionLowY() + var19, this.mapAreaData.method1218(), this.fonts);
						this.regions[var18][var19].initWorldMapData1(this.mapAreaData.field2101, this.mapAreaData.iconList);
					}
				}
			}
			...
			System.nanoTime();
			System.nanoTime();
			if (var1.isValidFileName(WorldMapCacheName.field2094.name, var2)) {
				byte[] var21 = var1.takeFileByNames(WorldMapCacheName.field2094.name, var2);
				this.compositeTextureSprite = WorldMapArchiveLoader.method2391(var21);
			}
	...
	public final void drawTiles(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		float[] var12 = Rasterizer2D.field4245;
		int[] var13 = new int[4];
		...
		Rasterizer3D.method1426(var9, var10, var11, var12);
		...
		for (int var22 = var14.x; var22 < var14.x + var14.width; ++var22) {
			for (int var23 = var14.y; var23 < var14.y + var14.height; ++var23) {
				this.regions[var22][var23].method1230(var5 + (this.regions[var22][var23].regionX * 64 - var20) * var19 / 64, var8 - (this.regions[var22][var23].regionY * 64 - var21 + 64) * var19 / 64, var19);
			}
		}
	...
	public final void drawElements(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, HashSet var9, HashSet var10, int var11, int var12, boolean var13) {
		...
		for (var19 = var14.x; var19 < var14.x + var14.width; ++var19) {
			for (var20 = var14.y; var20 < var14.height + var14.y; ++var20) {
				...
				this.regions[var19][var20].method1240(var5 + (this.regions[var19][var20].regionX * 64 - var17) * var16 / 64, var8 - (this.regions[var19][var20].regionY * 64 - var18 + 64) * var16 / 64, var16, var9);
			}
		}
	...
	public List method1270(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
		...
		if (!this.loaded) {
			...
			for (int var17 = var12.x; var17 < var12.x + var12.width; ++var17) {
				for (int var18 = var12.y; var18 < var12.height + var12.y; ++var18) {
					List var19 = this.regions[var17][var18].method1261(var5 + (this.regions[var17][var18].regionX * 64 - var15) * var14 / 64, var8 + var6 - (this.regions[var17][var18].regionY * 64 - var16 + 64) * var14 / 64, var14, var9, var10);
					if (!var19.isEmpty()) {
						var11.addAll(var19);
					}
				}
	...
	public int method1273() {
		return this.mapAreaData.method1219();
	}
	...
	public static void method1265(int var0, int var1) {
		EnumComposition.method925(var0, var1, 0, 0);
		...
		if (class316.musicSongs.isEmpty() || var0 == 0 && var1 == 0) {
			...
			class316.field2798.add(new DelayFadeTask((SongTask)null, class316.musicPlayerStatus));
			class316.field2798.add(new FadeOutTask((SongTask)null, 0, false, class316.field2794));
			...
			class316.field2798.add(new class413((SongTask)null, var3));
		}
	...
	protected static final void method1277() {
