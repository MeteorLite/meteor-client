...
public final class WorldMapManager {
   ...
   public WorldMapManager(IndexedSprite[] var1, HashMap var2, AbstractArchive var3, AbstractArchive var4) {
    ...
    public void load(AbstractArchive var1, String var2, boolean var3) {
      if (!this.loadStarted) {
         ...
         System.nanoTime();
         int var4 = var1.getGroupId(WorldMapCacheName.field2395.name);
         int var5 = var1.getFileId(var4, var2);
         Buffer var6 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field2395.name, var2));
         Buffer var7 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field2398.name, var2));
         System.nanoTime();
         System.nanoTime();
         ...
         System.nanoTime();
         System.nanoTime();
         if (var1.isValidFileName(WorldMapCacheName.field2394.name, var2)) {
            byte[] var20 = var1.takeFileByNames(WorldMapCacheName.field2394.name, var2);
            this.compositeTextureSprite = class266.method1505(var20);
         }
    ...
    public final void drawTiles(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      ...
      for(int var21 = var13.x; var21 < var13.x + var13.width; ++var21) {
         for(int var22 = var13.y; var22 < var13.height + var13.y; ++var22) {
            this.regions[var21][var22].method1390(var5 + (this.regions[var21][var22].regionX * 64 - var19) * var18 / 64, var8 - (this.regions[var21][var22].regionY * 64 - var20 + 64) * var18 / 64, var18);
         }
      }
    ...
    public final void drawElements(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, HashSet var9, HashSet var10, int var11, int var12, boolean var13) {
      ...
      for(var19 = var14.x; var19 < var14.x + var14.width; ++var19) {
         for(var20 = var14.y; var20 < var14.y + var14.height; ++var20) {
            ...
            this.regions[var19][var20].method1362(var5 + (this.regions[var19][var20].regionX * 64 - var17) * var16 / 64, var8 - (this.regions[var19][var20].regionY * 64 - var18 + 64) * var16 / 64, var16, var9);
         }
      }
   ...
   public List method1394(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      ...
      if (!this.loaded) {
         ...
         for(int var17 = var12.x; var17 < var12.x + var12.width; ++var17) {
            for(int var18 = var12.y; var18 < var12.y + var12.height; ++var18) {
               List var19 = this.regions[var17][var18].method1375(var5 + (this.regions[var17][var18].regionX * 64 - var15) * var14 / 64, var8 + var6 - (this.regions[var17][var18].regionY * 64 - var16 + 64) * var14 / 64, var14, var9, var10);
               if (!var19.isEmpty()) {
                  var11.addAll(var19);
               }
            }
   ...
   static int method1405(int var0, Script var1, boolean var2) {
   ...
   static final void method1404() {
      if (Client.logoutTimer > 0) {
         HealthBarDefinition.logOut();
      } else {
         Client.timer.method2021();
         class246.updateGameState(40);
         WorldMapLabelSize.field2235 = Client.packetWriter.getSocket();
    ...
    public static final void insertMenuItemNoShift(String var0, String var1, int var2, int var3, int var4, int var5) {
      class290.insertMenuItem(var0, var1, var2, var3, var4, var5, -1, false);
   }
}
