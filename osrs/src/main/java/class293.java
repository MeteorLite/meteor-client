...
public class class293 {
   ...
   public static double[] method1558(double var0, double var2, int var4) {
      int var5 = var4 * 2 + 1;
   ...
   public static final SpritePixels getItemSprite(int var0, int var1, int var2, int var3, int var4, boolean var5) {
      ...
      if (var19 == null) {
         ...
         var19.method1288(0, var9.yan2d, var9.zan2d, var9.xan2d, var9.offsetX2d, var19.height / 2 + var17 + var9.offsetY2d, var18 + var9.offsetY2d);
         if (var9.notedId != -1) {
            var20.drawTransBgAt(0, 0);
         }
         ...
         if (var4 == 1 || var4 == 2 && var9.isStackable == 1) {
            ItemComposition.ItemDefinition_fontPlain11.draw(class290.method1556(var1), 0, 9, 16776960, 1);
         }
