...
public class class178 {
	...
	static IndexedSprite[] field1459;
	@ObfuscatedName("ac")
	@ObfuscatedSignature(
		descriptor = "Leq;"
	)
	...
	static final int method924(long var0, String var2) {
		...
		var4.encryptRsa(class74.field730, class74.field729);
		var5.writeByte(10);
		...
		if (Client.randomDatData != null) {
			...
			byte[] var16 = class131.method706();
			var5.writeBytes(var16, 0, var16.length);
		}

		var5.writeLong(var3.nextLong());
		var5.encryptRsa(class74.field730, class74.field729);
		...
		String var10 = class233.method1199(var9.array);

		try {
			URL var11 = new URL(ScriptEvent.method474("services", false) + "m=accountappeal/login.ws");
			...
			var13.write("data2=" + Timer.method2181(var10) + "&dest=" + Timer.method2181("passwordchoice.ws"));
			var13.flush();
			...
			do {
				...
				if (var15 == -1) {
					...
					if (var17.startsWith("OFFLINE")) {
						...
						if (ItemComposition.method1092(var17)) {
	...
	static final void method926(int var0) {
		if (class33.field89.method1742(var0)) {
			class174.drawModelComponents(class33.field89.Widget_interfaceComponents[var0], -1);
		}
	}
}