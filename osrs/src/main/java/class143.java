...
public class class143 {
   ...
   IterableNodeDeque field1304 = new IterableNodeDeque();
   ...
   void method758(Buffer var1) {
      this.field1305 = var1.readLong();
      this.field1303 = var1.readInt();
      ...
      for(int var2 = var1.readUnsignedByte(); var2 != 0; var2 = var1.readUnsignedByte()) {
         ...
         ((class140)var3).vmethod3254(var1);
         this.field1304.addFirst((Node)var3);
      }
   ...
   public void method759(ClanSettings var1) {
      if (var1.field1337 == this.field1305 && this.field1303 == var1.field1357) {
         for(class140 var2 = (class140)this.field1304.last(); var2 != null; var2 = (class140)this.field1304.previous()) {
