...
public class class81 {
   ...
   static boolean method483(Date var0) {
    ...
    static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
         ...
         if (var8 != 0L) {
            ...
            if (var1 == 0) {
               ...
               if (var14.interactType != 0) {
                  Client.collisionMaps[var0].method1167(var2, var3, var16, var17, var14.boolean1);
               }
            }
            ...
            if (var1 == 3) {
               ...
               if (var14.interactType == 1) {
                  Client.collisionMaps[var0].method1169(var2, var3);
               }
            }
         }
         ...
         if (var4 >= 0) {
            ...
            class165.method923(var0, var13, var2, var3, var4, var5, var6, var7, class31.scene, Client.collisionMaps[var0]);
         }
      }
   ...
   static boolean method485(int var0) {
      for(int var1 = 0; var1 < Client.field355; ++var1) {
         if (Client.field424[var1] == var0) {
            return true;
         }
      }
