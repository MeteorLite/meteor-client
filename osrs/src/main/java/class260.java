...
public class class260 {
   ...
   static float[] method1465(JSONObject var0, String var1) throws JSONException {
            ...
            if (var4.isInteractable) {
               if (!var4.isFollower || Client.followerIndex == var1) {
                  ...
                  if (var4.combatLevel != 0 && var0.combatLevelChange != 0) {
                     var6 = var0.combatLevelChange != -1 ? var0.combatLevelChange * 1290268989 * 1738894869 : var4.combatLevel * -1896830679 * 283378457;
                     var5 = var5 + NPC.method571(var6, BuddyRankComparator.localPlayer.combatLevel) + " " + " (" + "level-" + var6 + ")";
                  }
                  ...
                  if (Client.isItemSelected == 1) {
                     class110.insertMenuItemNoShift("Use", Client.field513 + " " + "->" + " " + Canvas.colorStartTag(16776960) + var5, 7, var1, var2, var3);
                  } else if (Client.isSpellSelected) {
                     if ((class90.selectedSpellFlags & 2) == 2) {
                        class110.insertMenuItemNoShift(Client.field583, Client.field518 + " " + "->" + " " + Canvas.colorStartTag(16776960) + var5, 8, var1, var2, var3);
                     }
                  } else {
                     ...
                     if (var7 != null) {
                        for(var8 = 4; var8 >= 0; --var8) {
                           if (var0.method559(var8) && var7[var8] != null && !var7[var8].equalsIgnoreCase("Attack")) {
                              var9 = 0;
                              if (var8 == 0) {
                                 var9 = var6 + 9;
                              }
