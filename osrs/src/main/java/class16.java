...
public class class16 implements ThreadFactory {
	...
	public Thread newThread(Runnable var1) {
		Thread var2 = new Thread(this.field48, var1, this.this$0.field41 + "-rest-request-" + this.field49.getAndIncrement(), 0L);
		var2.setDaemon(true);
		var2.setPriority(5);
		return var2;
	}
	...
	public static final void method53(int var0, int var1) {
			...
			if (var4 != null) {
				if (var4.isInteractable) {
					if (!var4.isFollower || Client.followerIndex == var1) {
						String var5 = var0.method582();
						int var6;
						if (var4.combatLevel != 0 && var0.combatLevelChange != 0) {
							var6 = var0.combatLevelChange != -1 ? var0.combatLevelChange * -537106585 * -893205417 : var4.combatLevel * -1524379573 * 1597602147;
							var5 = var5 + WidgetDefinition.method1745(var6, TextureProvider.localPlayer.combatLevel) + " " + " (" + "level-" + var6 + ")";
						}
						...
						if (Client.isItemSelected == 1) {
							class153.insertMenuItemNoShift("Use", Client.field598 + " " + "->" + " " + Client.colorStartTag(16776960) + var5, 7, var1, var2, var3);
						} else if (Client.isSpellSelected) {
							if ((class31.field82 & 2) == 2) {
								class153.insertMenuItemNoShift(Client.field599, Client.field600 + " " + "->" + " " + Client.colorStartTag(16776960) + var5, 8, var1, var2, var3);
							}
						} else {
