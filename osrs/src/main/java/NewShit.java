...
public class NewShit {
	...
	static Script newScript(byte[] var0) {
		...
		if (var6 > 0) {
			...
			for (var7 = 0; var7 < var6; ++var7) {
				...
				IterableNodeHashTable var9 = new IterableNodeHashTable(var8 > 0 ? class184.method927(var8) : 1);
	...
	static void method936(byte[] var0, int var1) {
		if (Client.randomDatData == null) {
			Client.randomDatData = new byte[24];
		}

		class421.writeRandomDat(var0, var1, Client.randomDatData, 0, 24);
	}
}