...
public class class481 {
	...
	static Bounds field3945;

	static {
		field3943 = new int[32768];

		for (int var0 = 0; var0 < 32768; ++var0) {
			field3943[var0] = method2386(var0);
		}

		if (field3942 == null) {
			field3942 = new int[65536];
	...
	static final int method2386(int var0) {
	...
	public static int method2387(int var0) {
		return 255 - (var0 & 255);
	}
	...
	static final void method2389(Scene var0, CollisionMap[] var1) {
		int var2;
		int var3;
		int var4;
		int var5;
		...
		int var18;
		for (var2 = 0; var2 < 4; ++var2) {
			byte[][] var45 = Tiles.field835[var2];
			boolean var54 = true;
			boolean var55 = true;
			boolean var6 = true;
			boolean var7 = true;
			...
			for (var11 = 1; var11 < 103; ++var11) {
				for (var12 = 1; var12 < 103; ++var12) {
					...
					int var20 = (var45[var12][var11 + 1] >> 3) + (var45[var12 - 1][var11] >> 2) + (var45[var12][var11 - 1] >> 2) + (var45[var12 + 1][var11] >> 3) + (var45[var12][var11] >> 1);
					class158.field1387[var12][var11] = var19 - var20;
				}
			}
			...
			for (var11 = -5; var11 < 109; ++var11) {
				for (var12 = 0; var12 < 104; ++var12) {
					...
					if (var13 >= 0 && var13 < 104) {
						...
						if (var17 > 0) {
							FloorUnderlayDefinition var48 = KitDefinition.method979(var17 - 1);
							...
							var10002 = Script.field812[var12]++;
						}
					}
					...
					if (var14 >= 0 && var14 < 104) {
						...
						if (var18 > 0) {
							FloorUnderlayDefinition var51 = KitDefinition.method979(var18 - 1);
							var10000 = SecureRandomFuture.Tiles_hue;
					...
					for (var17 = -5; var17 < 109; ++var17) {
						...
						if (var17 >= 1 && var17 < 103 && (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var11][var17] & 2) != 0 || (Tiles.Tiles_renderFlags[var2][var11][var17] & 16) == 0)) {
							...
							if (var23 > 0 || var24 > 0) {
								...
								int var29 = class158.field1387[var11][var17];
								int var30 = class158.field1387[var11 + 1][var17];
								int var31 = class158.field1387[var11 + 1][var17 + 1];
								int var32 = class158.field1387[var11][var17 + 1];
								int var33 = -1;
								int var34 = -1;
								int var35;
								int var36;
								if (var23 > 0) {
									...
									var33 = EnumComposition.method1001(var35, var36, var37);
									...
									var34 = EnumComposition.method1001(var35, var36, var37);
								}
								...
								if (var2 > 0) {
									...
									if (var24 > 0 && !class4.method4(var24 - 1).hideUnderlay) {
										var60 = false;
									}

									if (var60 && var25 == var26 && var25 == var27 && var25 == var28) {
										var10000 = UserComparator6.field1191[var2][var11];
										var10000[var17] |= 2340;
									}
								}
								...
								var35 = 0;
								if (var34 != -1) {
									var35 = Rasterizer3D.Rasterizer3D_colorPalette[ScriptEvent.method472(var34, 96)];
								}

								if (var24 == 0) {
									var0.addTile(var2, var11, var17, 0, 0, -1, var25, var26, var27, var28, ScriptEvent.method472(var33, var29), ScriptEvent.method472(var33, var30), ScriptEvent.method472(var33, var31), ScriptEvent.method472(var33, var32), 0, 0, 0, 0, var35, 0);
								} else {
									var36 = SecureRandomFuture.Tiles_shapes[var2][var11][var17] + 1;
									byte var61 = class199.field1563[var2][var11][var17];
									FloorOverlayDefinition var38 = class4.method4(var24 - 1);
									...
									if (var39 >= 0) {
										...
										var40 = EnumComposition.method1001(var38.hue, var38.saturation, var38.lightness);
										...
										var41 = EnumComposition.method1001(var42, var38.saturation, var43);
									}

									var42 = 0;
									if (var41 != -2) {
										var42 = Rasterizer3D.Rasterizer3D_colorPalette[FloorUnderlayDefinition.method1044(var41, 96)];
									}
									...
									if (var38.secondaryRgb != -1) {
										...
										var41 = EnumComposition.method1001(var43, var38.secondarySaturation, var44);
										var42 = Rasterizer3D.Rasterizer3D_colorPalette[FloorUnderlayDefinition.method1044(var41, 96)];
									}

									var0.addTile(var2, var11, var17, var36, var61, var39, var25, var26, var27, var28, ScriptEvent.method472(var33, var29), ScriptEvent.method472(var33, var30), ScriptEvent.method472(var33, var31), ScriptEvent.method472(var33, var32), FloorUnderlayDefinition.method1044(var40, var29), FloorUnderlayDefinition.method1044(var40, var30), FloorUnderlayDefinition.method1044(var40, var31), FloorUnderlayDefinition.method1044(var40, var32), var35, var42);
								}
							}
						}
					}
			...
			for (var11 = 1; var11 < 103; ++var11) {
				for (var12 = 1; var12 < 103; ++var12) {
					var0.setTileMinPlane(var2, var12, var11, WorldMapLabel.method1570(var2, var12, var11));
				}
			}
			...
			class199.field1563[var2] = null;
			Tiles.field835[var2] = null;
		}

		var0.method1308(-50, -10, -50);
			...
			for (int var56 = 0; var56 <= var5; ++var56) {
				for (int var57 = 0; var57 <= 104; ++var57) {
					for (int var58 = 0; var58 <= 104; ++var58) {
						short var59;
						if ((UserComparator6.field1191[var56][var58][var57] & var2) != 0) {
							var9 = var57;
							var10 = var57;
							var11 = var56;

							for (var12 = var56; var9 > 0 && (UserComparator6.field1191[var56][var58][var9 - 1] & var2) != 0; --var9) {
							}

							while (var10 < 104 && (UserComparator6.field1191[var56][var58][var10 + 1] & var2) != 0) {
								++var10;
							}
							...
							while (var11 > 0) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((UserComparator6.field1191[var11 - 1][var58][var13] & var2) == 0) {
										break label335;
									}
								}
							...
							while (var12 < var5) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((UserComparator6.field1191[var12 + 1][var58][var13] & var2) == 0) {
										break label324;
									}
								}
							...
							if (var13 >= 8) {
								...
								for (var17 = var11; var17 <= var12; ++var17) {
									for (var18 = var9; var18 <= var10; ++var18) {
										var10000 = UserComparator6.field1191[var17][var58];
										var10000[var18] &= ~var2;
									}
								}
							}
						...
						if ((UserComparator6.field1191[var56][var58][var57] & var3) != 0) {
							var9 = var58;
							var10 = var58;
							var11 = var56;

							for (var12 = var56; var9 > 0 && (UserComparator6.field1191[var56][var9 - 1][var57] & var3) != 0; --var9) {
							}

							while (var10 < 104 && (UserComparator6.field1191[var56][var10 + 1][var57] & var3) != 0) {
								++var10;
							}
							...
							while (var11 > 0) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((UserComparator6.field1191[var11 - 1][var13][var57] & var3) == 0) {
										break label388;
									}
								}
							...
							while (var12 < var5) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((UserComparator6.field1191[var12 + 1][var13][var57] & var3) == 0) {
										break label377;
									}
								}
							...
							if (var13 >= 8) {
								...
								for (var17 = var11; var17 <= var12; ++var17) {
									for (var18 = var9; var18 <= var10; ++var18) {
										var10000 = UserComparator6.field1191[var17][var18];
										var10000[var57] &= ~var3;
									}
								}
							}
						...
						if ((UserComparator6.field1191[var56][var58][var57] & var4) != 0) {
							var9 = var58;
							var10 = var58;
							var11 = var57;

							for (var12 = var57; var11 > 0 && (UserComparator6.field1191[var56][var58][var11 - 1] & var4) != 0; --var11) {
							}

							while (var12 < 104 && (UserComparator6.field1191[var56][var58][var12 + 1] & var4) != 0) {
								++var12;
							}
							...
							while (var9 > 0) {
								for (var13 = var11; var13 <= var12; ++var13) {
									if ((UserComparator6.field1191[var56][var9 - 1][var13] & var4) == 0) {
										break label441;
									}
								}
							...
							while (var10 < 104) {
								for (var13 = var11; var13 <= var12; ++var13) {
									if ((UserComparator6.field1191[var56][var10 + 1][var13] & var4) == 0) {
										break label430;
									}
								}
							...
							if ((var12 - var11 + 1) * (var10 - var9 + 1) >= 4) {
								...
								for (var14 = var9; var14 <= var10; ++var14) {
									for (var15 = var11; var15 <= var12; ++var15) {
										var10000 = UserComparator6.field1191[var56][var14];
										var10000[var15] &= ~var4;
									}
								}
							}
	...
	static void method2390(int var0, int var1) {
		int var2 = SoundCache.fontBold12.stringWidth("Choose Option");

		int var3;
		int var4;
		for (var3 = 0; var3 < Client.menuOptionsCount; ++var3) {
			var4 = SoundCache.fontBold12.stringWidth(class169.method882(var3));
			if (var4 > var2) {
				var2 = var4;
			}
		}
