...
public class class181 {
	...
	static File method918(String var0, String var1, int var2) {
		String var3 = var2 == 0 ? "" : "" + var2;
		JagexCache.field1848 = new File(Login.userHomeDirectory, "jagex_cl_" + var0 + "_" + var1 + var3 + ".dat");
		String var4 = null;
		String var5 = null;
		boolean var6 = false;
		Buffer var8;
		int var11;
		File var27;
		if (JagexCache.field1848.exists()) {
			try {
				AccessFile var7 = new AccessFile(JagexCache.field1848, "rw", 10000L);
		...
		if (var4 == null && var2 == 0) {
			label134:
			for (int var16 = 0; var16 < class85.field859.length; ++var16) {
				for (int var17 = 0; var17 < GameObject.field2480.length; ++var17) {
					File var18 = new File(GameObject.field2480[var17] + class85.field859[var16] + File.separatorChar + var0 + File.separatorChar);
					if (var18.exists()) {
		...
		if (var6) {
			...
			try {
				AccessFile var34 = new AccessFile(JagexCache.field1848, "rw", 10000L);
	...
	protected static final int method919() {
