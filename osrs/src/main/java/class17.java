...
class class17 implements SSLSession {
   ...
   static final void method61(PacketBuffer var0) {
      var0.importIndex();
      int var1 = var0.readBits(8);
      int var2;
      if (var1 < Client.npcCount) {
         for(var2 = var1; var2 < Client.npcCount; ++var2) {
            Client.field503[++Client.field502 - 1] = Client.npcIndices[var2];
         }
      }
         ...
         for(var2 = 0; var2 < var1; ++var2) {
            ...
            if (var5 == 0) {
               ...
               if (var6 == 0) {
                  Client.npcIndices[++Client.npcCount - 1] = var3;
                  var4.npcCycle = Client.cycle;
                  Client.field426[++Client.field425 - 1] = var3;
               } else {
                  int var7;
                  int var8;
                  if (var6 == 1) {
                     ...
                     Client.field503[++Client.field502 - 1] = var3;
                  }
               }
            }
         }
   ...
   static final void method63(int var0, int var1, int var2, int var3, int var4, int var5) {
      int var6 = var2 - var0;
      int var7 = var3 - var1;
