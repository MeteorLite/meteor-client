...
public class class31 {
   @ObfuscatedName("aj")
   public static Applet field88 = null;
   @ObfuscatedName("al")
               ...
               if (var3.sequenceId != -1 || var3.sequenceId2 != -1) {
                  ...
                  if (var5 != -1) {
                     ...
                     if (!var6.isCachedModelIdSet()) {
                        for(var3.modelFrameCycle += Client.field504; var3.modelFrameCycle > var6.frameLengths[var3.modelFrame]; class69.invalidateWidget(var3)) {
                        ...
                        var3.modelFrame += Client.field504;
                        int var7 = var6.method1066();
   ...
   static final void method129() {
      Client.field399 = Client.cycleCntr;
