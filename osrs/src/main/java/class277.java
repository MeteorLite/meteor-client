...
public class class277 {
   @ObfuscatedName("n")
   static ThreadPoolExecutor field2428;
    ...
    public static synchronized void ByteArrayPool_release(byte[] var0) {
      if (var0.length == 100 && ByteArrayPool.ByteArrayPool_smallCount < ByteArrayPool.field3640) {
         ByteArrayPool.ByteArrayPool_small[++ByteArrayPool.ByteArrayPool_smallCount - 1] = var0;
      } else if (var0.length == 5000 && ByteArrayPool.ByteArrayPool_mediumCount < ByteArrayPool.field3644) {
         ByteArrayPool.ByteArrayPool_medium[++ByteArrayPool.ByteArrayPool_mediumCount - 1] = var0;
      } else if (var0.length == 10000 && ByteArrayPool.ByteArrayPool_largeCount < ByteArrayPool.field3645) {
         ByteArrayPool.ByteArrayPool_large[++ByteArrayPool.ByteArrayPool_largeCount - 1] = var0;
      } else if (var0.length == 30000 && ByteArrayPool.field3639 < ByteArrayPool.field3641) {
         ByteArrayPool.field3642[++ByteArrayPool.field3639 - 1] = var0;
      } else {
    ...
    static final void loadRegions(boolean var0, PacketBuffer var1) {
      ...
      if (!Client.isInInstance) {
         ...
         class28.method111(var3, var2, true);
      } else {
         var2 = var1.readUnsignedShortLEA();
         ...
         class28.method111(var4, var2, !var15);
      }
