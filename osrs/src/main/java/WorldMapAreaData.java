      ...
      if (var0 == 3600) {
         ...
         if (var0 == 3601) {
            ...
            if (var0 == 3604) {
               ...
               Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = UserComparator5.friendsChat != null ? UserComparator5.friendsChat.rank * 39383707 * 1788650387 : 0;
               return 1;
            } else if (var0 == 3619) {
               var5 = Interpreter.Interpreter_stringStack[--SecureRandomCallable.Interpreter_stringStackSize];
