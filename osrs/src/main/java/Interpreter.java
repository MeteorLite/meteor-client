...
public class Interpreter {
	...
	static final void method418(int var0, int var1) {
		if (class33.field89.method1742(var0)) {
			ClientPacket.runComponentCloseListeners(class33.field89.Widget_interfaceComponents[var0], var1);
		}
	}
}