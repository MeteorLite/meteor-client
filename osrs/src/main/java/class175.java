                  ...
                  if (Login.loginIndex == 1) {
                     ...
                     if (Login.loginIndex == 2) {
                        ...
                        if (class379.field4467 != null) {
                           var86 = class379.field4467.highX / 2;
                           if (var4 == 1 && var81 >= class379.field4467.lowX - var86 && var81 <= var86 + class379.field4467.lowX && var82 >= var85 - 15 && var82 < var85) {
                        ...
                        var87 = 277;
                        Login.field939 = var81 >= var86 && var81 < var86 + class126.field1569 && var82 >= var87 && var82 < var87 + WorldMapSection1.field2998;
                        ...
                        var87 = 277;
                        Login.field955 = var81 >= var86 && var81 < var86 + class126.field1569 && var82 >= var87 && var82 < var87 + WorldMapSection1.field2998;
                        ...
                        while(true) {
                           ...
                           try {
                              ...
                              for(int var94 = 0; var94 < var99; ++var94) {
                                 if (!ObjectSound.method1871(var93.charAt(var94)) || !class4.method22(var93.charAt(var94))) {
                                    class12.method155(3);
                                    return;
                                 }
                              }
                        ...
                        if (Login.loginIndex == 4) {
                           ...
                           if (Login.loginIndex == 5) {
                              ...
                              if (var4 == 1 && var81 >= var9 - 75 && var81 <= var9 + 75 && var82 >= var10 - 20 && var82 <= var10 + 20) {
                                 ...
                                 if (Login.Login_username.length() == 0) {
                                    ...
                                    if (var44 == 0L) {
                                       ...
                                       var120.encryptRsa(class69.field889, class69.field887);
                                       var20.writeByte(10);
                                       ...
                                       String var125 = EnumComposition.method3650(var51.array);

                                       byte var16;
                                       try {
                                          URL var107 = new URL(ScriptFrame.method1169("services", false) + "m=accountappeal/login.ws");
                              ...
                              if (class151.field1763 != null) {
                                 ...
                                 if (var4 == 1 && var81 >= class151.field1763.lowX - var12 && var81 <= var12 + class151.field1763.lowX && var82 >= var87 - 15 && var82 < var87) {
                              ...
                              if (Login.loginIndex == 7) {
                                    ...
                                    if (var4 == 1 && var81 >= var13 - 75 && var81 <= var13 + 75 && var82 >= var92 - 20 && var82 <= var92 + 20) {
                                       label1734: {
                                          ...
                                          if (var115 == null) {
                                             ...
                                             var101 = class410.method7833(var115);
                                             if (!var101) {
                                                Player.method2329("Date not valid.", "Please ensure date follows the format", "DD/MM/YYYY and is after 01/01/1900");
                                                var127 = false;
                                             } else {
                                                if (!var17) {
                                                   ...
                                                   class29.field172 = (int)(var115.getTime() / 86400000L - 11745L);
                                                }
                                 ...
                                 var9 = Login.loginBoxX + 180;
                                 var10 = 311;
                                 if (var38.field2328 == 84 || var38.field2328 == 13 || var4 == 1 && var81 >= var9 - 75 && var81 <= var9 + 75 && var82 >= var10 - 20 && var82 <= var10 + 20) {
                                    class124.method2939(false);
                                 }
                              } else if (Login.loginIndex == 10) {
                                 var9 = Login.loginBoxX + 180;
                                 var10 = 209;
                                 if (var38.field2328 == 84 || var4 == 1 && var81 >= var9 - 109 && var81 <= var9 + 109 && var82 >= var10 && var82 <= var10 + 68) {
                                    TaskHandler.setLoginResponseString("", "Connecting to server...", "");
                                 ...
                                 var10 = 233;
                                 Bounds var66 = var1.method7169(0, 30, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var9, var10);
                                 Bounds var39 = var1.method7169(32, 32, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var9, var10);
                                 Bounds var40 = var1.method7169(70, 34, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var9, var10);
                                 var86 = var10 + 17;
                                 Bounds var113 = var1.method7169(0, 34, "<col=ffd200>agreement (EULA)</col>.", var9, var86);
                                 if (var4 == 1) {
                                    if (var66.method7724(var81, var82)) {
                                       ModeWhere.openURL("https://www.jagex.com/terms", true, false);
                                    } else if (var39.method7724(var81, var82)) {
                                       ModeWhere.openURL("https://www.jagex.com/terms/privacy", true, false);
                                    } else if (var40.method7724(var81, var82) || var113.method7724(var81, var82)) {
