...
public class UserComparator5 extends AbstractUserComparator {
	...
	static void method674() {
		try {
			...
			if (var0.exists()) {
				...
				label34:
				for (int var1 = 0; var1 < class27.field74.length; ++var1) {
					for (var2 = 0; var2 < FriendsList.field3812.length; ++var2) {
						File var3 = new File(FriendsList.field3812[var2] + class27.field74[var1] + File.separatorChar + "random.dat");
						if (var3.exists()) {
	...
	static final void method672(byte[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, CollisionMap[] var10) {
		int var12;
			...
			for (int var13 = 0; var13 < 64; ++var13) {
				for (int var14 = 0; var14 < 64; ++var14) {
					if (var12 == var4 && var13 >= var5 && var13 < var5 + 8 && var14 >= var6 && var14 < var6 + 8) {
						...
						int var21 = var3 + ClanChannelMember.method771(var13 & 7, var14 & 7, var7);
	...
	static String method673(int var0, int var1, boolean var2) {
		if (var1 >= 2 && var1 <= 36) {
			if (var2 && var0 >= 0) {
				int var3 = 2;
