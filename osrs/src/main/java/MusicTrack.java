...
public class MusicTrack extends Node {
	...
	MusicTrack(Buffer var1) {
		this.field2837 = new NodeHashTable(16);
					...
					if (var68 == 23) {
						...
						if (var66 == 0) {
							...
							if (var71 > 0) {
								...
								class318 var73 = (class318)this.field2837.get((long)var72);
								if (var73 == null) {
									var73 = new class318(var65);
									this.field2837.put(var73, (long)var72);
								}

								var73.field2876.set(var74);
							}
						} else if (var66 == 1) {
							if (var69) {
