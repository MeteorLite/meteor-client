...
public class MusicTrack extends Node {
	...
	MusicTrack(Buffer var1) {
		this.field2860 = new NodeHashTable(16);
					...
					if (var68 == 23) {
						...
						if (var66 == 0) {
							...
							if (var71 > 0) {
								...
								class332 var73 = (class332)this.field2860.get((long)var72);
								if (var73 == null) {
									var73 = new class332(var65);
									this.field2860.put(var73, (long)var72);
								}

								var73.field2896.set(var74);
							}
						} else if (var66 == 1) {
							if (var69) {
