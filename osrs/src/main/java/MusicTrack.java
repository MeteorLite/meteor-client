...
public class MusicTrack extends Node {
	...
	MusicTrack(Buffer var1) {
		this.field2857 = new NodeHashTable(16);
					...
					if (var68 == 23) {
						...
						if (var66 == 0) {
							...
							if (var71 > 0) {
								...
								class329 var73 = (class329)this.field2857.get((long)var72);
								if (var73 == null) {
									var73 = new class329(var65);
									this.field2857.put(var73, (long)var72);
								}

								var73.field2894.set(var74);
							}
						} else if (var66 == 1) {
							if (var69) {
