...
public class WorldMapArea {
	...
	static void method1413(int var0) {
	}
	...
	public static boolean method1425() {
		boolean var0 = false;
		boolean var1 = false;
		if (!class305.field2771.isEmpty()) {
			SongTask var2 = (SongTask)class305.field2771.get(0);
			if (var2 == null) {
				class305.field2771.remove(0);
			} else if (var2.vmethod2142()) {
				if (var2.method2132()) {
					System.out.println("Error in midimanager.service: " + var2.method2135());
					var0 = true;
				} else {
					if (var2.method2136() != null) {
						class305.field2771.add(1, var2.method2136());
					}

					var1 = var2.method2134();
				}
