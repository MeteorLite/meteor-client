...
final class class511 implements class510 {
	...
	public void vmethod8274(Object var1, Buffer var2) {
		this.method2496((Integer)var1, var2);
	}
	...
	void method2496(Integer var1, Buffer var2) {
		var2.writeInt(var1);
	}
	...
	static final void drawObject(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var5 != 0L) {
			...
			if (var24.mapSceneId != -1) {
				IndexedSprite var18 = VarpDefinition.mapSceneSprites[var24.mapSceneId];
				if (var18 != null) {
				...
				int[] var20 = class102.sceneMinimapSprite.pixels;
