...
public class ApproximateRouteStrategy extends RouteStrategy {
	...
	static void runScriptLogic(ScriptEvent var0, Script var1, int var2, int var3) {
		...
		label860: {
			label861: {
				try {
					...
					try {
						...
						Interpreter.field705 = var0.field871;
						...
						while (true) {
							...
							if (var32 >= 100) {
								...
								var13 = var7[var5];
								ZoneOperation.method1632(var13, Interpreter.Interpreter_intStack[--DbTableType.Interpreter_intStackSize]);
							} else if (var32 == 31) {
								DbTableType.Interpreter_intStackSize -= 2;
								if (Interpreter.Interpreter_intStack[DbTableType.Interpreter_intStackSize] <= Interpreter.Interpreter_intStack[DbTableType.Interpreter_intStackSize + 1]) {
									var5 += var7[var5];
								...
								var20 = BoundaryObject.method1600(Interpreter.Interpreter_stringStack, class127.Interpreter_stringStackSize, var13);
								...
								if (var32 != 40) {
									if (var32 == 42) {
										...
										if (var32 == 47) {
											...
											Integer var38;
											if (var32 == 74) {
												var38 = Timer.field3782.getTitleGroupValue(var7[var5]);
												if (var38 == null) {
												...
												var38 = Client.varclan.method2337(var7[var5]);
												if (var38 == null) {
													Interpreter.Interpreter_intStack[++DbTableType.Interpreter_intStackSize - 1] = -1;
												} else {
													Interpreter.Interpreter_intStack[++DbTableType.Interpreter_intStackSize - 1] = var38;
					...
					if (var29) {
						while (Interpreter.field712.size() > 0) {
							class102 var19 = (class102)Interpreter.field712.remove(0);
							FloorOverlayDefinition.widgetDefaultMenuAction(var19.method598(), var19.method599(), var19.method600(), var19.method601(), "");
						}
				...
				while (Interpreter.field712.size() > 0) {
					class102 var33 = (class102)Interpreter.field712.remove(0);
					FloorOverlayDefinition.widgetDefaultMenuAction(var33.method598(), var33.method599(), var33.method600(), var33.method601(), "");
				}
			...
			while (Interpreter.field712.size() > 0) {
				class102 var40 = (class102)Interpreter.field712.remove(0);
				FloorOverlayDefinition.widgetDefaultMenuAction(var40.method598(), var40.method599(), var40.method600(), var40.method601(), "");
			}
		...
		while (Interpreter.field712.size() > 0) {
			class102 var25 = (class102)Interpreter.field712.remove(0);
			FloorOverlayDefinition.widgetDefaultMenuAction(var25.method598(), var25.method599(), var25.method600(), var25.method601(), "");
		}
	...
	static int method356(int var0, Script var1, boolean var2) {
		...
		if (var0 == 3400) {
			...
			EnumComposition var5 = ObjectComposition.getEnum(var3);
			if (var5.outputType != 's') {
			}

			for (var6 = 0; var6 < var5.outputCount; ++var6) {
				if (var4 == var5.keys[var6]) {
					Interpreter.Interpreter_stringStack[++class127.Interpreter_stringStackSize - 1] = var5.strVals[var6];
					var5 = null;
					break;
				}
			}
			...
			if (var5 != null) {
				Interpreter.Interpreter_stringStack[++class127.Interpreter_stringStackSize - 1] = var5.defaultStr;
			}
			...
			if (var0 == 3411) {
				...
				Interpreter.Interpreter_intStack[++DbTableType.Interpreter_intStackSize - 1] = var10.size();
				return 1;
			} else {
				return 2;
			}
			...
			EnumComposition var7 = ObjectComposition.getEnum(var9);
