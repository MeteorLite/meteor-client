...
public class class421 {
	...
	static {
		field4615 = new int[16384];
		field4611 = new int[16384];
		double var0 = 3.834951969714103E-4D;

		for (int var2 = 0; var2 < 16384; ++var2) {
			field4615[var2] = (int)(16384.0D * Math.sin((double)var2 * var0));
			field4611[var2] = (int)(16384.0D * Math.cos((double)var2 * var0));
		}
