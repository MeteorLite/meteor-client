...
public class class299 {
   ...
   static final void method5834(int var0) {
      ...
      if (var0 != StructComposition.clientPreferences.method2425()) {
         if (StructComposition.clientPreferences.method2425() == 0 && Client.currentTrackGroupId != -1) {
            class29.method426(class162.archive6, Client.currentTrackGroupId, 0, var0, false);
            Client.playingJingle = false;
         } else if (var0 == 0) {
            class6.method39();
            Client.playingJingle = false;
         } else {
            class32.method468(var0);
         }

         StructComposition.clientPreferences.method2414(var0);
      }
