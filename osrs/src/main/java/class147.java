...
public class class147 extends class143 {
	...
	void vmethod3248(ClanSettings var1) {
		var1.method817(this.field1350, this.field1349);
	}
	...
	static void runScriptLogic(ScriptEvent var0, Script var1, int var2, int var3) {
		...
		label860: {
			label861: {
				try {
					...
					try {
						...
						for (var13 = 1; var13 < var4.length; ++var13) {
							if (var4[var13] instanceof Integer) {
								...
								if (var14 == -2147483645) {
									var14 = var0.widget != null ? var0.widget.id * -198009563 * -802277715 : -1;
								}
								...
								if (var14 == -2147483643) {
									var14 = var0.widget != null ? var0.widget.childIndex * 1628260767 * -1714711969 : -1;
								}

								if (var14 == -2147483642) {
									var14 = var0.dragTarget != null ? var0.dragTarget.id * -198009563 * -802277715 : -1;
								}

								if (var14 == -2147483641) {
									var14 = var0.dragTarget != null ? var0.dragTarget.childIndex * 1628260767 * -1714711969 : -1;
								}
						...
						Interpreter.field708 = var0.field864;
						...
						while (true) {
							...
							if (var32 >= 100) {
								...
								var14 = PacketWriter.method644(var32, var1, var34);
								switch(var14) {
								case 0:
									var29 = false;
									break label841;
								...
								var13 = var7[var5];
								Frames.method1293(var13, Interpreter.Interpreter_intStack[--SoundCache.Interpreter_intStackSize]);
							} else if (var32 == 31) {
								SoundCache.Interpreter_intStackSize -= 2;
								if (Interpreter.Interpreter_intStack[SoundCache.Interpreter_intStackSize] <= Interpreter.Interpreter_intStack[SoundCache.Interpreter_intStackSize + 1]) {
									var5 += var7[var5];
								...
								var20 = class271.method1540(Interpreter.Interpreter_stringStack, class137.Interpreter_stringStackSize, var13);
								...
								if (var32 != 40) {
									if (var32 == 42) {
										...
										if (var32 == 47) {
											...
											Integer var38;
											if (var32 == 74) {
												var38 = class466.field3912.getTitleGroupValue(var7[var5]);
												if (var38 == null) {
												...
												var38 = class139.varclan.method2320(var7[var5]);
												if (var38 == null) {
													Interpreter.Interpreter_intStack[++SoundCache.Interpreter_intStackSize - 1] = -1;
												} else {
													Interpreter.Interpreter_intStack[++SoundCache.Interpreter_intStackSize - 1] = var38;
					...
					if (var29) {
						while (Interpreter.field715.size() > 0) {
							class102 var19 = (class102)Interpreter.field715.remove(0);
							class47.widgetDefaultMenuAction(var19.method601(), var19.method602(), var19.method603(), var19.method604(), "");
						}
						...
						if (!var9 && var3 > 0 && var10 >= var3) {
							Messages.RunException_sendStackTrace("Warning: Script " + var1.field817 + " finished at op count " + var10 + " of max " + var2, (Throwable)null);
						}
				...
				while (Interpreter.field715.size() > 0) {
					class102 var33 = (class102)Interpreter.field715.remove(0);
					class47.widgetDefaultMenuAction(var33.method601(), var33.method602(), var33.method603(), var33.method604(), "");
				}
			...
			while (Interpreter.field715.size() > 0) {
				class102 var40 = (class102)Interpreter.field715.remove(0);
				class47.widgetDefaultMenuAction(var40.method601(), var40.method602(), var40.method603(), var40.method604(), "");
			}
		...
		while (Interpreter.field715.size() > 0) {
			class102 var25 = (class102)Interpreter.field715.remove(0);
			class47.widgetDefaultMenuAction(var25.method601(), var25.method602(), var25.method603(), var25.method604(), "");
		}
