...
public class ModelData0 {
	...
	public static int method1381(float[] var0, int var1, float var2, boolean var3, float var4, boolean var5, float[] var6) {
		float var7 = 0.0F;
		...
		float var44 = (Math.abs(var2) + Math.abs(var4)) * (float)(var1 + 1) * class126.field1204;
		if (var7 <= var44) {
			return -1;
		} else {
			...
			if (var1 == 0) {
				...
				boolean var12 = var5 ? var4 > var6[0] - var44 : var4 > var6[0] + var44;
				...
				class452 var41 = new class452(var9, var1);
				...
				int var14 = method1381(var42, var1 - 1, var2, false, var4, false, var43);
				if (var14 == -1) {
					return 0;
				} else {
					boolean var15 = false;
					...
					for (int var20 = 0; var20 <= var14; ++var20) {
						...
						if (var20 == 0) {
							var16 = var2;
							var18 = GrandExchangeEvent.method1953(var9, var1, var2);
						...
						var17 = GrandExchangeEvent.method1953(var9, var1, var19);
						if (var15) {
							var15 = false;
							...
							float var24 = var16;
							float var25 = var19;
							float var26 = GrandExchangeEvent.method1953(var41.field3891, var41.field3892, var16);
							float var23;
							if (Math.abs(var26) < class126.field1204) {
								var23 = var16;
							} else {
								float var27 = GrandExchangeEvent.method1953(var41.field3891, var41.field3892, var19);
								if (Math.abs(var27) < class126.field1204) {
									var23 = var19;
								} else {
									float var28 = 0.0F;
									float var29 = 0.0F;
									...
									do {
										...
										float var38 = class126.field1203 * Math.abs(var25) + 0.0F;
										...
										if (var40) {
											...
											var27 = GrandExchangeEvent.method1953(var41.field3891, var41.field3892, var25);
	...
	public static void method1382(AbstractArchive var0) {
		DbRowType.field4116 = var0;
	}
	...
	static boolean method1383(Date var0) {
