...
public class ModelData0 {
	...
	static int method1599(int var0, Script var1, boolean var2) {
		int var3;
		int var4;
		if (var0 == 8000) {
			...
			class422.method2167(Interpreter.Interpreter_arrays[var3], new int[var4], 0, var4 - 1);
			return 1;
		} else if (var0 == 8001) {
			...
			if (var6 <= 1) {
				...
				class421.method2166(Interpreter.Interpreter_arrays[var3], var6, var4, var5);
				return 1;
			}
		} else {
			return 2;
