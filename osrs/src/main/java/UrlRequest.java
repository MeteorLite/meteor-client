		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState == 20) {
				...
				if (Login.loginIndex != 4 && Login.loginIndex != 10) {
					...
					for (var7 = ClientPacket.method5373(Login.Login_password); var0.stringWidth(var7) > var25; var7 = var7.substring(1)) {
					}
			...
			if (Client.gameState == 10 || Client.gameState == 11 || Client.gameState == 50) {
				...
				if (Login.loginIndex == 0) {
					...
					var23 = 201;
					var0.drawCentered(Login.Login_response1, Canvas.loginBoxCenter, var23, 16776960, 0);
					var24 = var23 + 15;
					var0.drawCentered(Login.Login_response2, Canvas.loginBoxCenter, var24, 16776960, 0);
					var24 += 15;
					var0.drawCentered(Login.Login_response3, Canvas.loginBoxCenter, var24, 16776960, 0);
					var24 += 15;
					var24 += 7;
					var0.draw("Login: ", Canvas.loginBoxCenter - 110, var24, 16777215, 0);
					var25 = 200;
					var5 = BufferedSink.clientPreferences.method2381() ? ClientPacket.method5373(Login.Login_username) : Login.Login_username;
					...
					var0.draw(AbstractFont.escapeBrackets(var6) + (Login.currentLoginField == 0 & Client.cycle % 40 < 20 ? GameObject.colorStartTag(16776960) + "|" : ""), Canvas.loginBoxCenter - 70, var24, 16777215, 0);
					var24 += 15;

					for (var7 = ClientPacket.method5373(Login.Login_password); var0.stringWidth(var7) > var25; var7 = var7.substring(1)) {
					}

					var0.draw("Password: " + var7 + (Login.currentLoginField == 1 & Client.cycle % 40 < 20 ? GameObject.colorStartTag(16776960) + "|" : ""), Canvas.loginBoxCenter - 108, var24, 16777215, 0);
					var24 += 15;
					var23 = 277;
					...
					class459.field4855 = new Bounds(Canvas.loginBoxCenter, var23, var1.stringWidth(class17.field95), 11);
					WorldMapID.field2925 = new Bounds(Canvas.loginBoxCenter, var23, var1.stringWidth("Still having trouble logging in?"), 11);
					var1.drawCentered(class17.field95, Canvas.loginBoxCenter, var23, 16777215, 0);
					...
					if (Login.loginIndex == 4) {
						...
						var0.drawCentered(Login.Login_response3, Login.loginBoxX + 180, var24, 16777215, 0);
						var24 += 15;
						var0.draw("PIN: " + ClientPacket.method5373(class355.otp) + (Client.cycle % 40 < 20 ? GameObject.colorStartTag(16776960) + "|" : ""), Login.loginBoxX + 180 - 108, var24, 16777215, 0);
						var24 -= 8;
						...
						IndexedSprite var26;
						if (Login.field900) {
							var26 = class181.options_buttons_2Sprite;
						} else {
						...
						var27 = 321;
						class143.titlebuttonSprite.drawAt(var20 - 73, var27 - 20);
						...
						var0.draw(AbstractFont.escapeBrackets(var6) + (Client.cycle % 40 < 20 ? GameObject.colorStartTag(16776960) + "|" : ""), Login.loginBoxX + 180 - 34, var24, 16777215, 0);
						var24 += 15;
						var20 = Login.loginBoxX + 180 - 80;
						var27 = 321;
						class143.titlebuttonSprite.drawAt(var20 - 73, var27 - 20);
						...
						var27 = 356;
						var1.drawCentered("Still having trouble logging in?", Canvas.loginBoxCenter, var27, 268435455, 0);
						...
						if (ItemContainer.field1020 && !Client.onMobile) {
							...
							for (var28 = 0; var28 < 8; ++var28) {
								class143.titlebuttonSprite.method8806(var4, var24, 30, 40);
								boolean var21 = var28 == Login.field913 & Client.cycle % 40 < 20;
								var0.draw((Login.field914[var28] == null ? "" : Login.field914[var28]) + (var21 ? GameObject.colorStartTag(16776960) + "|" : ""), var4 + 10, var24 + 27, 16777215, 0);
								if (var28 != 1 && var28 != 3) {
									var4 += 35;
								} else {
									var4 += 50;
							...
							var28 = Canvas.loginBoxCenter - 80;
							short var29 = 321;
							class143.titlebuttonSprite.drawAt(var28 - 73, var29 - 20);
						...
						var4 = var25 + 20;
						class362.field4314.drawAt(var24 - 109, var4);
						class138.field1609.drawAt(var24 - 48, var4 + 18);
					} else if (Login.loginIndex == 12) {
						var24 = Canvas.loginBoxCenter;
						var25 = 216;
						...
						var24 = Canvas.loginBoxCenter - 80;
						var25 = 311;
						class143.titlebuttonSprite.drawAt(var24 - 73, var25 - 20);
						...
						var4 = Login.loginBoxX + 180;
						var23 = 311;
						class143.titlebuttonSprite.drawAt(var4 - 73, var23 - 20);
			...
			if (Client.gameState >= 10) {
				...
				GraphicsObject.field868.draw(Login.xPadding - 22, Client.cycle);
				GraphicsObject.field868.draw(Login.xPadding + 22 + 765 - 128, Client.cycle);
			...
			if (Client.gameState > 5 && class103.clientLanguage == Language.Language_EN) {
				if (WorldMapManager.field2822 != null) {
					...
					byte var31 = 100;
					byte var30 = 35;
					WorldMapManager.field2822.drawAt(var24, var25);
