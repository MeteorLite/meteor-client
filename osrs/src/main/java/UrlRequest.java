...
public class UrlRequest {
	...
	public boolean isDone() {
		return this.field1186 != field1180;
	}
	...
	public String method659() {
		return this.field1184.toString();
	}
	...
	static void drawTitle(Font var0, Font var1, Font var2) {
		...
		if (Login.worldSelectOpen) {
			ParamComposition.method981(var0, var1);
		} else {
			...
			if (Client.gameState == 20) {
				...
				if (Login.loginIndex != 4 && Login.loginIndex != 10) {
					...
					var25 = 200;
					var5 = WorldMapIcon_1.clientPreferences.getIsUsernameHidden() ? MusicPatch.method1709(Login.Login_username) : Login.Login_username;
					...
					for (var7 = MusicPatch.method1709(Login.Login_password); var0.stringWidth(var7) > var25; var7 = var7.substring(1)) {
					}
			...
			if (Client.gameState == 10 || Client.gameState == 11 || Client.gameState == 50) {
				...
				if (Login.loginIndex == 0) {
					...
					boolean var11 = Login.field743;
					IndexedSprite var9 = var10 ? (var11 ? GrandExchangeEvents.field3611 : FriendsList.options_buttons_2Sprite) : (var11 ? Login.field779 : class310.options_buttons_0Sprite);
					...
					boolean var14 = WorldMapIcon_1.clientPreferences.getIsUsernameHidden();
					boolean var15 = Login.field745;
					IndexedSprite var13 = var14 ? (var15 ? GrandExchangeEvents.field3611 : FriendsList.options_buttons_2Sprite) : (var15 ? Login.field779 : class310.options_buttons_0Sprite);
					...
					case 2:
						ModeWhere.field3652 = "Having trouble logging in?";
						break;
					default:
						ModeWhere.field3652 = "Can't login? Click here.";
					}

					Login.field775 = new Bounds(class157.loginBoxCenter, var23, var1.stringWidth(ModeWhere.field3652), 11);
					class7.field13 = new Bounds(class157.loginBoxCenter, var23, var1.stringWidth("Still having trouble logging in?"), 11);
					var1.drawCentered(ModeWhere.field3652, class157.loginBoxCenter, var23, 16777215, 0);
					...
					if (Login.loginIndex == 4) {
						...
						var0.drawCentered(Login.Login_response3, Login.loginBoxX + 180, var24, 16777215, 0);
						var24 += 15;
						var0.draw("PIN: " + MusicPatch.method1709(NewShit.otp) + (Client.cycle % 40 < 20 ? class167.colorStartTag(16776960) + "|" : ""), Login.loginBoxX + 180 - 108, var24, 16777215, 0);
						var24 -= 8;
						...
						var27 = 321;
						Login.titlebuttonSprite.drawAt(var19 - 73, var27 - 20);
						var0.drawCentered("Continue", var19, var27 + 5, 16777215, 0);
						var19 = Login.loginBoxX + 180 + 80;
						Login.titlebuttonSprite.drawAt(var19 - 73, var27 - 20);
						var0.drawCentered("Cancel", var19, var27 + 5, 16777215, 0);
						...
						var27 = 321;
						Login.titlebuttonSprite.drawAt(var19 - 73, var27 - 20);
						var0.drawCentered("Recover", var19, var27 + 5, 16777215, 0);
						var19 = Login.loginBoxX + 180 + 80;
						Login.titlebuttonSprite.drawAt(var19 - 73, var27 - 20);
						var0.drawCentered("Back", var19, var27 + 5, 16777215, 0);
						var27 = 356;
						...
						if (PendingSpawn.field949 && !Client.onMobile) {
							...
							for (var28 = 0; var28 < 8; ++var28) {
								Login.titlebuttonSprite.method2671(var4, var24, 30, 40);
								boolean var20 = var28 == Login.field753 & Client.cycle % 40 < 20;
								var0.draw((Login.field769[var28] == null ? "" : Login.field769[var28]) + (var20 ? class167.colorStartTag(16776960) + "|" : ""), var4 + 10, var24 + 27, 16777215, 0);
								if (var28 != 1 && var28 != 3) {
									var4 += 35;
								} else {
									var4 += 50;
						...
						var4 = var25 + 20;
						Login.field776.drawAt(var24 - 109, var4);
						if (Login.field763.isEmpty()) {
							class11.field38.drawAt(var24 - 48, var4 + 18);
						} else {
							class11.field38.drawAt(var24 - 48, var4 + 5);
							var0.drawCentered(Login.field763, var24, var4 + 68 - 15, 16776960, 0);
						}
						...
						case 0:
							var21 = "Your account has been involved";
							var5 = "in serious rule breaking.";
							var6 = "";
							break;
						case 1:
							var21 = "Your account has been locked due to";
							var5 = "suspicious activity.";
							var6 = "Please recover your account.";
							break;
						case 2:
							var21 = "The unpaid balance on your account needs";
							var5 = "to be resolved before you can play.";
							var6 = Strings.field3326;
							break;
						default:
							SoundSystem.Login_promptCredentials(false);
						}

						var0.drawCentered(var21, Login.loginBoxX + 180, var23, 16776960, 0);
						var24 = var23 + 20;
						...
						Login.titlebuttonSprite.drawAt(var19 - 73, var27 - 20);
						if (Login.field751 == 1) {
							var0.drawCentered("Recover Account", var19, var27 + 5, 16777215, 0);
						} else {
							var0.drawCentered("View Appeal Options", var19, var27 + 5, 16777215, 0);
						}
			...
			if (Client.gameState >= 10) {
				...
				EnumComposition.field1505.draw(Login.xPadding - 22, Client.cycle);
				EnumComposition.field1505.draw(Login.xPadding + 22 + 765 - 128, Client.cycle);
				Rasterizer2D.Rasterizer2D_setClipArray(var22);
			}

			Login.title_muteSprite[WorldMapIcon_1.clientPreferences.getTitleMusicDisabled() ? 1 : 0].drawAt(Login.xPadding + 765 - 40, 463);
			if (Client.gameState > 5 && class85.clientLanguage == Language.Language_EN) {
				if (FadeOutTask.field3749 != null) {
					var24 = Login.xPadding + 5;
					var25 = 463;
					byte var31 = 100;
					byte var30 = 35;
					FadeOutTask.field3749.drawAt(var24, var25);
					...
					FadeOutTask.field3749 = class313.SpriteBuffer_getIndexedSpriteByName(GrandExchangeOfferOwnWorldComparator.archive8, "sl_button", "");
				}
			}
	...
	static final void method661(int var0, int var1, int var2, int var3, int var4, int var5) {
		int var6 = var2 - var0;
		int var7 = var3 - var1;
		...
		if (var10 != 0) {
			...
			Rasterizer3D.method1431(var17, var18, var19);
			Rasterizer3D.method1433(var21, var22, var23, var17, var18, var19, 0.0F, 0.0F, 0.0F, var4);
			Rasterizer3D.method1431(var17, var19, var20);
			Rasterizer3D.method1433(var21, var23, var24, var17, var19, var20, 0.0F, 0.0F, 0.0F, var4);
		}
	}
	...
	static void findItemDefinitions(String var0, boolean var1) {
		...
		for (int var9 = 0; var9 < BuddyRankComparator.foundItemIdCount; ++var9) {
			var8[var9] = class214.ItemDefinition_get(var2[var9]).name;
		}

		class215.method1095(var8, MusicPatchNode.foundItemIds);
	}
}