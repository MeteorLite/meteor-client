...
public class class135 implements class126 {
	...
	public static byte[] method726(Object var0, boolean var1) {
		if (var0 == null) {
			return null;
	...
	public static void method727(AbstractArchive var0) {
	...
	static boolean method728(CharSequence var0, int var1, boolean var2) {
		if (var1 >= 2 && var1 <= 36) {
			boolean var3 = false;
			boolean var4 = false;
			int var5 = 0;
