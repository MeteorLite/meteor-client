...
public class class135 {
	...
	static SpritePixels method741(int var0, int var1, int var2) {
	...
	public static void method742(Widget var0, int var1, int var2) {
		PlayerComposition var3 = var0.field3101;
		boolean var4 = var2 != var3.field2916;
		var3.field2916 = var2;
		if (var4) {
			int var5;
			int var6;
			if (var3.field2916 == var1) {
				for (var5 = 0; var5 < PlayerComposition.equipmentIndices.length; ++var5) {
					...
					if (var3.equipment[var6] > 0 && var3.equipment[var6] < 512) {
						var3.equipment[var6] = var3.field2913[var6];
					}
				}
			} else {
				if (var3.equipment[0] < 512 || Actor.method522(var3)) {
					var3.equipment[class209.field1862.field1871] = 1;
				}
	...
	static final void updateItemPile(int var0, int var1) {
		...
		if (var2 == null) {
			...
			if (var5 == null) {
				...
				class130.scene.newGroundItemPile(HealthBar.Client_plane, var0, var1, class18.getTileHeight(var0 * 128 + 64, var1 * 128 + 64, HealthBar.Client_plane), var5, var9, var12, var11);
			}
		}
	}
			...
			if (var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.clickedWidget)) {
				...
				if (!var10.isIf3 || !class143.isComponentHidden(var10)) {
					if (var10.contentType > 0) {
						StructComposition.method1025(var10);
					}
					...
					if (var10 == Client.clickedWidget) {
						if (var1 != -1412584499 && !var10.isScrollBar) {
							class162.field1420 = var0;
							class134.field1294 = var6;
							class326.field2893 = var7;
							continue;
						}

						if (Client.isDraggingWidget && Client.field395) {
							var15 = MouseHandler.MouseHandler_x;
							var16 = MouseHandler.MouseHandler_y;
							var15 -= Client.widgetClickX;
							var16 -= Client.widgetClickY;
							if (var15 < Client.field514) {
								var15 = Client.field514;
							}

							if (var15 + var10.width > Client.field514 + Client.clickedWidgetParent.width) {
								var15 = Client.field514 + Client.clickedWidgetParent.width - var10.width;
							}

							if (var16 < Client.field513) {
								var16 = Client.field513;
							}

							if (var16 + var10.height > Client.field513 + Client.clickedWidgetParent.height) {
								var16 = Client.field513 + Client.clickedWidgetParent.height - var10.height;
							}
					...
					if (!var10.isIf3 || var15 < var17 && var16 < var18) {
						if (var10.contentType != 0) {
							if (var10.contentType == 1336) {
								if (class449.clientPreferences.method550()) {
									var13 += 15;
							...
							if (var10.contentType == 1337) {
								...
								Client.field407[var10.rootIndex] = true;
								Rasterizer2D.Rasterizer2D_setClip(var2, var3, var4, var5);
								continue;
							}
							...
							if (var10.contentType == 1402) {
								class139.field1323.draw(var12, Client.cycle);
							}
						}
						...
						if (Client.isResizable || Client.field409[var11] || Client.gameDrawingMode > 1) {
							...
							if (var10.type != 1) {
								if (var10.type == 3) {
									...
									if (var10.fill) {
										switch(var10.fillMode.field4233) {
										case 1:
									...
									if (var40 == null) {
										...
										if (var10.isIf3 && var10.itemId != -1) {
											...
											if ((var43.isStackable == 1 || var10.itemQuantity != 1) && var10.itemQuantity != -1) {
												var42 = MoveSpeed.colorStartTag(16748608) + var42 + "</col>" + " " + 'x' + WorldMapData_0.formatItemStacks(var10.itemQuantity);
											}
										}
										...
										if (!var10.isIf3) {
											var42 = WorldMapSectionType.method1516(var42, var10);
										}

										var40.method2093(var42, var12, var13, var10.width, var10.height, var20, var10.textShadowed ? 0 : -1, class466.method2347(var10.transparencyTop), var10.textXAlignment, var10.textYAlignment, var10.textLineHeight);
									}
								} else {
									int var23;
									int var24;
									...
									if (var10.type == 5) {
											...
											if (var38 == null) {
												...
												if (!var10.spriteTiling) {
													...
													if (var10.spriteAngle != 0) {
														var38.method2687(var10.width / 2 + var12, var10.height / 2 + var13, var10.spriteAngle, var22);
													} else if (var14 != 0) {
													...
													for (var24 = 0; var24 < var22; ++var24) {
														for (var25 = 0; var25 < var23; ++var25) {
															if (var10.spriteAngle != 0) {
																var38.method2687(var20 / 2 + var12 + var20 * var24, var21 / 2 + var13 + var21 * var25, var10.spriteAngle, 4096);
															} else if (var14 != 0) {
										...
										if (var10.type == 6) {
											...
											if (var10.itemId != -1) {
												...
												var39 = var10.field3101.getModel((SequenceDefinition)null, -1, EnumComposition.SequenceDefinition_get(VarbitComposition.localPlayer.idleSequence), VarbitComposition.localPlayer.movementFrame);
											} else {
												...
												var34 = -1;
												if (var20 != -1) {
													var33 = EnumComposition.SequenceDefinition_get(var20);
													var34 = var10.modelFrame;
												}

												var39 = var10.getModel(var33, var34, var36, VarbitComposition.localPlayer.appearance, var45, var32);
												if (var39 == null && Widget.field2945) {
													class218.invalidateWidget(var10);
												}
											}

											Rasterizer3D.method1202(var10.width / 2 + var12, var10.height / 2 + var13);
											var23 = Rasterizer3D.Rasterizer3D_sine[var10.modelAngleX] * var10.modelZoom >> 16;
											var24 = Rasterizer3D.Rasterizer3D_cosine[var10.modelAngleX] * var10.modelZoom >> 16;
											if (var39 != null) {
												if (!var10.isIf3) {
													var39.method1338(0, var10.modelAngleY, 0, var10.modelAngleX, 0, var23, var24);
												} else {
													var39.calculateBoundsCylinder();
													if (var10.modelOrthog) {
														var39.method1339(0, var10.modelAngleY, var10.modelAngleZ, var10.modelAngleX, var10.modelOffsetX, var23 + var22 + var10.modelOffsetY, var24 + var10.modelOffsetY, var10.modelZoom);
													} else {
														var39.method1338(0, var10.modelAngleY, var10.modelAngleZ, var10.modelAngleX, var10.modelOffsetX, var23 + var22 + var10.modelOffsetY, var24 + var10.modelOffsetY);
													}
												}
											}

											Rasterizer3D.method1201();
										} else {
											Font var29;
											if (var10.type == 8 && var10 == class343.field3147 && Client.field498 == Client.field496) {
												var19 = 0;
												var20 = 0;
												...
												String var31;
												for (var30 = WorldMapSectionType.method1516(var30, var10); var30.length() > 0; var20 = var20 + var29.ascent + 1) {
												...
												for (var30 = WorldMapSectionType.method1516(var30, var10); var30.length() > 0; var34 = var34 + var29.ascent + 1) {
											...
											if (var10.type == 9) {
												...
												if (var10.lineWid == 1) {
													...
													Language.method1977(var19, var20, var21, var22, var10.color, var10.lineWid);
												}
											} else if (var10.type == 12) {
												class329 var37 = var10.method1844();
												class324 var35 = var10.method1845();
												if (var37 != null && var35 != null && var37.method1787()) {
													var29 = var10.getFont();
													if (var29 != null) {
														Client.field651.method2694(var12, var13, var10.width, var10.height, var37.method1788(), var37.method1789(), var37.method1785(), var37.method1786(), var37.method1784());
														var22 = var10.textShadowed ? var10.spriteShadow * -2076930741 * -1858431901 : -1;
														if (!var37.method1782() && var37.method1779().method2038()) {
															Client.field651.method2695(var35.field2891, var22, var35.field2892, var35.field2890);
															Client.field651.method2696(var37.method1780(), var29);
														} else {
															Client.field651.method2695(var10.color, var22, var35.field2892, var35.field2890);
															Client.field651.method2696(var37.method1779(), var29);
														}
