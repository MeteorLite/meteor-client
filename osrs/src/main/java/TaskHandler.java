...
public class TaskHandler implements Runnable {
   ...
   public static void method894() {
      ...
      synchronized(ArchiveDiskActionHandler.ArchiveDiskActionHandler_lock) {
         if (ArchiveDiskActionHandler.field3409 != 0) {
            ArchiveDiskActionHandler.field3409 = 1;
   ...
   static class134 method893(int var0) {
         ...
         if (var8 == null) {
            ...
            if (!var7) {
               ...
               if (UserComparator7.field1146 == null) {
                  ...
                  UserComparator7.field1146 = new ThreadPoolExecutor(0, class134.field1263, 0L, TimeUnit.MILLISECONDS, new ArrayBlockingQueue(class134.field1263 * 100 + 100), new class181());
               }
         ...
         if (var3 != null) {
            ...
            if (var8 == null) {
               ...
               if (!var7) {
                  ...
                  if (UserComparator7.field1146 == null) {
                     class134.field1263 = Runtime.getRuntime().availableProcessors();
                     UserComparator7.field1146 = new ThreadPoolExecutor(0, class134.field1263, 0L, TimeUnit.MILLISECONDS, new ArrayBlockingQueue(class134.field1263 * 100 + 100), new class199());
                  }
   ...
   static void method892(int var0) {
