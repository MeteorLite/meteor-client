...
public class class162 extends class144 {
	...
	void vmethod3248(ClanSettings var1) {
		var1.method814(this.field1411, this.field1410);
	}
	...
	static void method845() {
		ChatChannel.field835 = new int[2000];
		int var0 = 0;
		int var1 = 240;

		int var3;
		for (byte var2 = 12; var0 < 16; var1 -= var2) {
			var3 = ArchiveLoader.method459((double)((float)var1 / 360.0F), 0.9998999834060669D, (double)(0.425F * (float)var0 / 16.0F + 0.075F));
			ChatChannel.field835[var0] = var3;
			++var0;
		}

		var1 = 48;

		for (int var5 = var1 / 6; var0 < ChatChannel.field835.length; var1 -= var5) {
			var3 = var0 * 2;

			for (int var4 = ArchiveLoader.method459((double)((float)var1 / 360.0F), 0.9998999834060669D, 0.5D); var0 < var3 && var0 < ChatChannel.field835.length; ++var0) {
				ChatChannel.field835[var0] = var4;
			}
		}
