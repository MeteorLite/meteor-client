...
public class LoginScreenAnimation {
	...
	final void method2346(int var1) {
		...
		if (this.field1229 > this.field1234.length) {
			...
			this.method2362(this.field1220[var2]);
		}
		...
		for (var7 = 256 - var1; var7 < 256; ++var7) {
			this.field1224[var7] = (int)(Math.sin((double)this.field1228 / 14.0D) * 16.0D + Math.sin((double)this.field1228 / 15.0D) * 14.0D + Math.sin((double)this.field1228 / 16.0D) * 12.0D);
			++this.field1228;
		}
		...
		for (int var3 = 1; var3 < 255; ++var3) {
			...
			for (int var9 = var6; var9 < var7; ++var9) {
				...
				if (var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart && var11 < Rasterizer2D.Rasterizer2D_xClipEnd) {
					...
					class1.rasterProvider.pixels[var8++] = -16777216 | (var13 * (var14 & 65280) + var12 * (var10 & 65280) & 16711680) + ((var10 & 16711935) * var12 + (var14 & 16711935) * var13 & -16711936) >> 8;
				} else {
					++var8;
				}
			}
