...
public class LoginScreenAnimation {
   ...
   final void method2373(int var1) {
      ...
      if (this.field1264 > this.field1278.length) {
         ...
         this.method2378(this.field1270[var2]);
      }
      ...
      if (this.field1275 * 16 > 0) {
         this.field1275 = this.field1275 * 16 - var1 * 4;
      }

      if (this.field1285 * 16 == 0 && this.field1275 * 16 == 0) {
      ...
      for(var7 = 256 - var1; var7 < 256; ++var7) {
         this.field1273[var7] = (int)(Math.sin((double)this.field1269 / 14.0D) * 16.0D + Math.sin((double)this.field1269 / 15.0D) * 14.0D + Math.sin((double)this.field1269 / 16.0D) * 12.0D);
         ++this.field1269;
      }

      this.field1281 = this.field1281 * 10000 + 10000 * var1;
      ...
      if (var7 > 0) {
         ...
         int var12;
         int var13;
         for(var11 = 0; var11 < this.field1281 * 100; ++var11) {
   ...
   final void method2371(int var1) {
      ...
      } else if (this.field1275 * 16 > 0) {
         this.method2376(this.field1275 * 16, this.field1268);
      } else {
   ...
   final void method2378(IndexedSprite var1) {
      ...
      for(var2 = 0; var2 < 5000; ++var2) {
         ...
         this.field1278[var3] = (int)(Math.random() * 256.0D);
      }
      ...
      if (var1 != null) {
         ...
         for(var3 = 0; var3 < var1.subHeight * 694949360; ++var3) {
