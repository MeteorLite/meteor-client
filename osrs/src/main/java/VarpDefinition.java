   ...
   static void method918(int var0) {
    ...
    static final void drawEntities(int var0, int var1, int var2, int var3) {
      ...
      if (Client.hintArrowType == 2) {
         class467.worldToScreen((Client.hintArrowX - ParamComposition.baseX << 7) + Client.hintArrowSubX, (Client.hintArrowY - Client.baseY << 7) + Client.hintArrowSubY, Client.hintArrowHeight * 2);
