...
public class DevicePcmPlayerProvider implements class51 {
	...
	public static PrivateChatMode method74(int var0) {
		PrivateChatMode[] var1 = BufferedNetSocket.method2261();
	...
	public static int method75(CharSequence var0, int var1, boolean var2) {
		if (var1 >= 2 && var1 <= 36) {
			boolean var3 = false;
			boolean var4 = false;
			int var5 = 0;
	...
	static final void method76(int var0, int var1, int var2, int var3) {
