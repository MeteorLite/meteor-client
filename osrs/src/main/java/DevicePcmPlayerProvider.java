...
public class DevicePcmPlayerProvider implements class51 {
      ...
      if (Client.minimapState == 0 || Client.minimapState == 3) {
         if (!Client.isMenuOpen && (MouseHandler.MouseHandler_lastButton == 1 || !SceneTilePaint.mouseCam && MouseHandler.MouseHandler_lastButton == 4)) {
            ...
            if (var3.contains(var4, var5)) {
               ...
               var13.packetBuffer.method8580(Client.field747.method4106(82) ? (Client.field747.method4106(81) ? 2 : 1) : 0);
   ...
   static final void method315(class276 var0) {
      ...
      if (class276.field3165 == var0) {
         ...
         var3 = var1.method8591();
         var4 = var1.readInt();
         var5 = var1.method8581();
         ...
         var2 = var1.method8591();
         var3 = var1.readUnsignedByte();
         var4 = var1.method8702();
         var5 = (var4 >> 4 & 7) + InvDefinition.field1918;
         var6 = (var4 & 7) + class125.field1560;
         var7 = var1.method8591();
         if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
            var5 = var5 * 128 + 64;
            var6 = var6 * 128 + 64;
            GraphicsObject var43 = new GraphicsObject(var7, class383.Client_plane, var5, var6, SpotAnimationDefinition.getTileHeight(var5, var6, class383.Client_plane) - var3, var2, Client.cycle);
         ...
         if (class276.field3171 == var0) {
            var2 = var1.method8699() * 4;
            var3 = var1.readUnsignedByte();
            var4 = (var3 >> 4 & 7) + InvDefinition.field1918;
            var5 = (var3 & 7) + class125.field1560;
            var6 = var1.method8591();
            var7 = var1.method8591();
            var8 = var1.method8581() * 4;
            var9 = var1.method8699();
            var10 = var1.readUnsignedByte();
            var37 = var1.readShort();
            var12 = var1.method8591();
            var13 = var1.method8701();
            var14 = var1.readByte();
            var39 = var13 + var4;
            var40 = var14 + var5;
            if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104 && var39 >= 0 && var40 >= 0 && var39 < 104 && var40 < 104 && var12 != 65535) {
               var4 = var4 * 128 + 64;
               var5 = var5 * 128 + 64;
               var39 = var39 * 128 + 64;
               var40 = var40 * 128 + 64;
               var36 = new Projectile(var12, class383.Client_plane, var4, var5, SpotAnimationDefinition.getTileHeight(var4, var5, class383.Client_plane) - var8, var6 + Client.cycle, var7 + Client.cycle, var10, var9, var37, var2);
               var36.setDestination(var39, var40, SpotAnimationDefinition.getTileHeight(var39, var40, class383.Client_plane) - var2, var6 + Client.cycle);
               Client.projectiles.addFirst(var36);
            }

         } else if (class276.field3157 == var0) {
            var2 = var1.method8702();
            var3 = var2 >> 2;
            var4 = var2 & 3;
            var5 = Client.field579[var3];
            var6 = var1.method8702();
            ...
            if (class276.field3169 == var0) {
               var2 = var1.method8581();
               var3 = (var2 >> 4 & 7) + InvDefinition.field1918;
               var4 = (var2 & 7) + class125.field1560;
               var5 = var1.readUnsignedShort();
               var6 = var1.method8585();
               if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
               ...
               if (class276.field3164 == var0) {
                  var2 = var1.method8702();
                  var3 = var1.method8530();
                  var4 = var1.method8591();
                  ...
                  var10 = var1.method8530();
                  var37 = var1.method8702();
                  byte var38 = var1.method8701();
                  var13 = var1.method8718();
                  var40 = var1.method8549();
                  var39 = var13 + var7;
                  var12 = var38 + var8;
                  if (var7 >= 0 && var8 >= 0 && var7 < 104 && var8 < 104 && var39 >= 0 && var12 >= 0 && var39 < 104 && var12 < 104 && var4 != 65535) {
                     var7 = var7 * 128 + 64;
                     var8 = var8 * 128 + 64;
                     var39 = var39 * 128 + 64;
                     var12 = var12 * 128 + 64;
                     var36 = new Projectile(var4, class383.Client_plane, var7, var8, SpotAnimationDefinition.getTileHeight(var7, var8, class383.Client_plane) - var5, var10 + Client.cycle, var3 + Client.cycle, var2, var37, var40, var9);
                     var36.setDestination(var39, var12, SpotAnimationDefinition.getTileHeight(var39, var12, class383.Client_plane) - var9, var10 + Client.cycle);
                     Client.projectiles.addFirst(var36);
                  }
                  ...
                  var2 = var1.method8591();
                  var3 = var1.method8592();
                  var4 = var1.method8699();
                  var5 = (var4 >> 4 & 7) + InvDefinition.field1918;
                  var6 = (var4 & 7) + class125.field1560;
                  var7 = var1.method8530();
                  if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
                     NodeDeque var42 = Client.groundItems[class383.Client_plane][var5][var6];
                     if (var42 != null) {
                  ...
                  if (class276.field3167 == var0) {
                     ...
                     var4 = var2 & 3;
                     var5 = Client.field579[var3];
                     var6 = var1.method8530();
                     var7 = var1.method8591();
                     var8 = var1.method8581();
                     var9 = (var8 >> 4 & 7) + InvDefinition.field1918;
                     var10 = (var8 & 7) + class125.field1560;
                     byte var11 = var1.method8701();
                     var12 = var1.method8530();
                     var13 = var1.method8701();
                     var14 = var1.readByte();
                     byte var15 = var1.method8718();
                     int var16 = var1.method8591();
                     Player var17;
                  ...
                  if (class276.field3170 == var0) {
                     ...
                     if (var3 >= 0 && var4 >= 0 && var3 < 103 && var4 < 103) {
                        if (var9 == 0) {
                           ...
                           if (var34 != null) {
                              ...
                              if (var7 == 2) {
                                 var34.renderable1 = new DynamicObject(var37, 2, var8 + 4, class383.Client_plane, var3, var4, var5, false, var34.renderable1);
                                 var34.renderable2 = new DynamicObject(var37, 2, var8 + 1 & 3, class383.Client_plane, var3, var4, var5, false, var34.renderable2);
                              } else {
                                 var34.renderable1 = new DynamicObject(var37, var7, var8, class383.Client_plane, var3, var4, var5, false, var34.renderable1);
                              }
                           }
                        }
                           ...
                           if (var44 != null) {
                              ...
                              if (var7 != 4 && var7 != 5) {
                                 if (var7 == 6) {
                                    ...
                                    var44.renderable1 = new DynamicObject(var37, 4, var8 + 4, class383.Client_plane, var3, var4, var5, false, var44.renderable1);
                                    var44.renderable2 = new DynamicObject(var37, 4, (var8 + 2 & 3) + 4, class383.Client_plane, var3, var4, var5, false, var44.renderable2);
                                 }
                              } else {
                     ...
                     var3 = var1.method8581();
                     var4 = (var3 >> 4 & 7) + InvDefinition.field1918;
                     var5 = (var3 & 7) + class125.field1560;
                     if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104) {
                        NodeDeque var33 = Client.groundItems[class383.Client_plane][var4][var5];
                        if (var33 != null) {
                           for(TileItem var41 = (TileItem)var33.last(); var41 != null; var41 = (TileItem)var33.previous()) {
                     ...
                     var3 = var1.method8702();
                     var4 = (var3 >> 4 & 7) + InvDefinition.field1918;
                     var5 = (var3 & 7) + class125.field1560;
                     var6 = var1.method8699();
                     if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104) {
