...
public class class220 {
   ...
   class220(Buffer var1, int var2) {
      this.field1978 = new class124[var2];
      this.field1979 = var1.readUnsignedByte();

      for(int var3 = 0; var3 < this.field1978.length; ++var3) {
         class124 var4 = new class124(this.field1979, var1, false);
         this.field1978[var3] = var4;
      }
   ...
   void method1178() {
      class124[] var1 = this.field1978;

      for(int var2 = 0; var2 < var1.length; ++var2) {
         class124 var3 = var1[var2];
         if (var3.field1173 >= 0) {
            var3.field1182 = this.field1978[var3.field1173];
         }
      }
   ...
   class124 method1180(int var1) {
      return var1 >= this.method1177() ? null : this.field1978[var1];
   }
   ...
   void method1182(class134 var1, int var2) {
      this.method1183(var1, var2, (boolean[])null, false);
   }
   ...
   void method1183(class134 var1, int var2, boolean[] var3, boolean var4) {
      int var5 = var1.method731();
      int var6 = 0;
      class124[] var7 = this.method1184();

      for(int var8 = 0; var8 < var7.length; ++var8) {
         class124 var9 = var7[var8];
         if (var3 == null || var4 == var3[var6]) {
            var1.method727(var2, var9, var6, var5);
         }
   ...
   static final void method1179(byte[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, CollisionMap[] var10) {
      int var12;
