   ...
   static void method856(int var0, String var1) {
      ...
      for(int var6 = 0; var6 < var2; ++var6) {
         ...
         if (var7 != null && var7 != class155.localPlayer && var7.username != null && var7.username.equals(var5)) {
            ...
            if (var0 == 1) {
               var8 = class136.getPacketBufferNode(ClientPacket.field3091, Client.packetWriter.isaacCipher);
               var8.packetBuffer.writeByte(0);
               var8.packetBuffer.writeShort(var3[var6]);
               Client.packetWriter.addNode(var8);
            } else if (var0 == 4) {
               var8 = class136.getPacketBufferNode(ClientPacket.field3047, Client.packetWriter.isaacCipher);
               var8.packetBuffer.writeShort(var3[var6]);
               var8.packetBuffer.method8580(0);
               Client.packetWriter.addNode(var8);
            } else if (var0 == 6) {
               var8 = class136.getPacketBufferNode(ClientPacket.field3066, Client.packetWriter.isaacCipher);
               var8.packetBuffer.method8580(0);
               var8.packetBuffer.writeShort(var3[var6]);
               Client.packetWriter.addNode(var8);
            } else if (var0 == 7) {
               var8 = class136.getPacketBufferNode(ClientPacket.field3105, Client.packetWriter.isaacCipher);
               var8.packetBuffer.method8589(var3[var6]);
               var8.packetBuffer.method8580(0);
               Client.packetWriter.addNode(var8);
            }
