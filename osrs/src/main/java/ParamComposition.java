...
public class ParamComposition extends DualNode {
	...
	void decodeNext(Buffer var1, int var2) {
		if (var2 == 1) {
			this.type = class17.method60(var1.readByte());
		} else if (var2 == 2) {
	...
	static void method981(Font var0, Font var1) {
		if (class108.worldSelectBackSprites == null) {
			class108.worldSelectBackSprites = Players.method620(GrandExchangeOfferOwnWorldComparator.archive8, "sl_back", "");
		}

		if (class130.worldSelectFlagSprites == null) {
			class130.worldSelectFlagSprites = Skills.method1895(GrandExchangeOfferOwnWorldComparator.archive8, "sl_flags", "");
		}

		if (class148.worldSelectArrows == null) {
			class148.worldSelectArrows = Skills.method1895(GrandExchangeOfferOwnWorldComparator.archive8, "sl_arrows", "");
		}

		if (MoveSpeed.worldSelectStars == null) {
			MoveSpeed.worldSelectStars = Skills.method1895(GrandExchangeOfferOwnWorldComparator.archive8, "sl_stars", "");
		}
		...
		if (class108.worldSelectBackSprites != null) {
			...
			for (var16 = var5 * var15; var16 < World.World_count && var15 - Login.worldSelectPage < var4; ++var16) {
				...
				int var21 = 0;
				if (var17.isBeta()) {
					var20 = var17.isMembersOnly() ? class108.field1131 : class108.field1129;
				} else if (var17.isDeadman()) {
					var20 = var17.isMembersOnly() ? class108.field1133 : class108.field1143;
				} else if (var17.method402()) {
					var21 = 16711680;
					var20 = var17.isMembersOnly() ? class108.field1140 : class108.field1130;
				} else if (var17.method404()) {
					var20 = var17.isMembersOnly() ? class108.field1144 : class108.field1134;
				} else if (var17.isPvp()) {
					var20 = var17.isMembersOnly() ? class108.field1135 : class108.field1137;
				} else if (var17.method405()) {
					var20 = var17.isMembersOnly() ? class108.field1141 : class108.field1136;
				} else if (var17.method406()) {
					var20 = var17.isMembersOnly() ? class108.field1138 : class108.field1142;
				}

				if (var20 == null || var20.field1145 >= class108.worldSelectBackSprites.length) {
					var20 = var17.isMembersOnly() ? class108.field1132 : class108.field1139;
				}
				...
				if (MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var11 && MouseHandler.MouseHandler_x < var23 + var12 && MouseHandler.MouseHandler_y < var11 + var24 && var18) {
					...
					class108.worldSelectBackSprites[var20.field1145].drawTransOverlayAt(var12, var11, 128, 16777215);
					var14 = true;
				} else {
					class108.worldSelectBackSprites[var20.field1145].drawAt(var12, var11);
				}
