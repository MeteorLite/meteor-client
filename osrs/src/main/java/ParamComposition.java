...
public class ParamComposition extends DualNode {
   ...
   public static boolean method1060(AbstractArchive var0, AbstractArchive var1, AbstractArchive var2, MidiPcmStream var3) {
   ...
   static void method1062(class125 var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      if (var0 != null) {
         ...
         if (0.0D != (double)var9) {
            ...
            if ((double)var12[0] > 1.0D || var12[1] < -1.0F) {
               ...
               if (var12[0] > 1.0F || var12[1] > 1.0F) {
                  var15 = (float)(1.0D + (double)var12[1] * ((double)var12[1] - 2.0D) + (double)((var12[0] - 2.0F + var12[1]) * var12[0]));
