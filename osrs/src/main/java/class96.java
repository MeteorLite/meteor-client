...
public class class96 {
   ...
   public static boolean method577() {
      long var0 = class153.clockNow();
      int var2 = (int)(var0 - NetCache.field3486);
      NetCache.field3486 = var0;
      if (var2 > 200) {
         var2 = 200;
      }
                  ...
                  if (var5 > 0) {
                     ...
                     if (NetCache.field3482 != 0) {
                        for(var7 = 0; var7 < var6; ++var7) {
                           NetCache.NetCache_responseHeaderBuffer.array[NetCache.NetCache_responseHeaderBuffer.offset + var7] ^= NetCache.field3482;
                        }
                     }
                     ...
                     if (WorldMapDecoration.NetCache_currentResponse == null) {
                        ...
                        NetCache.field3484 = 8;
                        NetCache.NetCache_responseHeaderBuffer.offset = 0;
                     } else if (NetCache.field3484 == 0) {
                        if (NetCache.NetCache_responseHeaderBuffer.array[0] == -1) {
                           NetCache.field3484 = 1;
                           NetCache.NetCache_responseHeaderBuffer.offset = 0;
                        } else {
                     ...
                     if (NetCache.field3482 != 0) {
                        for(var8 = 0; var8 < var7; ++var8) {
                           class14.NetCache_responseArchiveBuffer.array[var8 + class14.NetCache_responseArchiveBuffer.offset] ^= NetCache.field3482;
                        }
                     }

                     class14.NetCache_responseArchiveBuffer.offset += var7;
                     NetCache.field3484 += var7;
                     if (var6 == class14.NetCache_responseArchiveBuffer.offset) {
                        if (16711935L == WorldMapDecoration.NetCache_currentResponse.key) {
                           class10.field38 = class14.NetCache_responseArchiveBuffer;

                           for(var8 = 0; var8 < 256; ++var8) {
                              Archive var17 = NetCache.NetCache_archives[var8];
                              if (var17 != null) {
                                 class1.method2(var17, var8);
                              }
                           }
                        } else {
                           ...
                           if (var8 != WorldMapDecoration.NetCache_currentResponse.crc) {
                              ...
                              NetCache.field3482 = (byte)((int)(Math.random() * 255.0D + 1.0D));
                              return false;
                           }

                           NetCache.NetCache_crcMismatches = 0;
                           NetCache.NetCache_ioExceptions = 0;
                           WorldMapDecoration.NetCache_currentResponse.archive.write((int)(WorldMapDecoration.NetCache_currentResponse.key & 65535L), class14.NetCache_responseArchiveBuffer.array, 16711680L == (WorldMapDecoration.NetCache_currentResponse.key & 16711680L), Messages.field1118);
                        }

                        WorldMapDecoration.NetCache_currentResponse.remove();
                        if (Messages.field1118) {
                           --NetCache.NetCache_pendingPriorityResponsesCount;
                        } else {
                           --NetCache.NetCache_pendingResponsesCount;
                        }
   ...
   public static PacketBufferNode method579(int var0, String var1, Language var2, int var3) {
      PacketBufferNode var4 = Renderable.getPacketBufferNode(ClientPacket.field2496, Client.packetWriter.isaacCipher);
      ...
      ServerPacket.method1540(var4.packetBuffer, var1);
      if (var0 == class317.field3026.rsOrdinal()) {
         var4.packetBuffer.writeByte(var3);
      }

      var4.packetBuffer.method2434(var4.packetBuffer.offset - var5);
      return var4;
   }
   ...
   static int method580(int var0, Script var1, boolean var2) {
      ...
      if (var0 == 1700) {
         ...
         return var0 == 1709 ? class308.method1721(var3) : 2;
      }
   }
