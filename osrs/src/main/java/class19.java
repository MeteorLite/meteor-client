...
public class class19 {
	...
	static final void drawActor2d(Actor var0, int var1, int var2, int var3, int var4, int var5) {
		if (var0 != null && var0.isVisible()) {
			...
			byte var8 = 0;
			if (var1 < var75 && var0.playerCycle == Client.cycle && WorldMapEvent.method5256((Player)var0)) {
				Player var9 = (Player)var0;
				if (var1 < var75) {
					class124.method2956(var0, var0.defaultHeight + 15);
				...
				for (HealthBar var87 = (HealthBar)var0.healthBars.last(); var87 != null; var87 = (HealthBar)var0.healthBars.previous()) {
					...
					if (var79 == null) {
						...
						if (var79.cycleOffset > var84) {
							var86 = var80.field1897 == 0 ? 0 : var80.field1897 * (var84 / var80.field1897);
			...
			if (var1 < var75) {
				...
				if (var88.headIconPk != -1 || var88.headIconPrayer != -1) {
					...
					if (Client.viewportTempX > -1) {
						if (var88.headIconPk != -1) {
							var76 += 25;
							class6.headIconPkSprites[var88.headIconPk].drawTransBgAt(var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - var76);
						}

						if (var88.headIconPrayer != -1) {
							var76 += 25;
							class28.headIconPrayerSprites[var88.headIconPrayer].drawTransBgAt(var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - var76);
						}
					}
				}
				...
				if (var1 >= 0 && Client.hintArrowType == 10 && var7[var1] == Client.hintArrowPlayerIndex) {
					class124.method2956(var0, var0.defaultHeight + 15);
					if (Client.viewportTempX > -1) {
						var76 += class135.headIconHintSprites[1].subHeight;
						class135.headIconHintSprites[1].drawTransBgAt(var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - var76);
					}
				}
			} else {
				...
				if (var89.headIconPrayer >= 0 && var89.headIconPrayer < class28.headIconPrayerSprites.length) {
					class124.method2956(var0, var0.defaultHeight + 15);
					if (Client.viewportTempX > -1) {
						class28.headIconPrayerSprites[var89.headIconPrayer].drawTransBgAt(var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - 30);
					}
				}
			...
			if (var0.overheadText != null && (var1 >= var75 || !var0.field1150 && (Client.publicChatMode == 4 || !var0.isAutoChatting && (Client.publicChatMode == 0 || Client.publicChatMode == 3 || Client.publicChatMode == 1 && ((Player)var0).isFriend())))) {
				class124.method2956(var0, var0.defaultHeight);
				if (Client.viewportTempX > -1 && Client.overheadTextCount < Client.overheadTextLimit) {
					Client.overheadTextXOffsets[Client.overheadTextCount] = class29.fontBold12.stringWidth(var0.overheadText) / 2;
					Client.overheadTextAscents[Client.overheadTextCount] = class29.fontBold12.ascent;
			...
			for (int var77 = 0; var77 < 4; ++var77) {
				...
				if (var12 >= 0) {
					...
					var91 = class126.method2973(var0.hitSplatTypes[var77]);
					var14 = var91.field2051;
				...
				if (var15 >= 0) {
					var16 = class126.method2973(var15);
				...
				if (var90 - var14 <= Client.cycle) {
					if (var91 == null) {
						...
						class124.method2956(var0, var0.defaultHeight / 2);
						if (Client.viewportTempX > -1) {
							boolean var92 = true;
							if (var77 == 1) {
							...
							int var63 = var91.field2056 - var62 * var91.field2056 / var91.field2051;
							int var64 = var62 * var91.field2057 / var91.field2051 + -var91.field2057;
							int var65 = var63 + (var2 + Client.viewportTempX - (var51 >> 1));
							int var66 = var3 + Client.viewportTempY - 12 + var64;
							int var67 = var66;
							int var68 = var42 + var66;
							int var69 = var66 + var91.field2053 + 15;
							...
							int var74;
							if (var16 != null) {
								var72 = var66 + var16.field2053 + 15;
