...
public class WorldMapRegion {
   ...
   void method1435(int var1, int var2, int var3) {
      SpritePixels var4 = VarpDefinition.method982(this.regionX, this.regionY, this.pixelsPerTile);
      if (var4 != null) {
    ...
    void addAllToIconList(List var1) {
      ...
      while(var2.hasNext()) {
         ...
         if (class354.WorldMapElement_get(var3.element).field1489 && var3.coord2.x >> 6 == this.regionX && var3.coord2.y >> 6 == this.regionY) {
            WorldMapIcon_0 var4 = new WorldMapIcon_0(var3.coord2, var3.coord2, var3.element, this.method1457(var3.element));
   ...
   void method1441() {
    ...
    void drawTile(int var1, WorldMapScaleHandler var2, IndexedSprite[] var3, AbstractArchive var4, AbstractArchive var5) {
      ...
      if (this.worldMapData_0 != null || !this.worldMapData1List.isEmpty()) {
         if (VarpDefinition.method982(this.regionX, this.regionY, var1) == null) {
            boolean var6 = true;
            ...
            if (var6) {
               ...
               if (var7 == null) {
                  ...
                  var9 = new WorldMapSprite(Strings.method1853(var7).pixels);
               }

               SpritePixels var11 = new SpritePixels(this.pixelsPerTile * 64, this.pixelsPerTile * 64);
               var11.setRaster();
               if (this.worldMapData_0 != null) {
                  this.method1446(var2, var3, var9);
               } else {
                  this.method1460(var2, var3, var9);
               }

               int var12 = this.regionX;
               int var13 = this.regionY;
               int var14 = this.pixelsPerTile;
               WorldMapRegion_cachedSprites.put(var11, BuddyRankComparator.method710(var12, var13, var14), var11.pixels.length * 4);
               this.method1441();
            }
         }
      }
   ...
   void method1444(int var1, int var2, int var3, HashSet var4) {
      if (var4 == null) {
         var4 = new HashSet();
      }
    ...
    void flashElements(HashSet var1, int var2, int var3) {
      ...
      this.method1434(var1, var2, var3);
   }
   ...
   void method1446(WorldMapScaleHandler var1, IndexedSprite[] var2, WorldMapSprite var3) {
      int var4;
      int var5;
      for(var4 = 0; var4 < 64; ++var4) {
         for(var5 = 0; var5 < 64; ++var5) {
            this.drawTileGround(var4, var5, this.worldMapData_0, var1, var3);
            this.method1467(var4, var5, this.worldMapData_0, var1);
         }
      }

      for(var4 = 0; var4 < 64; ++var4) {
         for(var5 = 0; var5 < 64; ++var5) {
            this.method1447(var4, var5, this.worldMapData_0, var1, var2);
         }
      }
   ...
   void method1460(WorldMapScaleHandler var1, IndexedSprite[] var2, WorldMapSprite var3) {
      ...
      while(var4.hasNext()) {
         ...
         for(var6 = var5.getChunkX() * 8; var6 < var5.getChunkX() * 8 + 8; ++var6) {
            for(var7 = var5.getChunkY() * 8; var7 < var5.getChunkY() * 8 + 8; ++var7) {
               ...
               this.method1467(var6, var7, var5, var1);
            }
         }
      }
      ...
      while(var4.hasNext()) {
         ...
         for(var6 = var5.getChunkX() * 8; var6 < var5.getChunkX() * 8 + 8; ++var6) {
            for(var7 = var5.getChunkY() * 8; var7 < var5.getChunkY() * 8 + 8; ++var7) {
               this.method1447(var6, var7, var5, var1, var2);
            }
         }
      }
   ...
   void method1447(int var1, int var2, AbstractWorldMapData var3, WorldMapScaleHandler var4, IndexedSprite[] var5) {
      this.method1451(var1, var2, var3);
      this.method1464(var1, var2, var3, var5);
   }
    ...
    void drawTileGround(int var1, int var2, AbstractWorldMapData var3, WorldMapScaleHandler var4, WorldMapSprite var5) {
      ...
      if (var7 != -1) {
         ...
         if (var11 == null) {
            ...
            if (var11.secondaryRgb >= 0) {
               ...
               var18 = class97.method617(var17, 96);
               var9 = Rasterizer3D.Rasterizer3D_colorPalette[var18] | -16777216;
            } else if (var11.texture >= 0) {
               int var19 = class97.method617(Rasterizer3D.clips.Rasterizer3D_textureLoader.getAverageTextureRGB(var11.texture), 96);
      ...
      if (var7 > -1 && var3.field2390[0][var1][var2] == 0) {
         Rasterizer2D.Rasterizer2D_fillRectangle(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, this.pixelsPerTile, var8);
      } else {
         var9 = this.method1450(var1, var2, var3, var5);
         if (var7 == -1) {
            Rasterizer2D.Rasterizer2D_fillRectangle(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, this.pixelsPerTile, var9);
         } else {
            var4.method1557(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), var9, var8, this.pixelsPerTile, this.pixelsPerTile, var3.field2390[0][var1][var2], var3.field2396[0][var1][var2]);
         }
      }
   }
   ...
   void method1467(int var1, int var2, AbstractWorldMapData var3, WorldMapScaleHandler var4) {
         ...
         if (var6 > -1) {
            ...
            if (var9 == null) {
               ...
               if (var9.secondaryRgb >= 0) {
                  ...
                  var16 = class97.method617(var15, 96);
                  var7 = Rasterizer3D.Rasterizer3D_colorPalette[var16] | -16777216;
               } else if (var9.texture >= 0) {
                  int var17 = class97.method617(Rasterizer3D.clips.Rasterizer3D_textureLoader.getAverageTextureRGB(var9.texture), 96);
            ...
            if (var3.field2390[var5][var1][var2] == 0) {
               Rasterizer2D.Rasterizer2D_fillRectangle(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, this.pixelsPerTile, var7);
            } else {
               var4.method1557(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), 0, var7, this.pixelsPerTile, this.pixelsPerTile, var3.field2390[var5][var1][var2], var3.field2396[var5][var1][var2]);
            }
         }
      }
   ...
   int method1450(int var1, int var2, AbstractWorldMapData var3, WorldMapSprite var4) {
   ...
   void method1464(int var1, int var2, AbstractWorldMapData var3, IndexedSprite[] var4) {
      for(int var5 = 0; var5 < var3.planes; ++var5) {
         ...
         if (var6 != null && var6.length != 0) {
            ...
            for(int var8 = 0; var8 < var7.length; ++var8) {
               ...
               if (!ItemLayer.method1182(var9.decoration)) {
                  int var11 = var9.decoration;
                  boolean var10 = var11 == WorldMapDecorationType.field3066.id;
                  if (!var10) {
                     continue;
                  }
               }
               ...
               if (var12.mapSceneId != -1) {
                  if (var12.mapSceneId != 46 && var12.mapSceneId != 52) {
                     var4[var12.mapSceneId].method2596(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile * 2, this.pixelsPerTile * 2);
                  } else {
                     var4[var12.mapSceneId].method2596(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile * 2 + 1, this.pixelsPerTile * 2 + 1);
                  }
               }
            }
         }
   ...
   void method1451(int var1, int var2, AbstractWorldMapData var3) {
      for(int var4 = 0; var4 < var3.planes; ++var4) {
         ...
         if (var5 != null && var5.length != 0) {
            ...
            for(int var7 = 0; var7 < var6.length; ++var7) {
               ...
               boolean var9 = var10 >= WorldMapDecorationType.field3047.id && var10 <= WorldMapDecorationType.field3050.id || var10 == WorldMapDecorationType.field3048.id;
               if (var9) {
                  ObjectComposition var11 = class144.getObjectDefinition(var8.objectDefinitionId);
                  int var12 = var11.int1 != 0 ? -3407872 : -3355444;
                  if (var8.decoration == WorldMapDecorationType.field3047.id) {
                     this.method1455(var1, var2, var8.rotation, var12);
                  }

                  if (var8.decoration == WorldMapDecorationType.field3046.id) {
                     this.method1455(var1, var2, var8.rotation, -3355444);
                     this.method1455(var1, var2, var8.rotation + 1, var12);
                  }

                  if (var8.decoration == WorldMapDecorationType.field3050.id) {
                     if (var8.rotation == 0) {
      ...
      while(var7.hasNext()) {
         ...
         if (var12 != null && var12.hasValidElement()) {
            ...
            if (!var3.contains(var13.getObjectId())) {
               this.method1454(var12, var10, var11, var5);
            }
         }
      }
   ...
   void method1434(HashSet var1, int var2, int var3) {
   ...
   void method1454(AbstractWorldMapIcon var1, int var2, int var3, float var4) {
      WorldMapElement var5 = class354.WorldMapElement_get(var1.getElement());
      this.method1463(var5, var2, var3);
      this.method1456(var1, var5, var2, var3, var4);
   }
   ...
   void method1463(WorldMapElement var1, int var2, int var3) {
      SpritePixels var4 = var1.getSpriteBool(false);
      if (var4 != null) {
         int var5 = this.method1462(var4, var1.horizontalAlignment);
         int var6 = this.method1449(var4, var1.verticalAlignment);
   ...
   void method1456(AbstractWorldMapIcon var1, WorldMapElement var2, int var3, int var4, float var5) {
      WorldMapLabel var6 = var1.getLabel();
      if (var6 != null) {
         if (var6.size.method1394(var5)) {
            Font var7 = (Font)this.fonts.get(var6.size);
            var7.drawLines(var6.text, var3 - var6.width / 2, var4, var6.width, var6.height, -16777216 | var2.field1484, 0, 1, 0, var7.ascent / 2);
         }
      }
   }
      ...
      while(var6.hasNext()) {
         ...
         if (var7.hasValidElement()) {
            ...
            if (!var3.contains(var7.getElement())) {
               this.method1454(var7, var7.screenX, var7.screenY, var5);
            }
         }
      }
   ...
   int method1462(SpritePixels var1, HorizontalAlignment var2) {
      switch(var2.value) {
      case 0:
         return 0;
      case 2:
   ...
   int method1449(SpritePixels var1, VerticalAlignment var2) {
      switch(var2.value) {
      case 1:
   ...
   WorldMapLabel method1457(int var1) {
    ...
    WorldMapLabel createMapLabel(WorldMapElement var1) {
      if (var1.name != null && this.fonts != null && this.fonts.get(WorldMapLabelSize.WorldMapLabelSize_small) != null) {
         WorldMapLabelSize var2 = WorldMapLabelSize.method1395(var1.textSize);
         if (var2 == null) {
            return null;
         } else {
   ...
   List method1468(int var1, int var2, int var3, int var4, int var5) {
   ...
   void method1455(int var1, int var2, int var3, int var4) {
      var3 %= 4;
      if (var3 == 0) {
