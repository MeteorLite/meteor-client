...
public class WorldMapDecoration {
	...
	public static class462 method1329() {
		synchronized(class462.field3907) {
			if (DirectByteArrayCopier.field3136 == 0) {
				return new class462();
			} else {
				class462.field3907[--DirectByteArrayCopier.field3136].method2318();
				return class462.field3907[DirectByteArrayCopier.field3136];
			}
		}
	}
	...
	static final void method1330(int var0) {
		...
		for (var5 = 0; var5 < 104; ++var5) {
			for (var6 = 0; var6 < 104; ++var6) {
				...
				if (0L != var7) {
					...
					if (var10 >= 0 && class141.WorldMapElement_get(var10).field1462) {
