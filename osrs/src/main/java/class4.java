...
public final class class4 {
	...
	public static void method5(int[] var0, int[] var1) {
		if (var0 != null && var1 != null) {
			...
			for (int var2 = 0; var2 < Clock.ByteArrayPool_alternativeSizes.length; ++var2) {
				...
				ByteArrayPool.field3780.add(var0[var2]);
			}

			Collections.sort(ByteArrayPool.field3780);
		} else {
	...
	static final void method6(int var0, int var1, boolean var2) {
		if (Client.currentClanChannels[var0] != null) {
			if (var1 >= 0 && var1 < Client.currentClanChannels[var0].method857()) {
				ClanChannelMember var3 = (ClanChannelMember)Client.currentClanChannels[var0].members.get(var1);
				PacketBufferNode var4 = class113.getPacketBufferNode(ClientPacket.f10, Client.packetWriter.isaacCipher);
	...
	static boolean method7() {
		return WorldMapIcon_1.clientPreferences.method561() >= Client.param21;
	}
}