...
public class VarcInt extends DualNode {
	...
	void method902(Buffer var1, int var2) {
		if (var2 == 2) {
			this.persist = true;
		}
	...
	public static Object method899(byte[] var0, boolean var1) {
		if (var0 == null) {
			return null;
