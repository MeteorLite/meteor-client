...
public class BuddyRankComparator extends AbstractUserComparator {
   ...
   public static PacketBufferNode method670(int var0, String var1, Language var2, int var3) {
      PacketBufferNode var4 = UserComparator9.getPacketBufferNode(ClientPacket.field2436, Client.packetWriter.isaacCipher);
      ...
      ClanChannel.method840(var4.packetBuffer, var1);
      if (var0 == class320.field2998.rsOrdinal()) {
         var4.packetBuffer.writeByte(var3);
      }

      var4.packetBuffer.method2425(var4.packetBuffer.offset - var5);
      return var4;
   }
