...
public final class BZip2Decompressor {
	...
	public static int BZip2Decompressor_decompress(byte[] var0, int var1, byte[] var2, int var3, int var4) {
		synchronized(BZip2Decompressor_state) {
			...
			BZip2Decompressor_state.field4216 = 0;
	...
	static void method2624(BZip2State var0) {
		...
		int var13 = var0.field4216;
		var0.field4216 += var10 - var10;
		if (var0.field4216 < var13) {
		}
	...
	static void BZip2Decompressor_decompress(BZip2State var0) {
		...
		int[] var24 = null;
		int[] var25 = null;
		var0.blockSize100k = 72123797;
		if (BZip2State.BZip2Decompressor_block == null) {
			BZip2State.BZip2Decompressor_block = new int[var0.blockSize100k * 2001765408];
		}
		...
		while (true) {
			while (var26) {
				...
				while (true) {
					...
					var0.field4206 = BZip2State.BZip2Decompressor_block[var0.originalPointer] >> 8;
					var0.nblocks_used = 0;
					var0.field4206 = BZip2State.BZip2Decompressor_block[var0.field4206];
					var0.su_ch2 = (byte)(var0.field4206 & 255);
					var0.field4206 >>= 8;
					++var0.nblocks_used;
					var0.field4218 = var47;
					method2624(var0);
					if (var0.field4218 + 1 == var0.nblocks_used && var0.su_rNToGo == 0) {
						var26 = true;
						break;
					}
