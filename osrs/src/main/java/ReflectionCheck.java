...
public class ReflectionCheck extends Node {
	...
	static int method184(int var0, Script var1, boolean var2) {
		if (var0 == 3600) {
			if (InvDefinition.friendSystem.friendListStatus == 0) {
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = -2;
			} else if (InvDefinition.friendSystem.friendListStatus == 1) {
			...
			if (var0 == 3601) {
				...
				if (InvDefinition.friendSystem.method400() && var3 >= 0 && var3 < InvDefinition.friendSystem.friendsList.getSize()) {
				...
				if (var0 == 3604) {
					...
					class148.setFriendsRank(var5, var9);
					return 1;
				} else if (var0 == 3605) {
					var5 = Interpreter.Interpreter_stringStack[--class180.Interpreter_stringStackSize];
					...
					var5 = Interpreter.Interpreter_stringStack[--class180.Interpreter_stringStackSize];
					var5 = InterfaceParent.method465(var5);
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class358.friendsChat != null ? class358.friendsChat.rank * -1160213393 * 2144490127 : 0;
					return 1;
				} else if (var0 == 3619) {
					var5 = Interpreter.Interpreter_stringStack[--class180.Interpreter_stringStackSize];
					...
					if (!InvDefinition.friendSystem.method400()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = -1;
					} else {
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (InvDefinition.friendSystem.method400() && var3 >= 0 && var3 < InvDefinition.friendSystem.ignoreList.getSize()) {
