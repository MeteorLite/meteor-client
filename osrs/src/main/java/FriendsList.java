				...
				if (var4 != null && var4.hasCleanName()) {
					...
					if (var11 != null) {
						...
						if (var6 != var11.world) {
							...
							for (class388 var13 = (class388)this.friendLoginUpdates.last(); var13 != null; var13 = (class388)this.friendLoginUpdates.previous()) {
							...
							if (var14) {
								this.friendLoginUpdates.addFirst(new class388(var4, var6));
							}
						}
					} else {
						if (this.getSize() >= 400) {
