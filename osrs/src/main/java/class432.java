...
public abstract class class432 implements class272 {
   ...
   public void method2281(Buffer var1) {
      while(true) {
         ...
         class428[] var3 = new class428[]{class428.field3816, class428.field3815, class428.field3814, class428.field3817};
         class428 var4 = (class428)StructComposition.findEnumerated(var3, var2);
         if (var4 != null) {
            switch(var4.field3818) {
            case 1:
               int var5 = var1.readUnsignedByte();
               this.field3821 = class103.method639(var5);
            ...
            case 2:
               StructComposition.findEnumerated(Language.method1949(), var1.readUnsignedByte());
               break;
            case 3:
   ...
   Object method2284() {
      if (this.field3821 == class478.field4028) {
         return 0;
      } else if (this.field3821 == class478.field4027) {
         return -1L;
      } else {
         return this.field3821 == class478.field4026 ? "" : null;
      }
   }
