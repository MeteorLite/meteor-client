...
public class class87 {
	...
	static void method461() {
		synchronized(ArchiveDiskActionHandler.field3545) {
			...
			ArchiveDiskActionHandler.field3544 = 600;
			ArchiveDiskActionHandler.field3543 = false;
		}
	}
	...
	static final void method463(int var0) {
		...
		for (var5 = 0; var5 < 104; ++var5) {
			for (var6 = 0; var6 < 104; ++var6) {
				...
				if (0L != var7) {
					...
					if (var10 >= 0 && class148.WorldMapElement_get(var10).field1518) {
