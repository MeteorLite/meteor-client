...
public enum class87 implements class352 {
   ...
   public static void method475(String var0, String var1, int var2, int var3) throws IOException {
      ...
      while(var18 < 4) {
         ...
         if (var9) {
            class329.method1801(new File(var7), (File)null);
         }
   ...
   static int method473(int var0) {
      return (int)((Math.log((double)var0) / Interpreter.field695 - 7.0D) * 256.0D);
   }
}
