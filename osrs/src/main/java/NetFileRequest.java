...
public class NetFileRequest extends DualNode {
   ...
   static final boolean method1807(byte[] var0, int var1, int var2) {
      boolean var3 = true;
   ...
   static final void method1808(byte[] var0, int var1, int var2, Scene var3, CollisionMap[] var4) {
      Buffer var5 = new Buffer(var0);
      int var6 = -1;

      while(true) {
         int var7 = var5.method2433();
         if (var7 == 0) {
            return;
         }
