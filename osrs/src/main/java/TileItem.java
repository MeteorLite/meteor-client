...
public final class TileItem extends Renderable {
	...
	boolean method612(int var1) {
		if (var1 >= 0 && var1 <= 4) {
			return (this.field1107 & 1 << var1) != 0;
		} else {
			return true;
		}
	}
	...
	static void method614(class132 var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
		if (var0 != null) {
			var0.field1247 = var1;
			...
			var0.field1244 = var14 * (var15 + var16 - var10 - var10) / var9;
			var0.field1249 = (var10 + var10 + var10 - var15 - var15 - var16) * var14;
			var0.field1242 = var12;
			var0.field1240 = var5;
		}
	}
	...
	static boolean method615(ObjectComposition var0) {
	...
	protected static int getGcDuration() {
		...
		if (GrandExchangeOfferTotalQuantityComparator.garbageCollector != null) {
			long var9 = GrandExchangeOfferTotalQuantityComparator.method1971();
		...
		for (int var1 = 0; var1 < Client.npcCount; ++var1) {
			...
			if (var2 != null && var2.isVisible() && var2.definition.isVisible == var0 && var2.definition.transformIsVisible()) {
				...
				if (var3 >= 0 && var3 < 104 && var4 >= 0 && var4 < 104) {
					if (var2.field971 == 1 && (var2.x & 127) == 64 && (var2.y & 127) == 64) {
					...
					class10.scene.drawEntity(class87.Client_plane, var2.x, var2.y, class115.getTileHeight(var2.field971 * 64 - 64 + var2.x, var2.field971 * 64 - 64 + var2.y, class87.Client_plane), var2.field971 * 64 - 64 + 60, var2, var2.rotation, var5, var2.isWalking);
				}
			}
		}
