...
public class class5 implements class2 {
   @ObfuscatedName("af")
   final MessageDigest field7 = this.method14();
   ...
   boolean method16(int var1, String var2, long var3) {
      byte[] var5 = this.method15(var2, var3);
      return method13(var5) >= var1;
   }

   @ObfuscatedName("ac")
   byte[] method15(String var1, long var2) {
