...
public abstract class GameEngine extends Applet implements Runnable, FocusListener, WindowListener {
   ...
   static void method665() {
      PacketBufferNode var0 = class136.getPacketBufferNode(ClientPacket.field3057, Client.packetWriter.isaacCipher);
      ...
      if (!var0) {
         ...
         if (!var0) {
            ...
            if (BuddyRankComparator.client.hasFrame()) {
               var19 = class136.getPacketBufferNode(ClientPacket.field3130, Client.packetWriter.isaacCipher);
