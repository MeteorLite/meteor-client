...
public class class198 {
	...
	static void getLoginError(int var0) {
		...
		if (!var5 && Client.field648.method2654()) {
			GameEngine.method166(9);
		}
	...
	static final void method994(int var0) {
		var0 = Math.min(Math.max(var0, 0), 127);
		class91.clientPreferences.setAreaSoundEffectsVolume(var0);
	}
}