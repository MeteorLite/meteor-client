...
public class class218 {
	...
	public static class216[] field1926;
	...
	public static boolean isNumber(CharSequence var0) {
		return WorldMapData_1.method1486(var0, 10, true);
	}
	...
	static int method1146(int var0, Script var1, boolean var2) {
		...
		if (var0 == 8000) {
			...
			class477.method2370(Interpreter.Interpreter_arrays[var3], new int[var4], 0, var4 - 1);
			return 1;
		} else if (var0 == 8001) {
			...
			if (var6 <= 1) {
				...
				class409.method2146(Interpreter.Interpreter_arrays[var3], var6, var4, var5);
				return 1;
			}
		} else {
			return 2;
