...
public class RasterizerAlpha extends AbstractInjector {
     ...
     */
    public void inject() {
        final Field r2dPx = InjectUtil.findField(inject, "Rasterizer2D_pixels", "osrs/Rasterizer2D");
        final Method draw = InjectUtil.findMethod(inject, "drawLoggedIn", "osrs/Client");
