...
class Pathfinder(
    val collisionMap: CollisionMap? = null, val transportCoords: Map<WorldPoint, MutableList<Transport>>? = null,
    val startCoords: List<WorldPoint?>? = null, val destination: WorldPoint? = null,
    val boundary: Deque<WorldPoint?> = ArrayDeque<WorldPoint?>(), val predecessors: CoordMap = CoordMap(),
    var nearest: WorldPoint? = null
) {
